...
class NetworkMap
{
	...
	public function overlay(array $data, MacSearchProvider $provider): void
	{
		...
		$overlay = ['confirmed' => [], 'unseen' => [], 'found' => [], 'unknown' => [],
			...
			//диагностика возможностей по целям (CLI/SNMP, команды, права) -
			//сервис собирает её и для сбойных целей, отдаём вьюхе как есть
			'capabilities' => $data['capabilities'] ?? [],
			//отчёт прогрева ARP/FDB (ping-sweep), если его просили
