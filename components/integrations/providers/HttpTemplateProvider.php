 ...
 *         'timeout' => 10,
 *         //ссылка на абонента в Web-UI телефонии. По умолчанию база
 *         //берётся из host:port у request (кнопка появляется без доп.
 *         //конфига). Задайте web ЯВНО, только если БРАУЗЕРНЫЙ адрес
 *         //отличается от backend-адреса request (напр. request идёт на
 *         //имя контейнера/host.docker.internal, а браузер — на localhost):
 *         //'web' => 'https://phones.local:8080',
