...
class LicTypes extends ArmsModel
{
	...
	public function attributeData()
	{
		return [
			'comment' => [
				'Описание',
				'hint' => 'Подробное описание схемы лицензирования. Если описание сложное, удобно добавить в поле «Ссылки» ссылку на официальную документацию или свою статью',
				'type' => 'text',
			...
			'name' => [
				'Служебное имя',
				'hint' => 'Машинное название схемы латиницей, в нижнем регистре и без пробелов. Зарезервировано, пока нигде не используется',
			],
