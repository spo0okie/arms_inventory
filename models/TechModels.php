...
class TechModels extends ArmsModel
{
	...
	public function attributeData()
	{
		return [
			...
			'back_rack_two_sided'=>['Двухсторонняя','hint'=>'Посадочные места идут на всю глубину устройства и доступны для установки устройств как сзади так и спереди','typeClass'=>\app\types\BooleanType::class],
			'contain_back_rack' => ['Посадочные места сзади','hint'=>'Имеет посадочные места для дополнительных устройств (корзину) сзади','typeClass'=>\app\types\BooleanType::class],
			'contain_front_rack' => ['Посадочные места спереди','hint'=>'Имеет посадочные места для дополнительных устройств (корзину) спереди','typeClass'=>\app\types\BooleanType::class],
			'comment' => [
				'Описание',
			...
			'usages' => ['Экз.','typeClass'=>\app\types\IntegerType::class],
		];
	}
