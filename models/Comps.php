        ...
        return ArrayHelper::recursiveOverride(parent::attributeData(),[
			...
			'name' => [
				...
				'indexHint' => 'Сетевое имя компьютера настроенное в ОС.<br>'
					...
					.'Цвет ячейки отображает давность последних данных от скрипта инвентаризации:<ul>'
					.'<li>до часа - ярко-голубой</li>'
					.'<li>до суток - бледно-голубой</li>'
					.'<li>до недели — зелёный</li>'
					.'<li>до месяца — жёлтый</li>'
					.'<li>свыше — красный</li></ul>'
