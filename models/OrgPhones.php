...
class OrgPhones extends ArmsModel
{
	...
	public static function modelDescription(): string
	{
		return 'Городские телефонные номера организации: привязка к помещениям '
			.'и услугам связи, стоимость обслуживания.';
	}
    /**
     * {@inheritdoc}
     */
    ...
    public function attributeData()
    {
        return [
	        ...
	        'account' => ['Аккаунт, л/с','hint'=>'Номер лицевого счета/аккаунта у оператора связи'],
			...
			'archived' => [
				'Архивирован',
				'hint'=>'Если номер уже не используется, лучше его заархивировать.<br /> Он останется в БД для истории, но исчезнет из списков и меню выбора (показать можно переключателем «Архивные»)',
			],
        ];
    }
