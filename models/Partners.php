...
class Partners extends ArmsModel
{
    ...
    public function attributeData()
    {
        return [
			...
			'bname' => [
				'Бренд',
				'hint'=>'Публичное имя, под которым контрагент известен '
					.'(вместо юридического «ИП Иванов И.И.»), — как все привыкли его называть',
				'typeClass'=>\app\types\StringType::class,
			],
			'alias' => [
            ...
            'comment' => [
            	'Комментарий',
				'hint' => 'Любая полезная информация: с кем и какие вопросы решать у этого контрагента — '
				 . 'персональный менеджер, технический специалист, бухгалтер, адреса и контакты.<br>'
