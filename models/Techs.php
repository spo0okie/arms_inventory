		...
		return ArrayHelper::recursiveOverride(parent::attributeData(),[
			...
			'comment' => [
				...
				'hint' => 'Краткое пояснение по этому оборудованию.<br>'
					.'Выводится при наведении на статус оборудования в карте рабочих мест.<br>'
			...
			'installed_id'=>[
				...
				'hint'=>'Если это устройство установлено в другое, то нужно указать в какое'
					.'<br><i>(Для модульных сборок типа блейд сервер установлен в корзину, корзина в шкаф и т.п.)</i>',
			...
			'mac' => [
				...
				'hint' => 'MAC адреса сетевых интерфейсов оборудования.<br>'
					.'В списках и поиске вместе с ними учитываются адреса привязанной ОС.<br>'
