...
class Materials extends ArmsModel
{
	...
	public function attributeData()
	{
		return [
			...
			'history' => ['Записная книжка','typeClass'=>\app\types\TextType::class],
			...
			'materials_usages_ids' => ['Расход','typeClass'=>\app\types\LinkType::class],
			'model' => [
				'Наименование',
			...
			'parent_id' => [
				...
				'hint' => 'Если указать источник поступления материалов, то этот материал<br>'
					.'будет считаться частью, отделённой от указанного источника<br>'
					.'(партию можно дробить на части по разным местам хранения)',
			...
			'used' => ['Использовано','typeClass'=>\app\types\IntegerType::class],
		];
	}
