    ...
    public function attributeData()
    {
		return array_merge(parent::attributeData(),[
			...
			'includedBy' => [
				...
				'hint'=>'Выполнением каких других требований удовлетворяется это требование',
				'indexHint'=>'{same}',
			...
			'spread_techs' => [
				...
				'indexHint'=>'{same}',
				'hint'=>'При прикреплении требований к сервису, автоматически предъявлять эти требования к оборудованию на которых он работает. (не распространяется на АРМ, на которых работают операционные системы)',
				'column'=>['class'=>BooleanColumn::class],
			],
