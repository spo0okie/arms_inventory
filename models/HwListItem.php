...
class HwListItem
{
    ...
    public $inv_num;        //бухгалтерский инв номер
    public $manual_name;    //наименование введенное вручную (override)
    public $manual_sn;      //серийный номер введенный вручную (override)
