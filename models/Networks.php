...
class Networks extends ArmsModel
{
	...
	public function attributeData()
	{
		return ArrayHelper::recursiveOverride(parent::attributeData(),[
			...
			'readableBroadcastIp' => ['Широковещательный IP','readOnly'=>true],
			'readableDhcp' => ['alias'=>'dhcp'],
			'readableFirstIp' => ['Первый доступный IP','readOnly'=>true],
			'readableLastIp' => ['Последний доступный IP','readOnly'=>true],
			'readableNetMask' => ['alias'=>'mask'],
			'readableNetworkIp' => ['IP сети','readOnly'=>true],
			'readableRouter' => ['alias'=>'text_router'],
			'readableWildcard' => ['Обратная маска','readOnly'=>true],
