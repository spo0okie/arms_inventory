...
class Networks extends ArmsModel
{
    ...
    public function rules()
    {
        return [
			...
			[['vlan_id', 'segments_id', 'archived'], 'integer'],
	...
	public function attributeData()
	{
		return ArrayHelper::recursiveOverride(parent::attributeData(),[
			...
			'readableBroadcastIp' => ['Широковещательный IP','readOnly'=>true,'typeClass'=>\app\types\StringType::class],
			'readableDhcp' => ['alias'=>'dhcp'],
			'readableFirstIp' => ['Первый доступный IP','readOnly'=>true,'typeClass'=>\app\types\StringType::class],
			'readableLastIp' => ['Последний доступный IP','readOnly'=>true,'typeClass'=>\app\types\StringType::class],
			'readableNetMask' => ['alias'=>'mask'],
			'readableNetworkIp' => ['IP сети','readOnly'=>true,'typeClass'=>\app\types\StringType::class],
			'readableRouter' => ['alias'=>'text_router'],
			'readableWildcard' => ['Обратная маска','readOnly'=>true,'typeClass'=>\app\types\StringType::class],
			'router' => ['alias'=>'text_router'],
			'text_addr' => [
				'Адрес и маска',
				'hint' => 'Адрес и маска сети (в десятичной нотации 192.168.1.0/24)',
				'type' => 'ips',
				'typeClass'=>\app\types\IpNetType::class,
			],
			'text_dhcp' => [
				'DHCP сервер',
