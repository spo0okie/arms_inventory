 ...
 *
 * КОНВЕНЦИЯ ПОРЯДКА: записи attributeData() держать отсортированными по ключу
 * (алфавитно) — блок у больших моделей разрастается на сотни строк, и без
 * сортировки визуально найти атрибут тяжело. Допустимое исключение:
 * alias-запись ('accessTypes'=>['alias'=>'access_types_ids']) ставится
 * вплотную к своему базовому атрибуту.
 *
