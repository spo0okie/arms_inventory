...
/* @var $model app\models\ui\LoginForm */
			...
			<div class="col-lg-6">
				<div class="card">
					...
					<div class="card-body">
						...
						<p class="text-right p-3"><?php if (Yii::$app->params['localAuth']) {?>
								Авторизация производится при помощи локальных учетных данных самой инвентаризации.<br />
								За сбросом пароля, а также назначением прав вашему пользователю на просмотр/редактирование данных, или на управление ACL обращайтесь к ответственному за инвентаризацию.
							<?php }else{?>
