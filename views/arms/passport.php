...
JS;
    ...
    <div class="passport_footer">
        <p>
            Сотрудник дирекции ИТ:_________________ <?= is_object($model->itStaff)?$model->itStaff->full_name:'________________________________________' ?>
        </p>
        <p>
        ...
        <p>
            Руководитель структурного подразделения: _________________ <?= is_object($model->head)?$model->head->full_name:'________________________________________' ?>
        </p>
        <p>
            Сотрудник: _________________ <?= is_object($model->user)?$model->user->full_name:'________________________________________' ?>
        </p>
        <?php if  (is_object($model->responsible)) {?>
        <p>
            <i>
            Установку и изменение аппаратно-программной конфигурации данном ПК осуществляет:
            Сотрудник: _________________ <?= $model->responsible->full_name ?>
            </i>
        </p>
        <?php } ?>
        <p>
            Дата "___"_______________ 201_г.
        </p>
    </div>
