...
/* @var $searchModel app\models\MaintenanceReqsSearch */
...
$this->title = app\models\MaintenanceReqs::$titles;
$this->params['breadcrumbs'][] = $this->title;
$renderer=$this;

$filtered=false;
if (isset(Yii::$app->request->get()['app\models\MaintenanceReqsSearch'])) {
	foreach (Yii::$app->request->get()['app\models\MaintenanceReqsSearch'] as $field) if ($field) $filtered=true;
}
...
?>
<div class="maintenance-reqs-index">
	<?= DynaGridWidget::widget([
		'id' => 'maintenance-reqs-index',
		...
		'hintButton' => HintIconWidget::widget(['model'=>'\app\models\app\models\MaintenanceReqs','cssClass'=>'btn']),
