...
class WikiLinksScanner
{
	...
	/**
	 * @var bool учитывать ли находки ВНУТРИ включенных страниц.
	 *
	 * По умолчанию НЕТ: это ссылки самой wiki (их и так видно во встроенном
	 * "Ссылки сюда"), а через включение одна такая ссылка размножается на все
	 * объекты, втягивающие страницу-шаблон - в отчете это выглядит как сотни
	 * ссылок из инвентаризации, которых в ней нет. Само включение при этом
	 * учитывается всегда: его написали в поле объекта.
	 *
	 * Включение флага дает полную картину "что видно на странице объекта" -
	 * такие находки помечаются цепочкой включений.
	 */
