...
<?= \yii\grid\GridView::widget([
	...
	'columns' => [
		[
			'header'=>\app\modules\schedules\models\SchedulesEntries::$label_day,
			'value'=>function($data,$day) {
				return \app\modules\schedules\models\SchedulesEntries::$days[$day];
			},
		...
		[
			'header'=>\app\modules\schedules\models\SchedulesEntries::$label_schedule,
			'format'=>'raw',
			'value'=>function ($data,$day) use ($static_view,$model) {
				//Если задано явно, то рисуем явно заданное с возможностью править и удалить
				/**
				 * @var \app\modules\schedules\models\SchedulesEntries $data
				 */
		...
		[
			'header'=>\app\modules\schedules\models\SchedulesEntries::$label_graph,
