...
trait SchedulesModelCalcFieldsTrait
{
	...
	public function nextWorkingMeta($date,$time)
	{
		...
		/*$now=\app\modules\schedules\models\SchedulesEntries::strTimestampToMinutes($time);
		foreach ($periods as $period) {
			$interval=\app\modules\schedules\models\SchedulesEntries::scheduleExToMinuteInterval($period);
