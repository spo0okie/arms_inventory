...
| `11-forwards.sql` | тип доступа «проброс» и пробросы с белых адресов шлюзов на реверс-прокси и VPN-серверы: блоки «Доступен снаружи»/«Пробрасывается на» у ОС, IP и DNS-имён |
