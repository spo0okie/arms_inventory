...
CREATE TABLE `absences` (
  ...
  `user_id` int NOT NULL COMMENT 'Сотрудник (конкретное трудоустройство), users.id',
  `type` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Нормализованный тип отсутствия (код совпадает с XML_ID в Bitrix)',
  `date_from` date NOT NULL COMMENT 'Начало периода отсутствия',
  `date_to` date NOT NULL COMMENT 'Конец периода отсутствия',
  `comment` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Текст отсутствия из источника (SAP Abstext)',
  `source` varchar(8) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Источник записи: sap|c1|manual',
  `external_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Натуральный ключ записи в источнике; для manual — NULL',
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx-absences-source-external` (`source`,`external_id`),
  KEY `idx-absences-user_id` (`user_id`),
  KEY `idx-absences-period` (`date_from`,`date_to`)
...
INSERT INTO `absences` VALUES (1,1,'VACATION','2026-01-09','2026-01-20',NULL,'manual',NULL,'2026-01-05 08:00:00','seed'),(9001,2,'VACATION','2026-08-24','2026-09-07','Основной отпуск','sap','SAP-2026-0231','2026-08-10 00:00:00','sapsync'),(9002,3,'ASSIGNMENT','2026-08-27','2026-08-29','Челябинск, приёмка офиса','manual',NULL,'2026-08-25 07:30:00','admin'),(9003,4,'LEAVESICK','2026-08-18','2026-08-22',NULL,'c1','1C-BL-4412','2026-08-23 23:15:00','c1sync'),(9004,6,'VACATION_PLAN','2026-10-05','2026-10-18','График отпусков на IV квартал','sap','SAP-2026-0410','2026-08-01 00:00:00','sapsync'),(9005,7,'LEAVEMATERNITY','2026-03-02','2027-07-20',NULL,'sap','SAP-2026-0088','2026-03-02 00:00:00','sapsync'),(9006,9,'LEAVEUNPAYED','2026-09-01','2026-09-01','Отгул за работу в выходной','manual',NULL,'2026-08-26 04:10:00','admin'),(9007,10,'UNKNOWN','2026-07-13','2026-07-13','Отсутствовал без объяснения, разобрано','c1','1C-PR-0771','2026-07-13 23:20:00','c1sync'),(9008,12,'OTHER','2026-09-14','2026-09-18','Обучение 1С:Бухгалтерия','manual',NULL,'2026-08-20 06:00:00','admin'),(9009,13,'PERSONAL','2026-08-31','2026-08-31','Удалённый день','manual',NULL,'2026-08-27 10:40:00','admin'),(9010,14,'ASSIGNMENT','2026-09-08','2026-09-12','Выставка, Екатеринбург','sap','SAP-2026-0255','2026-08-22 00:00:00','sapsync'),(9011,15,'VACATION','2026-06-01','2026-06-14',NULL,'sap','SAP-2026-0177','2026-05-20 00:00:00','sapsync'),(9012,5,'ASSIGNMENT','2026-08-28','2026-08-28','Переговоры у контрагента','manual',NULL,'2026-08-27 11:00:00','admin');
/*!40000 ALTER TABLE `absences` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `absences_history`
--

DROP TABLE IF EXISTS `absences_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `absences_history` (
  ...
  `source` varchar(8) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `idx-absences_history-master_id` (`master_id`),
  KEY `idx-absences_history-updated_at` (`updated_at`),
  KEY `idx-absences_history-updated_by` (`updated_by`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `absences_history`
--

LOCK TABLES `absences_history` WRITE;
/*!40000 ALTER TABLE `absences_history` DISABLE KEYS */;
INSERT INTO `absences_history` VALUES (1,1,1,'VACATION','2026-01-09','2026-01-20',NULL,'manual',NULL,'2026-01-05 08:00:00','seed',NULL,'user_id,type,date_from,date_to,source');
/*!40000 ALTER TABLE `absences_history` ENABLE KEYS */;
UNLOCK TABLES;
...
) ENGINE=InnoDB AUTO_INCREMENT=9310 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `access_in_aces` VALUES (1,4,1,'UDP 1194'),(4,4,3,'UDP 1194'),(10,4,4,'UDP 1194'),(9001,7,9001,'TCP 3389'),(9002,9003,9001,NULL),(9003,3,9002,'TCP 22'),(9004,4,9002,'UDP 1194'),(9005,2,9003,'UDP 161'),(9006,2,9004,'UDP 161'),(9007,9001,9004,'TCP 8443'),(9100,9001,9100,'TCP 443->8443'),(9101,4,9101,'UDP 1194'),(9102,4,9102,'UDP 1194'),(9200,9001,9200,'TCP 44344'),(9201,9001,9201,'TCP 44345'),(9202,9001,9202,'TCP 443'),(9300,9001,9300,'TCP 443'),(9301,7,9301,'TCP 3389'),(9302,9001,9301,'TCP 443'),(9303,9001,9302,'TCP 443'),(9304,9001,9303,'TCP 443'),(9305,9001,9304,'TCP 80,443');
...
INSERT INTO `access_types` VALUES (2,'read','Чтение',NULL,NULL,0,0,0,0,NULL),(3,'write','Запись',NULL,NULL,0,0,0,0,NULL),(4,'vpn','Ovpn','OpenVPN','',1,0,1,0,'UDP 1194'),(6,'full','Полный','Полный доступ ко всем функциям ресурса','',0,0,0,0,''),(7,'rdp','RDP','Удалённый рабочий стол','',1,0,0,0,'TCP 3389'),(9001,'https','HTTPS','Веб-интерфейс ресурса','',1,0,0,0,'TCP 443'),(9002,'sip','Телефония SIP','Регистрация аппарата и разговорный тракт','',1,1,0,0,'UDP 5060,20000-20100'),(9003,'app_1c','1С: доступ в базу','Права внутри приложения, выдаёт администратор 1С','',0,0,0,1,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=9007 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `access_types_hierarchy` VALUES (9003,2,3),(9001,3,6),(9002,4,6),(9004,7,6),(9005,9001,6);
...
) ENGINE=InnoDB AUTO_INCREMENT=9307 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `aces` VALUES (1,1,'','Удалённая работа через OpenVPN','',NULL,NULL,'Коллектив ХЗ к терминалам 1С',0),(3,3,'','Удалённая работа через OpenVPN','','2024-03-18 15:39:06','admin','Безруков к рабочему месту',0),(4,4,'','Удалённая работа через OpenVPN','','2024-03-18 15:51:21','admin','Зимин к рабочему месту',0),(9001,9001,'','Бухгалтерия: терминал и база','','2026-07-21 03:46:00','VeniaminLevchenko','Бухгалтерия в 1С',0),(9002,9002,'10.20.30.0/24','Администраторы с рабочих мест ИТ','','2026-07-21 03:51:00','admin','ИТ к управлению коммутатором',0),(9003,9003,'','Опрос из ИТ-сети Челябинска','','2026-07-21 03:56:00','admin','ИТ-сеть ЧЕЛ к сети управления',0),(9004,9004,'','Zabbix опрашивает коммутатор','','2026-07-21 04:01:00','DaniilZimin','Мониторинг к ЧЕЛ-КОМ-0002',0),(9100,9100,'55.66.77.81','HTTPS снаружи на реверс-прокси','','2026-09-15 05:01:00','admin','Проброс 443 на MSK-PROXY',1),(9101,9101,'55.66.77.81','OpenVPN снаружи','','2026-09-15 05:06:00','admin','Проброс VPN на MSK-OVPN',1),(9102,9102,'66.77.88.98','OpenVPN снаружи','','2026-09-15 05:06:00','VeniaminLevchenko','Проброс VPN на chl-ovpn',1),(9200,9200,'','','','2026-09-16 04:05:00','admin','Забирает кадровые данные из 1С (через прокси)',0),(9201,9200,'','','','2026-09-16 04:06:00','admin','Публикует прайс из 1С (через прокси)',0),(9202,9201,'','','','2026-09-16 04:10:00','admin','Проброс запросов к веб-сервисам 1С',0),(9300,9300,'','','','2026-09-17 04:01:00','admin','Пользователи к серверным веб-сервисам',0),(9301,9300,'','','','2026-09-17 04:02:00','admin','Администраторы к серверам',0),(9302,9300,'','','','2026-09-17 04:03:00','DaniilZimin','Мониторинг опрашивает серверный сегмент',0),(9303,9301,'','','','2026-09-17 04:06:00','admin','Администраторы к интерфейсам управления',0),(9304,9302,'','','','2026-09-17 04:11:00','admin','Пользователи в интернет (веб)',0);
...
CREATE TABLE `aces_history` (
  ...
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `next_aces_ids` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `prev_aces_ids` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `segments_ids` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `is_forward` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `aces_history` VALUES (1,3,'2024-03-18 15:39:06','admin',NULL,'acls_id,users_ids,access_types_ids',NULL,NULL,3,'1',NULL,'1,4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(2,4,'2024-03-18 15:50:21','admin',NULL,'acls_id,users_ids,access_types_ids',NULL,NULL,4,'6',NULL,'1,4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(3,4,'2024-03-18 15:50:52','admin',NULL,'notepad',NULL,'Для выполнения должностных обязанностей удаленно',4,'6',NULL,'1,4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(4,4,'2024-03-18 15:51:21','admin',NULL,'notepad',NULL,NULL,4,'6',NULL,'1,4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
/*!40000 ALTER TABLE `aces_history` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `aces_next_aces`
--

DROP TABLE IF EXISTS `aces_next_aces`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `aces_next_aces` (
  `id` int NOT NULL AUTO_INCREMENT,
  `aces_id` int DEFAULT NULL,
  `next_aces_id` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `aces_next_aces-m2m` (`aces_id`,`next_aces_id`),
  KEY `aces_next_aces-aces_id` (`aces_id`),
  KEY `aces_next_aces-next_aces_id` (`next_aces_id`)
) ENGINE=InnoDB AUTO_INCREMENT=9204 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `aces_next_aces`
--

LOCK TABLES `aces_next_aces` WRITE;
/*!40000 ALTER TABLE `aces_next_aces` DISABLE KEYS */;
INSERT INTO `aces_next_aces` VALUES (9200,9200,9202),(9201,9201,9202);
/*!40000 ALTER TABLE `aces_next_aces` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `acls` (
  ...
  KEY `idx-acls-segments_id` (`segments_id`)
) ENGINE=InnoDB AUTO_INCREMENT=9304 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `acls` VALUES (1,6,NULL,NULL,19,NULL,'','Просили вообще ко всему кластеру, но доступ открыли к терминалу, оттуда на остальные узлы через RDP',NULL,NULL,NULL,NULL,NULL),(3,8,NULL,NULL,40,NULL,'','Для выполнения должностных обязанностей удаленно','2024-03-18 15:51:38','admin',NULL,NULL,NULL),(4,8,NULL,NULL,39,NULL,'','Для выполнения должностных обязанностей удаленно','2024-03-18 15:51:26','admin',NULL,NULL,NULL),(9001,6,18,NULL,NULL,NULL,'Доступ бухгалтерии в терминалы 1С','Согласовано служебной запиской №14-2026','2026-07-21 03:45:00','VeniaminLevchenko',NULL,NULL,NULL),(9002,8,NULL,NULL,NULL,22,'Управление коммутатором МСК-КОМ-0003','Только с рабочих мест ИТ и через VPN','2026-07-21 03:50:00','admin',NULL,NULL,NULL),(9003,6,NULL,NULL,NULL,NULL,'Опрос сети управления Челябинска',NULL,'2026-07-21 03:55:00','admin',4,NULL,NULL),(9004,8,NULL,33,NULL,NULL,'Мониторинг ЧЕЛ-КОМ-0002 по SNMP',NULL,'2026-07-21 04:00:00','DaniilZimin',NULL,NULL,NULL),(9100,NULL,NULL,NULL,34,NULL,NULL,'Публикация наружу через шлюз msk-gw','2026-09-15 05:00:00','admin',NULL,NULL,NULL),(9101,NULL,NULL,30,NULL,NULL,NULL,'Клиентский VPN, площадка Москва','2026-09-15 05:05:00','admin',NULL,NULL,NULL),(9102,NULL,NULL,31,NULL,NULL,NULL,'Клиентский VPN, площадка Челябинск','2026-09-15 05:05:00','admin',NULL,NULL,NULL),(9200,NULL,19,NULL,NULL,NULL,NULL,'Прокси контролирует на сетевом уровне, кто куда ходит','2026-09-16 04:00:00','admin',NULL,NULL,NULL),(9201,NULL,18,NULL,NULL,NULL,NULL,'Доступ к веб-сервисам 1С только через прокси','2026-09-16 04:00:00','admin',NULL,NULL,NULL),(9300,NULL,NULL,NULL,NULL,NULL,NULL,'Базовая политика: кто ходит в серверный сегмент','2026-09-17 04:00:00','admin',NULL,NULL,6),(9301,NULL,NULL,NULL,NULL,NULL,NULL,'Сегмент управления доступен только ИТ','2026-09-17 04:05:00','admin',NULL,NULL,9),(9302,NULL,NULL,NULL,NULL,NULL,NULL,'Выход в интернет','2026-09-17 04:10:00','admin',NULL,NULL,10);
...
INSERT INTO `acls_history` VALUES (1,3,'2024-03-18 15:22:27','admin',NULL,'schedules_id',NULL,NULL,8,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(2,3,'2024-03-18 15:39:06','admin',NULL,'aces_ids',NULL,NULL,8,NULL,NULL,NULL,NULL,'3',NULL,NULL,NULL),(3,3,'2024-03-18 15:49:36','admin',NULL,'comps_id',NULL,NULL,8,NULL,NULL,40,NULL,'3',NULL,NULL,NULL),(4,4,'2024-03-18 15:50:12','admin',NULL,'schedules_id,comps_id',NULL,NULL,8,NULL,NULL,39,NULL,NULL,NULL,NULL,NULL),(5,4,'2024-03-18 15:50:21','admin',NULL,'aces_ids',NULL,NULL,8,NULL,NULL,39,NULL,'4',NULL,NULL,NULL),(6,4,'2024-03-18 15:51:26','admin',NULL,'notepad',NULL,'Для выполнения должностных обязанностей удаленно',8,NULL,NULL,39,NULL,'4',NULL,NULL,NULL),(7,3,'2024-03-18 15:51:38','admin',NULL,'notepad',NULL,'Для выполнения должностных обязанностей удаленно',8,NULL,NULL,40,NULL,'3',NULL,NULL,NULL),(8,5,'2024-03-18 17:06:55','admin',NULL,'schedules_id,services_id',NULL,NULL,8,20,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(9,5,'2024-03-19 03:42:25','admin',NULL,'object_deleted',NULL,NULL,8,20,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO `admins_in_comps` VALUES (9006,5,10),(9007,6,10),(9003,17,9),(9004,18,9),(9005,19,9),(9001,39,6),(9002,40,1),(9008,41,1);
...
) ENGINE=InnoDB AUTO_INCREMENT=9007 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Компьютеры';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `comps_in_aces` VALUES (9001,39,9002),(9002,40,9002);
...
) ENGINE=InnoDB AUTO_INCREMENT=9002 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Договоры';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `contracts` VALUES (1,NULL,0,'Договор на услуги связи №0444/23','2023-01-09','2027-01-08','',NULL,NULL,NULL,1,'ЗНП-2023-0444',NULL,NULL,NULL,'2026-06-24 06:40:00','DaniilZimin'),(2,NULL,0,'Договор на услуги связи №1010-22','2020-10-11','2026-10-10','',NULL,NULL,NULL,1,'ЗНП-2020-1010',NULL,NULL,NULL,'2026-06-24 06:40:00','DaniilZimin'),(3,NULL,0,'Счет №456 Серверное оборудование в МСК','2020-11-17',NULL,'',6,1348790.71,224798.45,1,'ЗНП-2020-0456',6,NULL,3,'2026-07-30 04:20:00','admin'),(4,NULL,0,'Счет№ 709 Оборудование в офисы','2021-12-21',NULL,'',6,2507596.70,417932.78,1,'ЗНП-2021-0709',20,10,NULL,'2026-07-30 04:20:00','admin'),(5,NULL,0,'Договор поставки № 50428','2018-11-07',NULL,'Просто рыба с интернета, для правильной иерархии документов',NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,'2026-06-24 06:40:00','DaniilZimin'),(6,5,0,'ДС №1 - Серверные шкафы','2019-02-01',NULL,'',NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL),(7,6,0,'Счет № 213 - Серверные шкафы в Чел и Мск','2019-02-15',NULL,'',6,39611.00,6601.83,1,'ЗНП-2019-0213',2,NULL,NULL,'2026-07-30 04:20:00','admin'),(8,7,0,'ТТН 306 Шкаф Чел','2019-03-05',NULL,'',NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL),(9001,5,1,'ДС №2 - Серверные шкафы (замена ДС №1)','2019-04-12',NULL,'Заменяет ДС №1: сменилась модель шкафа',6,41250.00,6875.00,1,'ЗНП-2019-0288',2,NULL,NULL,'2026-07-30 04:30:00','admin');
...
INSERT INTO `contracts_in_materials` VALUES (5,4,9);
...
INSERT INTO `contracts_in_services` VALUES (15,1,1),(16,2,2);
...
CREATE TABLE `contracts_states` (
  ...
  `marker_id` int DEFAULT NULL COMMENT 'Цветовой маркер',
  PRIMARY KEY (`id`),
  UNIQUE KEY `code` (`code`),
  UNIQUE KEY `name` (`name`),
  KEY `idx-contracts_states-paid` (`paid`),
  KEY `idx-contracts_states-unpaid` (`unpaid`),
  KEY `idx-contracts_states-marker_id` (`marker_id`)
...
INSERT INTO `contracts_states` VALUES (1,'state_required','Потребность','Счет на руках, потребность очевидна, но еще до подачи счета на согласование',0,0,59),(2,'state_paywait','На согласовании','Сформирована СЗ на согласование счета. Ожидаем решения',0,0,59),(3,'state_paywait_confirmed','Согласовано','Счет согласован и ожидает оплаты/предоплаты финансовым отделом',0,1,60),(4,'state_payed_partial','Предоплачено','После поступления частичной предоплаты на расчетный счет поставщика\nУказывает на необходимость получить услуги или товары у поставщика работающего по схеме частичной предоплаты',1,1,61),(5,'state_paywait_full','Ожидает оплаты','Ожидает полной оплаты\n- после получения при работе по частичной предоплате\n- или до получения при работе по полной предоплате',0,1,62),(6,'state_payed','Оплачено 100%','После поступления 100% стоимости на расчетный счет поставщика',1,0,52),(7,'state_revoked','Отказано','Не прошел процедуру согласования, был отклонен по каким-то иным причинам',0,0,56),(8,'state_fail','Сторнировано','Счет потерял актуальность, необходимо запросить новый',0,0,56);
...
--
-- Table structure for table `default_access_in_services`
--

DROP TABLE IF EXISTS `default_access_in_services`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `default_access_in_services` (
  `id` int NOT NULL AUTO_INCREMENT,
  `services_id` int DEFAULT NULL,
  `access_types_id` int DEFAULT NULL,
  `ip_params` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`id`),
  UNIQUE KEY `default_access_in_services-m2m` (`services_id`,`access_types_id`),
  KEY `default_access_in_services-services_id` (`services_id`),
  KEY `default_access_in_services-access_types_id` (`access_types_id`)
) ENGINE=InnoDB AUTO_INCREMENT=9007 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `default_access_in_services`
--

LOCK TABLES `default_access_in_services` WRITE;
/*!40000 ALTER TABLE `default_access_in_services` DISABLE KEYS */;
INSERT INTO `default_access_in_services` VALUES (9001,17,4,'UDP 1194'),(9002,18,6,'TCP 3389'),(9003,18,4,'UDP 1194'),(9004,22,2,'TCP 80,443'),(9005,11,6,'UDP 5060,20000-20100'),(9006,19,2,'TCP 3128');
/*!40000 ALTER TABLE `default_access_in_services` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `dns_names`
--
...
CREATE TABLE `dns_names` (
  `id` int NOT NULL AUTO_INCREMENT,
  `domain_id` int NOT NULL COMMENT 'Зона (domains.id)',
  `host` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT 'Имя в зоне (левая часть FQDN); пусто = apex зоны',
  `ip` varchar(768) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'IP-адреса по одному в строке (текстовый ввод; связи — dns_names_in_ips)',
  `comment` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Комментарий',
  `updated_at` timestamp NULL DEFAULT NULL COMMENT 'Дата последнего изменения',
  `updated_by` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Автор последних изменений (username)',
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx-dns_names-domain-host` (`domain_id`,`host`)
) ENGINE=InnoDB AUTO_INCREMENT=9013 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `dns_names`
--

LOCK TABLES `dns_names` WRITE;
/*!40000 ALTER TABLE `dns_names` DISABLE KEYS */;
INSERT INTO `dns_names` VALUES (9000,9000,'','55.66.77.90','Apex зоны: сайт на MSK-WWW','2026-09-10 04:00:00','admin'),(9001,9000,'www','55.66.77.90','Сайт (тот же адрес, что apex)','2026-09-10 04:00:00','admin'),(9002,9000,'ns1','55.66.77.82','Внешний DNS на MSK-NS','2026-09-10 04:00:00','admin'),(9003,9000,'mail','55.66.77.81','Почта: белый адрес шлюза msk-gw, NAT на внутренний почтовик','2026-09-10 04:05:00','admin'),(9004,9000,'vpn','55.66.77.81\n66.77.88.98','Клиентский VPN: оба шлюза (Москва и Челябинск)','2026-09-10 04:05:00','admin'),(9005,9000,'old-portal',NULL,'Старый портал выведен из эксплуатации, имя зарезервировано до конца года','2026-09-12 10:30:00','VeniaminLevchenko'),(9010,1,'inventory','10.20.75.20','Алиас инвентаризации (hostname узла — msk-inventory)','2026-09-11 06:00:00','admin'),(9011,1,'zabbix','10.50.75.4','Алиас мониторинга (hostname узла — CHL-ZABBIX)','2026-09-11 06:00:00','admin'),(9012,1,'proxy','10.20.100.10\n10.50.100.10','Одно имя на два прокси (по площадкам)','2026-09-11 06:10:00','BorisBarinov');
/*!40000 ALTER TABLE `dns_names` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `dns_names_history`
--

DROP TABLE IF EXISTS `dns_names_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `dns_names_history` (
  `id` int NOT NULL AUTO_INCREMENT,
  `master_id` int DEFAULT NULL,
  `domain_id` int DEFAULT NULL,
  `host` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ip` varchar(768) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `comment` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `updated_by` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `changed_attributes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`id`),
  KEY `idx-dns_names_history-master_id` (`master_id`),
  KEY `idx-dns_names_history-updated_at` (`updated_at`),
  KEY `idx-dns_names_history-updated_by` (`updated_by`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `dns_names_history`
--

LOCK TABLES `dns_names_history` WRITE;
/*!40000 ALTER TABLE `dns_names_history` DISABLE KEYS */;
/*!40000 ALTER TABLE `dns_names_history` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `dns_names_in_ips`
--

DROP TABLE IF EXISTS `dns_names_in_ips`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `dns_names_in_ips` (
  `id` int NOT NULL AUTO_INCREMENT,
  `dns_names_id` int DEFAULT NULL,
  `ips_id` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `dns_names_in_ips-m2m` (`dns_names_id`,`ips_id`),
  KEY `dns_names_in_ips-dns_names_id` (`dns_names_id`),
  KEY `dns_names_in_ips-ips_id` (`ips_id`)
) ENGINE=InnoDB AUTO_INCREMENT=9014 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `dns_names_in_ips`
--

LOCK TABLES `dns_names_in_ips` WRITE;
/*!40000 ALTER TABLE `dns_names_in_ips` DISABLE KEYS */;
INSERT INTO `dns_names_in_ips` VALUES (9000,9000,50),(9001,9001,50),(9002,9002,51),(9003,9003,26),(9005,9004,24),(9004,9004,26),(9010,9010,18),(9011,9011,38),(9012,9012,39),(9013,9012,40);
/*!40000 ALTER TABLE `dns_names_in_ips` ENABLE KEYS */;
UNLOCK TABLES;
...
) ENGINE=InnoDB AUTO_INCREMENT=9001 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Домены';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `domains` VALUES (1,'TABURETKA','taburetka.local','Основной домен табуретки'),(2,'LAB1','lab1.taburetka.local','Тестовая лаборатория MS AD'),(9000,'TABURETKA-RU','taburetka.ru','Внешняя (публичная) DNS-зона: имена сайта, почты и VPN на белых адресах');
...
CREATE TABLE `integrations_log` (
  `id` int NOT NULL AUTO_INCREMENT,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Когда выполнено',
  `users_id` int DEFAULT NULL COMMENT 'Инициатор (пользователь ARMS), NULL для консоли',
  `provider` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Id провайдера интеграции',
  `action` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Id действия',
  `class` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Класс объекта ARMS (NULL для standalone)',
  `object_id` int DEFAULT NULL COMMENT 'Id объекта ARMS (NULL для standalone)',
  `parent_id` int DEFAULT NULL COMMENT 'Запись-инициатор для вложенных вызовов',
  `ext_login` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Исполнитель во внешней ИС (L2+)',
  `params` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Параметры действия (JSON, без секретов)',
  `result` varchar(8) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'ok / error',
  `message` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Итог/ответ внешней ИС',
  PRIMARY KEY (`id`),
  KEY `idx-integrations_log-object` (`class`,`object_id`),
  KEY `idx-integrations_log-provider` (`provider`,`action`),
  KEY `fk-integrations_log-users_id` (`users_id`),
  KEY `fk-integrations_log-parent_id` (`parent_id`),
  CONSTRAINT `fk-integrations_log-parent_id` FOREIGN KEY (`parent_id`) REFERENCES `integrations_log` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk-integrations_log-users_id` FOREIGN KEY (`users_id`) REFERENCES `users` (`id`) ON DELETE SET NULL
...
INSERT INTO `integrations_log` VALUES (9001,'2026-08-18 01:31:12',1,'ad','reset-password','app\\models\\Users',6,NULL,'TABURETKA\\admin','{\"length\":12,\"mustChange\":true}','ok','Пароль учётной записи DaniilZimin изменён, SMS доставлено'),(9002,'2026-08-18 01:31:14',1,'sms','send','app\\models\\Users',6,9001,NULL,'{\"phone\":\"+7 (952) 073-14-59\"}','ok','Отправлено'),(9003,'2026-08-19 03:04:50',1,'ad','create-account','app\\models\\Users',15,NULL,'TABURETKA\\admin','{\"ou\":\"OU=Users,OU=Taburetka,DC=taburetka,DC=local\",\"groups\":[\"sales\",\"vpn-users\"]}','ok','Учётная запись ApollonKirillov создана'),(9004,'2026-08-19 03:04:53',1,'sms','send','app\\models\\Users',15,9003,NULL,'{\"phone\":\"+7 (961) 020-15-86\"}','ok','Отправлено'),(9005,'2026-08-19 07:10:31',9,'ad','restore-account','app\\models\\Users',11,NULL,'TABURETKA\\VeniaminLevchenko','{\"login\":\"ElinaTarskaya\"}','error','Учётная запись не найдена в OU уволенных'),(9006,'2026-08-20 05:02:17',10,'ad','reset-password','app\\models\\Users',13,NULL,'TABURETKA\\BorisBarinov','{\"length\":10,\"mustChange\":true}','error','Отказ AD: недостаточно прав на сброс пароля (Reset Password)'),(9007,'2026-08-21 09:45:03',1,'sms','send',NULL,NULL,NULL,NULL,'{\"phone\":\"+7 (912) 137-28-86\"}','ok','Отправлено'),(9008,'2026-08-25 04:15:44',6,'sms','send',NULL,NULL,NULL,NULL,'{\"phone\":\"+7 (998) 558-41-00\"}','error','Таймаут запроса к шлюзу (15 с)'),(9009,'2026-08-26 02:58:20',1,'ad','create-account','app\\models\\Users',14,NULL,'TABURETKA\\admin','{\"ou\":\"OU=Users,OU=Taburetka,DC=taburetka,DC=local\"}','error','Учётная запись с таким sAMAccountName уже существует'),(9010,'2026-08-27 11:20:00',1,'ad','reset-password','app\\models\\Users',12,NULL,'TABURETKA\\admin',NULL,'run',NULL);
...
INSERT INTO `ips_in_aces` VALUES (9001,32,9004),(9100,26,9100),(9101,26,9101),(9102,24,9102);
...
INSERT INTO `ips_in_techs` VALUES (164,78,5),(165,28,12),(166,69,12),(167,70,12),(168,71,12),(169,72,12),(170,73,12),(171,74,12),(172,32,14),(173,29,22),(174,33,23),(175,22,33),(176,34,34),(177,41,37),(178,42,38),(179,43,39),(180,44,40),(181,47,41),(182,48,42),(183,49,43),(184,46,44),(185,52,45),(186,53,45),(187,54,46),(188,55,47),(189,56,48),(190,57,49),(191,62,50),(192,63,51),(193,64,52),(194,65,53),(195,81,54),(196,66,55),(9001,33,9001);
...
CREATE TABLE `lic_groups` (
  ...
  `created_by` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Автор создания',
  PRIMARY KEY (`id`),
  KEY `lic_types_id` (`lic_types_id`),
  KEY `idx-lic_groups-services_id` (`services_id`)
) ENGINE=InnoDB AUTO_INCREMENT=9002 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Группы лицензий';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `lic_groups` VALUES (1,1,'Microsoft Windows 10 Pro OEM','Группа OEM лицензий на WIndows 10 Pro приобретенных с ПК ','2023-09-08 15:31:53',NULL,NULL,NULL,NULL),(2,2,'Win Server Datacenter 2012R2','','2023-09-08 15:31:54',NULL,NULL,NULL,NULL),(3,3,'MS SQL 2014 Enterprise','','2023-09-08 15:31:54',NULL,NULL,NULL,NULL),(4,4,'Лицензии на HelpDesk Litemanager для ИТ','','2023-09-08 15:31:54',NULL,NULL,NULL,NULL),(6,1,'Лицензии на КриптоПро CSP','','2023-09-08 15:31:54',NULL,NULL,NULL,NULL),(7,6,'Лицензии на SCAD Office 21 USB','','2023-09-08 15:31:54',NULL,NULL,NULL,NULL),(9,6,'Лицензии на Гранд-смету USB','','2023-09-08 15:31:54',NULL,NULL,NULL,NULL),(22,8,'MS Office 2016 Standard VL','MS Office 2016 Standard VL','2023-09-08 15:31:54',NULL,NULL,NULL,NULL),(23,8,'MS Visio 2016 Standard VL','MS Visio 2016 Standard VL','2023-09-08 15:31:54',NULL,NULL,NULL,NULL),(24,8,'MS Access 2016','MS Access 2016','2023-09-08 15:31:54',NULL,NULL,NULL,NULL),(25,1,'1С Предприятие 8.3','1С Предприятие 8.3\r\nКонфигурации: Бухгалтерия предприятия КОРП 3.0\r\nЗарплата и управление персоналом КОРП 2.5 клиентская лицензия','2025-08-29 07:24:02','admin',18,NULL,NULL),(29,1,'Adobe Photoshop CS6','Adobe Photoshop CS6','2023-09-08 15:31:55',NULL,NULL,NULL,NULL),(31,9,'КОМПАС-График v17','','2025-06-05 11:53:59',NULL,NULL,NULL,NULL),(33,1,'CorelDRAW Graphics 2017','','2023-09-08 15:31:55',NULL,NULL,NULL,NULL),(34,1,'CorelDRAW Graphics 2019','','2023-09-08 15:31:55',NULL,NULL,NULL,NULL),(42,1,'Microsoft Windows 7 Professional OEM','Microsoft Windows 7 Professional приобретенные вместе с ПК','2023-09-08 15:31:55',NULL,NULL,NULL,NULL),(43,1,'MS Office 2010 Std','MS Office 2010 Std','2023-09-08 15:31:55',NULL,NULL,NULL,NULL),(44,1,'MS Office 2013 Std','MS Office 2013 Std','2023-09-08 15:31:55',NULL,NULL,NULL,NULL),(45,1,'MS Project 2016 Std','MS Project 2016 Std','2023-09-08 15:31:55',NULL,NULL,NULL,NULL),(46,1,'MS Visio 2010 Std','MS Visio 2010 Std','2023-09-08 15:31:55',NULL,NULL,NULL,NULL),(47,1,'Microsoft Windows Pro 8.1 x64','Microsoft Windows Pro 8.1 x64','2023-09-08 15:31:55',NULL,NULL,NULL,NULL),(48,8,'Microsoft Windows Pro 8.1 x64 VLSC','Microsoft Windows Pro 8.1 x64 VLSC','2023-09-08 15:31:55',NULL,NULL,NULL,NULL),(54,10,'Kaspersky Endpoint Security для бизнеса','Kaspersky Endpoint Security для бизнеса\r\n','2023-09-08 15:31:55',NULL,NULL,NULL,NULL),(55,10,'Kaspersky Security для почтовых серверов','Kaspersky Security для почтовых серверов','2023-09-08 15:31:55',NULL,NULL,NULL,NULL),(56,10,'Kaspersky Security для банкоматов и точек мгновенной оплаты','Kaspersky Security для банкоматов и точек мгновенной оплаты','2023-09-08 15:31:55',NULL,NULL,NULL,NULL),(60,1,'Microsoft Windows 7 Professional 64-bit Рус.(OEM)','Microsoft Windows 7 Professional 64-bit Рус.(OEM)','2023-09-15 13:08:35',NULL,NULL,NULL,NULL),(62,1,'VMWare vSphere Essentials','Позволяет установить VMWare ESXi на три ноды и vCenter','2023-09-15 15:10:37','admin',NULL,NULL,NULL),(9001,10,'Zabbix Support Silver','Годовая подписка на поддержку системы мониторинга','2026-01-11 05:00:00','admin',20,'2026-01-11 05:00:00','admin');
...
INSERT INTO `lic_groups_in_users` VALUES (9001,25,2,'Работает в 1С',1,'2026-07-17 10:00:00',1,'2026-07-17 10:00:00'),(9002,25,4,'Работает в 1С',1,'2026-07-17 10:00:00',1,'2026-07-17 10:00:00'),(9003,25,12,'Работает в 1С',1,'2026-07-17 10:00:00',1,'2026-07-17 10:00:00'),(9004,25,13,'Работает в 1С',1,'2026-07-17 10:00:00',1,'2026-07-17 10:00:00');
...
) ENGINE=InnoDB AUTO_INCREMENT=9003 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Лицензии';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `lic_items` VALUES (1,1,'OEM Windows 10 в комплекте с NUC-ами',22,'',NULL,NULL,'2023-09-13 15:29:17',NULL,'2026-07-17 04:30:00','admin',NULL),(2,62,'VMWare в Москву',3,'На самом деле лицензия одна, но на три узла',NULL,NULL,'2023-09-15 15:11:39',NULL,'2026-07-17 04:30:00','admin',5),(4,6,'Для бухгалтерии',2,'','2026-03-01','2027-02-28','2025-06-06 18:53:48',NULL,NULL,NULL,NULL),(9001,9001,'Подписка Zabbix Support на 2026 год',1,'Продлевается в декабре','2026-01-01','2026-12-31','2026-01-11 05:05:00',NULL,'2026-01-11 05:05:00','admin',20),(9002,25,'1С:Предприятие 8.3, клиентские лицензии (годовые)',10,'Срок истёк, продление в работе','2025-07-01','2026-06-30','2025-06-24 04:00:00',NULL,'2026-07-17 04:40:00','VeniaminLevchenko',18);
...
INSERT INTO `lic_items_in_comps` VALUES (9001,9002,17,'Сервер приложений 1С',1,'2026-07-17 09:45:00',1,'2026-07-17 09:45:00'),(9002,9002,19,'Терминальный сервер 1С',1,'2026-07-17 09:45:00',1,'2026-07-17 09:45:00'),(9003,2,1,'Хост виртуализации',1,'2026-07-17 09:46:00',1,'2026-07-17 09:46:00'),(9004,2,2,'Хост виртуализации',1,'2026-07-17 09:46:00',1,'2026-07-17 09:46:00'),(9005,9001,33,'Сервер мониторинга',1,'2026-07-17 09:47:00',1,'2026-07-17 09:47:00');
...
INSERT INTO `lic_items_in_users` VALUES (9001,9002,2,'Бухгалтерия',1,'2026-07-17 09:50:00',1,'2026-07-17 09:50:00'),(9002,9002,4,'Бухгалтерия',1,'2026-07-17 09:50:00',1,'2026-07-17 09:50:00'),(9003,9002,12,'Бухгалтерия',1,'2026-07-17 09:50:00',1,'2026-07-17 09:50:00'),(9004,9002,13,'Бухгалтерия',1,'2026-07-17 09:50:00',1,'2026-07-17 09:50:00'),(9005,4,3,'КриптоПро для обмена с банком',1,'2026-07-17 09:52:00',1,'2026-07-17 09:52:00');
...
INSERT INTO `lic_keys` VALUES (1,1,'1975f377-87a5-49d3-b051-c9ed8b070d23','наклейка на корпусе','2026-07-17 04:35:00','VeniaminLevchenko'),(2,1,'87f2c59b-bea6-462c-b0ab-27d561e8dc31','наклейка на корпусе','2026-07-17 04:35:00','VeniaminLevchenko'),(3,1,'8c925267-b9a7-4b84-bb64-bbd742000fa7','наклейка на корпусе','2026-07-17 04:35:00','VeniaminLevchenko'),(4,1,'0f8351f1-45a9-494c-958f-04b907e5d13d','наклейка на корпусе','2026-07-17 04:35:00','VeniaminLevchenko'),(5,1,'8628efaa-5d7d-4896-b4a1-76cda5afc9c8','наклейка на корпусе',NULL,NULL),(6,1,'8af67a4a-5097-41e5-a35a-c0c19682e658','наклейка в серверной, надо наклеить',NULL,NULL),(7,1,'9e126ad6-e0c6-4ad7-a8cd-351f6466bd21','наклейка в серверной, надо наклеить',NULL,NULL),(8,1,'3d517bba-a08f-41a9-9deb-c5b4fdda5a39','прошит в БИОС',NULL,NULL),(9,1,'9fddab17-c867-4887-8abc-b7c0e989985f','прошит в БИОС',NULL,NULL),(10,1,'96f24a6d-62c8-4bce-ba04-7b64a59dc148','наклейка стерлась','2025-08-29 07:25:37',NULL);
...
INSERT INTO `lic_keys_in_comps` VALUES (9001,1,3,'Активирован при установке',1,'2026-07-17 09:55:00',1,'2026-07-17 09:55:00'),(9002,2,4,'Активирован при установке',1,'2026-07-17 09:55:00',1,'2026-07-17 09:55:00');
...
INSERT INTO `lic_keys_in_users` VALUES (9001,4,9,'Выдан под личный ноутбук',1,'2026-07-17 09:58:00',1,'2026-07-17 09:58:00'),(9002,5,10,'Выдан под личный ноутбук',1,'2026-07-17 09:58:00',1,'2026-07-17 09:58:00');
...
) ENGINE=InnoDB AUTO_INCREMENT=9007 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Журнал входа в систему';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `login_journal` VALUES (1,'2025-05-09 14:30:27','wks-03',5,'NinaBelozerova',2,0,1746801027,'2025-05-09 14:30:30','2025-05-09 14:30:27'),(2,'2025-06-05 14:09:41','wks-04',6,'SerafimaBrovina',4,0,1749132581,'2025-06-05 14:09:45','2025-06-05 14:09:41'),(9001,'2026-08-26 01:12:04','wks-05',7,'KimSadovskiy',3,0,1787292724,'2026-08-26 06:12:10','2026-08-26 01:12:04'),(9002,'2026-08-26 02:40:11','msk-1c-term',19,'KimSadovskiy',3,1,1787298011,'2026-08-26 07:40:15','2026-08-26 02:40:11'),(9003,'2026-08-27 00:55:39','wks-03',5,'NinaBelozerova',2,0,1787378139,'2026-08-27 05:55:44','2026-08-27 00:55:39'),(9004,'2026-08-27 04:14:02','msk-1c-term',19,'NinaBelozerova',2,1,1787390042,'2026-08-27 09:14:08','2026-08-27 04:14:02'),(9005,'2026-08-27 07:31:57','admin-lab7',39,'DaniilZimin',6,1,1787402117,'2026-08-27 12:32:01','2026-08-27 07:31:57'),(9006,'2026-08-28 00:48:20','chel-pc-01',9,'SilantiyGorodnov',12,0,1787464100,'2026-08-28 05:48:26','2026-08-28 00:48:20');
...
INSERT INTO `maintenance_jobs_in_services` VALUES (9003,18,2),(9001,26,1),(9002,26,2);
...
INSERT INTO `maintenance_jobs_in_techs` VALUES (9002,1,1),(9003,2,2),(9001,45,1);
...
INSERT INTO `maintenance_reqs` VALUES (1,'Бэкап ВМ 7/3/0','Кратковременное хранение с ежедневным бэкапом за неделю  \r\n**стратегия GFS  - 3 ежемесячных, 7 ежедневных точек восстановления**',1,1,1,NULL,'2026-07-06 02:55:00','admin',NULL,NULL),(2,'Бэкап ВМ 7/3/3','Кратковременное хранение с ежедневным бэкапом за неделю  \r\n**стратегия GFS  - 3 ежегодных, 3 ежемесячных, 7 ежедневных точек восстановления**',1,1,0,NULL,'2026-07-06 02:55:00','admin',NULL,NULL),(9001,'Хранение копий на LTO (выведено)','Требование отменено вместе с ленточной библиотекой',1,0,0,NULL,'2026-05-18 04:22:00','admin',1,NULL);
...
INSERT INTO `maintenance_reqs_in_comps` VALUES (9001,1,17),(9002,1,18),(9003,1,19),(9004,2,36),(9005,2,41);
...
INSERT INTO `maintenance_reqs_in_services` VALUES (9001,1,18),(9002,2,22),(9003,2,24);
...
INSERT INTO `maintenance_reqs_in_techs` VALUES (9001,1,1),(9002,1,2),(9003,2,45);
...
INSERT INTO `manufacturers` VALUES (1,'Logitech','Logitech International S.A.','Производитель компьютерной периферии','2023-08-28 12:52:06',NULL,NULL,NULL),(3,'Microsoft','Microsoft corporation','Микрософт','2023-08-28 12:52:06',NULL,NULL,NULL),(11,'Adobe','Adobe Systems Incorporated','','2023-08-28 12:52:06',NULL,NULL,NULL),(20,'Avaya','Avaya Inc.','','2023-08-28 12:52:06',NULL,NULL,NULL),(21,'Intel','Intel corporation','Производитель железа и ПО','2023-08-28 12:52:06',NULL,NULL,NULL),(35,'HP','Hewlett-Packard','','2023-08-28 12:52:06',NULL,NULL,NULL),(55,'ASUS','AsusTek Computer Inc.','','2023-08-28 12:52:06',NULL,NULL,NULL),(56,'The Document Foundation','The Document Foundation','','2023-08-28 12:52:06',NULL,NULL,NULL),(63,'Bitrix','Bitrix, Inc','','2023-08-28 12:52:06',NULL,NULL,NULL),(70,'Яндекс','Яндекс','','2023-08-28 12:52:06',NULL,NULL,NULL),(81,'Mail.Ru','Mail.Ru LLC','','2023-08-28 12:52:06',NULL,NULL,NULL),(93,'LiteManager Team','LiteManager Team','','2023-08-28 12:52:06',NULL,NULL,NULL),(97,'Крипто-ПРО','Компания КРИПТО-ПРО','','2023-08-28 12:52:06',NULL,NULL,NULL),(99,'KYOCERA','KYOCERA Document Solutions Inc.','','2023-08-28 12:52:06',NULL,NULL,NULL),(112,'Canon','Canon Inc.','','2023-08-28 12:52:06',NULL,NULL,NULL),(116,'Samsung','Samsung','','2023-08-28 12:52:06',NULL,NULL,NULL),(162,'No Name','Безымянные и не определяющиеся производители','А как без этого','2023-08-28 12:52:06',NULL,NULL,NULL),(169,'Sony','Sony','','2023-08-28 12:52:06',NULL,NULL,NULL),(180,'Cisco','Cisco Systems, Inc.','','2023-08-28 12:52:06',NULL,NULL,NULL),(186,'Axis','Axis Communications AB','','2023-08-28 12:52:06',NULL,NULL,NULL),(190,'Центр ГРАНД','Центр ГРАНД','','2023-08-28 12:52:06',NULL,NULL,NULL),(193,'Lenovo ','Lenovo ','','2023-08-28 12:52:06',NULL,NULL,NULL),(203,'NEC','NEC Corporation','日本電気株式会社','2023-08-28 12:52:06',NULL,NULL,NULL),(204,'SHARP','SHARP','','2023-08-28 12:52:06',NULL,NULL,NULL),(206,'Oce-Technologies','Oce-Technologies','','2023-08-28 12:52:06',NULL,NULL,NULL),(233,'SCAD Soft','SCAD Soft','','2023-08-28 12:52:06',NULL,NULL,NULL),(235,'Toshiba','Toshiba','','2023-08-28 12:52:06',NULL,NULL,NULL),(253,'1C','1C','','2023-08-28 12:52:06',NULL,NULL,NULL),(260,'Corel','Corel Corporation','','2023-08-30 11:39:31','reviakin.a',NULL,NULL),(317,'Лаборатория Касперского','АО \"Лаборатория Касперского\"','','2023-08-28 12:52:06',NULL,NULL,NULL),(494,'NetApp','NetApp','Производитель железа и ПО','2023-08-28 12:52:06',NULL,NULL,NULL),(496,'Huawei','Huawei Technologies Co.,Ltd','','2023-08-28 12:52:06',NULL,NULL,NULL),(497,'Mikrotik','Mikrotik','','2023-08-28 12:52:06',NULL,NULL,NULL),(498,'Grandstream','Grandstream Networks','SIP-телефония и SIP-видеонаблюдение','2023-08-28 12:52:06',NULL,NULL,NULL),(499,'D-Link','D-Link Corporation','Производитель сетевого оборудования','2023-08-28 12:52:06',NULL,NULL,NULL),(500,'APC','American Power Conversion','Поглощена Schneider Electric в 2007. Сохраняется как торговая марка.','2023-08-28 12:52:06',NULL,NULL,NULL),(501,'Ubiquiti','Ubiquiti Networks','производит продукты для беспроводной передачи данных для предприятий и провайдеров беспроводного широкополосного доступа с основным упором на малообслуживаемость и развивающиеся рынки','2023-08-28 12:52:06',NULL,NULL,NULL),(502,'Ippon','Ippon','Производитель ИБП','2023-08-28 12:52:06',NULL,NULL,NULL),(503,'Beward','НПП \"Бeвард\"','разработчик и производитель оборудования для систем видеонаблюдения.','2023-08-28 12:52:06',NULL,NULL,NULL),(504,'DEPO','DEPO','','2023-08-28 12:52:06',NULL,NULL,NULL),(505,'Powerman','Powerman','','2023-08-28 12:52:06',NULL,NULL,NULL),(506,'ExeGate','ExeGate','Компания ExeGate основана в 2009 году в Гонконге группой инженеров компьютерной отрасли. Специализация ExeGate - производство компьютерных комплектующих и аксессуаров.','2023-08-28 12:52:06',NULL,NULL,NULL),(507,'CyberPower','CyberPower','','2023-08-28 12:52:06',NULL,NULL,NULL),(508,'EATON','EATON','','2023-08-28 12:52:06',NULL,NULL,NULL),(509,'Acer','Acer','','2023-08-28 12:52:06',NULL,NULL,NULL),(510,'QNAP','QNAP','QNAP','2023-08-28 12:52:06',NULL,NULL,NULL),(511,'Parsec','Parsec','СКУД','2023-08-28 12:52:06',NULL,NULL,NULL),(512,'MERCUSYS','MERCUSYS','Desktop Switch','2023-08-28 12:52:06',NULL,NULL,NULL),(513,'Brocade','Brocade Communications Systems','Американская компания. Проектирует, производит и продаёт комплексные решения, а также программное обеспечение для управления сетями хранения данных','2023-08-28 12:52:06',NULL,NULL,NULL),(514,'RICOH','RICOH','ricoh.ru','2023-08-28 12:52:06',NULL,NULL,NULL),(515,'3COM','3COM','','2023-08-28 12:52:06',NULL,NULL,NULL),(516,'Yealink','Yealink Network Technology','китайская компания, производитель и разработчик SIP-телефонов, систем видео-конференц-связи и аксессуаров к ним','2023-08-28 12:52:06',NULL,NULL,NULL),(517,'Sky Control','Sky Control s.r.o','Sky Control s.r.o — высокотехнологическая компания, основанная в Словакии (Братислава).','2023-08-28 12:52:06',NULL,NULL,NULL),(518,'H3C','H3C','H3C','2023-08-28 12:52:06',NULL,NULL,NULL),(519,'Brother','Brother','','2023-08-28 12:52:06',NULL,NULL,NULL),(520,'Philips','Koninklijke Philips N.V.','Нидерландская транснациональная компания. Производство потребительских товаров и медицинского оборудования.','2023-08-28 12:52:06',NULL,NULL,NULL),(521,'Dell','Dell Technologies Inc.','','2023-08-28 12:52:06',NULL,NULL,NULL),(522,'Supermicro','Super Micro Computer, Inc.','американская компания, крупный производитель материнских плат, корпусов, источников питания, систем охлаждения, контроллеров SAS, Ethernet и InfiniBand. Компания специализируется на выпуске x86-серверных платформ и различных комплектующих для серверов, ра','2023-08-28 12:52:06',NULL,NULL,NULL),(523,'AOC','AOC International','','2023-08-28 12:52:06',NULL,NULL,NULL),(524,'ViewSonic','ViewSonic','','2023-08-28 12:52:06',NULL,NULL,NULL),(525,'BenQ','BenQ','','2023-08-28 12:52:06',NULL,NULL,NULL),(526,'LG','LG','','2023-08-28 12:52:06',NULL,NULL,NULL),(527,'TP-LINK','TP-Link','','2023-08-28 12:52:06',NULL,NULL,NULL),(528,'Brady','Brady','Общество с Ограниченной Ответственностью \"Центр Промышленной Маркировки\"','2023-08-28 12:52:06',NULL,NULL,NULL),(529,'Zebra','Zebra Technologies Corporation','','2023-08-28 12:52:06',NULL,NULL,NULL),(530,'GETAC','GETAC','','2023-08-28 12:52:06',NULL,NULL,NULL),(531,'ELO','ELO','','2023-08-28 12:52:06',NULL,NULL,NULL),(532,'PowerCom','PowerCom','','2023-08-28 12:52:06',NULL,NULL,NULL),(534,'Hisseu','Hisseu','','2023-08-28 12:52:06',NULL,NULL,NULL),(535,'Net work NVR','Network Video Recorder','','2023-08-28 12:52:06',NULL,NULL,NULL),(536,'Cabeus','Cabeus','Cabeus является производителем полного спектра продукции для построения Структурированной Кабельной Системы (СКС).','2023-08-28 12:52:06',NULL,NULL,NULL),(537,'RDW','RDW Computers','Российский производитель компьютеров','2023-08-28 12:52:06',NULL,NULL,NULL),(538,'Vutlan','Система контроля Vutlan','мониторинг серверной комнаты','2023-08-28 12:52:06',NULL,NULL,NULL),(539,'ДистКонтрол','ООО \"ДистКонтрол\"','Производитель USB концентраторов','2023-09-15 05:19:13','admin',NULL,NULL),(540,'Epson','Epson','','2023-08-28 12:52:06',NULL,NULL,NULL),(541,'RoverScan','RoverScan','Мониторы','2023-08-28 12:52:06',NULL,NULL,NULL),(542,'Импульс','ООО \"ЦРИ \"ИМПУЛЬС\"','https://impuls.energy/','2023-09-06 10:01:12','reviakin.a',NULL,NULL);
...
INSERT INTO `manufacturers_dict` VALUES (1,'logitech',1,'2023-08-28 12:52:08',NULL),(2,'logitech inc.',1,'2023-08-28 12:52:08',NULL),(8,'microsoft corporation',3,'2023-08-28 12:52:08',NULL),(9,'microsoft',3,'2023-08-28 12:52:08',NULL),(10,'skype technologies s.a.',3,'2023-08-28 12:52:08',NULL),(11,'корпорация майкрософт',3,'2023-08-28 12:52:08',NULL),(12,'microsoft corp',3,'2023-08-28 12:52:08',NULL),(13,'корпорация майкрософт (microsoft corporation)',3,'2023-08-28 12:52:08',NULL),(14,'microsoft corp.',3,'2023-08-28 12:52:08',NULL),(15,'майкрософт',3,'2023-08-28 12:52:08',NULL),(37,'adobe systems incorporated',11,'2023-08-28 12:52:08',NULL),(38,'adobe systems, inc.',11,'2023-08-28 12:52:08',NULL),(39,'adobe systems, inc',11,'2023-08-28 12:52:08',NULL),(40,'adobe systems inc.',11,'2023-08-28 12:52:08',NULL),(41,'adobe',11,'2023-08-28 12:52:08',NULL),(55,'avaya',20,'2023-08-28 12:52:08',NULL),(56,'intel(r)',21,'2023-08-28 12:52:08',NULL),(57,'intel corporation',21,'2023-08-28 12:52:08',NULL),(58,'intel',21,'2023-08-28 12:52:08',NULL),(59,'корпорация intel',21,'2023-08-28 12:52:08',NULL),(60,'intel(r) corporation',21,'2023-08-31 03:50:28','reviakin.a'),(61,'intel (r)',21,'2023-08-30 13:53:30','reviakin.a'),(62,'intel ®',21,'2023-08-30 13:57:32','reviakin.a'),(63,'intel®',21,'2023-08-30 13:57:39','reviakin.a'),(82,'hewlett-packard',35,'2023-08-28 12:52:08',NULL),(83,'hp',35,'2023-08-28 12:52:08',NULL),(84,'hp inc.',35,'2023-08-28 12:52:08',NULL),(85,'hewlett-packard co.',35,'2023-08-28 12:52:08',NULL),(86,'hewlett packard development company l.p.',35,'2023-08-28 12:52:08',NULL),(87,'hewlett-packard company',35,'2023-08-28 12:52:08',NULL),(88,'hewlett-packard development company, lp.',35,'2023-08-28 12:52:08',NULL),(89,'hewlett-packard development company, l.p.',35,'2023-08-28 12:52:08',NULL),(115,'asustek computer inc.',55,'2023-08-28 12:52:08',NULL),(116,'asustek',55,'2023-08-28 12:52:08',NULL),(117,'asus',55,'2023-08-28 12:52:08',NULL),(118,'the document foundation',56,'2023-08-28 12:52:08',NULL),(127,'bitrix, inc',63,'2023-08-28 12:52:08',NULL),(136,'яндекс',70,'2023-08-28 12:52:08',NULL),(137,'yandex llc',70,'2023-08-28 12:52:08',NULL),(138,'ооо «яндекс»',70,'2023-08-31 04:54:47','reviakin.a'),(139,'yandex',70,'2023-08-31 04:55:23','reviakin.a'),(161,'mail.ru',81,'2023-08-28 12:52:08',NULL),(162,'mail.ru llc',81,'2023-08-28 12:52:08',NULL),(176,'litemanagerteam',93,'2023-08-28 12:52:08',NULL),(186,'компания крипто-про',97,'2023-08-28 12:52:08',NULL),(187,'крипто-про',97,'2023-08-28 12:52:08',NULL),(188,'компания криптопро',97,'2023-08-28 12:52:08',NULL),(190,'kyocera document solutions inc.',99,'2023-08-28 12:52:08',NULL),(191,'kyocera mita corporation',99,'2023-08-28 12:52:08',NULL),(209,'canon inc.',112,'2023-08-28 12:52:08',NULL),(213,'syncmaster',116,'2023-08-28 12:52:08',NULL),(214,'s24d590',116,'2023-08-28 12:52:08',NULL),(215,'sme2220nw',116,'2023-08-28 12:52:08',NULL),(216,'samsung',116,'2023-08-28 12:52:08',NULL),(217,'sms27a550h',116,'2023-08-28 12:52:08',NULL),(218,'smb2430l',116,'2023-08-28 12:52:08',NULL),(219,'sms23a350h',116,'2023-08-28 12:52:08',NULL),(220,'sms27a650',116,'2023-08-28 12:52:08',NULL),(221,'sms24a450',116,'2023-08-28 12:52:08',NULL),(222,'samsung electronics co., ltd.',116,'2023-08-28 12:52:08',NULL),(223,'s24d300',116,'2023-08-28 12:52:08',NULL),(280,'0000',162,'2023-08-28 12:52:08',NULL),(281,'manufacturer0',162,'2023-08-28 12:52:08',NULL),(282,'manufacturer2',162,'2023-08-28 12:52:08',NULL),(283,'manufacturer1',162,'2023-08-28 12:52:08',NULL),(284,'manufacturer3',162,'2023-08-28 12:52:08',NULL),(290,'sony',169,'2023-08-28 12:52:08',NULL),(291,'sony corporation',169,'2023-08-28 12:52:08',NULL),(292,'sdm-s205f/k',169,'2023-08-28 12:52:08',NULL),(293,'sony computer entertainment inc.',169,'2023-08-30 14:13:31','reviakin.a'),(305,'cisco systems, inc.',180,'2023-08-28 12:52:08',NULL),(306,'cisco',180,'2023-08-28 12:52:08',NULL),(307,'cisco systems',180,'2023-08-28 12:52:08',NULL),(313,'axis communications ab',186,'2023-08-28 12:52:08',NULL),(319,'центр гранд',190,'2023-08-28 12:52:08',NULL),(320,'мгк гранд',190,'2023-08-28 12:52:08',NULL),(324,'lenovo group limited',193,'2023-08-28 12:52:08',NULL),(325,'lenovo',193,'2023-08-28 12:52:08',NULL),(326,'broadcom corporation',193,'2023-08-28 12:52:08',NULL),(327,'conexant',193,'2023-08-28 12:52:08',NULL),(343,'lcd2190uxp',203,'2023-08-28 12:52:08',NULL),(344,'ea192m',203,'2023-08-28 12:52:08',NULL),(345,'nec 90gx2',203,'2023-08-28 12:52:08',NULL),(346,'90gx2',203,'2023-08-28 12:52:08',NULL),(347,'nec electronics corporation',203,'2023-08-28 12:52:08',NULL),(348,'ea244wmi',203,'2023-08-28 12:52:08',NULL),(349,'sharp',204,'2023-08-28 12:52:08',NULL),(351,'oce-technologies b.v.',206,'2023-08-28 12:52:08',NULL),(383,'scad soft',233,'2023-08-28 12:52:08',NULL),(385,'toshiba',235,'2023-08-28 12:52:08',NULL),(386,'toshiba corporation',235,'2023-08-28 12:52:08',NULL),(402,'1c',253,'2023-08-28 12:52:08',NULL),(403,'1с-софт',253,'2023-08-28 12:52:08',NULL),(410,'corel corporation',260,'2023-08-28 12:52:08',NULL),(411,'winzip computing, inc.',260,'2023-08-28 12:52:08',NULL),(459,'ао \"лаборатория касперского\"',317,'2023-08-28 12:52:08',NULL),(460,'лаборатория касперского',317,'2023-08-28 12:52:08',NULL),(461,'\"лаборатория касперского\"',317,'2023-08-28 12:52:08',NULL),(462,'ao kaspersky lab',317,'2023-08-28 12:52:08',NULL),(637,'huawei technologies co.,ltd',496,'2023-08-28 12:52:08',NULL),(638,'d-link corporation',499,'2023-08-28 12:52:08',NULL),(639,'philips',520,'2023-08-28 12:52:08',NULL),(640,'dell',521,'2023-08-28 12:52:08',NULL),(641,'2369',523,'2023-08-28 12:52:08',NULL),(642,'2460x',523,'2023-08-28 12:52:08',NULL),(643,'2757m',523,'2023-08-28 12:52:08',NULL),(644,'аос 2470sw',523,'2023-08-28 12:52:08',NULL),(645,'2470sw',523,'2023-08-28 12:52:08',NULL),(646,'2050w',523,'2023-08-28 12:52:08',NULL),(647,'vg2436',524,'2023-08-28 12:52:08',NULL),(648,'vg150m',524,'2023-08-28 12:52:08',NULL),(649,'benq',525,'2023-08-28 12:52:08',NULL),(650,'ips236',526,'2023-08-28 12:52:08',NULL),(651,'zebra technologies corporation',529,'2023-08-28 12:52:08',NULL),(652,'vutlan',538,'2023-08-28 12:52:08',NULL);
...
CREATE TABLE `markers` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Название маркера',
  `color` varchar(7) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Цвет фона в HEX формате',
  `text_color` varchar(7) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Цвет текста (NULL = автоконтраст к фону)',
  `border_color` varchar(7) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Цвет рамки (NULL = без рамки)',
  `border_style` varchar(8) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Стиль рамки: solid/dashed',
  `comment` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Пояснение, когда применяется этот маркер',
  `archived` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'Признак архивирования',
  `updated_at` timestamp NULL DEFAULT NULL COMMENT 'Дата последнего изменения',
  `updated_by` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Автор последних изменений (username)',
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx-markers-name` (`name`),
  KEY `idx-markers-archived` (`archived`)
...
INSERT INTO `markers` VALUES (51,'Голубой (cyan)','#00FFFF',NULL,NULL,NULL,'Базовая палитра',0,'2026-07-13 03:50:00','admin'),(52,'Ярко-синий','#1DA7EE',NULL,NULL,NULL,'Базовая палитра',0,'2026-07-13 03:50:00','admin'),(53,'Серый','#808080',NULL,NULL,NULL,'Базовая палитра',0,'2026-07-13 03:50:00','admin'),(54,'Зелёный','#5CB85C',NULL,NULL,NULL,'Базовая палитра',0,'2026-07-13 03:50:00','admin'),(55,'Оранжевый','#FFA500',NULL,NULL,NULL,'Базовая палитра',0,'2026-07-13 03:50:00','admin'),(56,'Красный','#FF0000',NULL,NULL,NULL,'Базовая палитра',0,'2026-07-13 03:50:00','admin'),(57,'Серый, оранжевый текст','#808080','#FFA500',NULL,NULL,'Базовая палитра',0,NULL,'migration'),(58,'Пурпурный','#8B008B',NULL,NULL,NULL,'Базовая палитра',0,NULL,'migration'),(59,'Жёлтый','#FFFF00',NULL,NULL,NULL,'Базовая палитра',0,NULL,'migration'),(60,'Светло-зелёный','#90EE90',NULL,NULL,NULL,'Базовая палитра',0,NULL,'migration'),(61,'Салатовый (limegreen)','#32CD32',NULL,NULL,NULL,'Базовая палитра',0,NULL,'migration'),(62,'Тёмно-зелёный','#008000',NULL,NULL,NULL,'Базовая палитра',0,NULL,'migration'),(63,'Розовый','#FFC0CB',NULL,NULL,NULL,'Базовая палитра',0,NULL,'migration'),(64,'Светло-голубой','#87CEFA',NULL,NULL,NULL,'Базовая палитра',0,NULL,'migration'),(65,'Жёлтый, красный пунктир','#FFFF00',NULL,'#FF0000','dashed','Базовая палитра',0,NULL,'migration'),(66,'Светло-серый, оранжевый пунктир','#D3D3D3',NULL,'#FFA500','dashed','Базовая палитра',0,NULL,'migration'),(67,'Светло-зелёный, оранжевый пунктир','#90EE90',NULL,'#FFA500','dashed','Базовая палитра',0,NULL,'migration'),(68,'Розовый, оранжевый пунктир','#FFC0CB',NULL,'#FFA500','dashed','Базовая палитра',0,NULL,'migration'),(69,'Тёмный, оранжевая рамка и текст','#3C3C3C','#FFA500','#FFA500','solid','Базовая палитра',0,NULL,'migration'),(70,'Палевый (palegoldenrod)','#EEE8AA',NULL,NULL,NULL,'Базовая палитра',0,NULL,'migration'),(71,'Светло-жёлтый','#FFFFE0',NULL,NULL,NULL,'Базовая палитра',0,NULL,'migration'),(72,'Светло-зелёный, красная рамка','#90EE90',NULL,'#FF0000','solid','Базовая палитра',0,NULL,'migration'),(73,'Розовый, зелёная рамка','#FFC0CB',NULL,'#00FF00','solid','Базовая палитра',0,NULL,'migration'),(74,'Жёлто-зелёный (greenyellow)','#ADFF2F',NULL,NULL,NULL,'Базовая палитра',0,NULL,'migration'),(75,'Бежевый (burlywood)','#DEB887',NULL,NULL,NULL,'Базовая палитра',0,NULL,'migration'),(76,'Светло-оливковый','#EDEDCB',NULL,NULL,NULL,'Базовая палитра',0,NULL,'migration'),(77,'Пастельно-бирюзовый','#96DCE1',NULL,NULL,NULL,'Базовая палитра',0,NULL,'migration'),(78,'Серый средний','#949494',NULL,NULL,NULL,'Базовая палитра',0,NULL,'migration'),(79,'Хаки светлый','#C9C9A3',NULL,NULL,NULL,'Базовая палитра',0,NULL,'migration'),(80,'Пастельно-жёлтый','#EDEDB7',NULL,NULL,NULL,'Базовая палитра',0,NULL,'migration'),(81,'Пастельно-синий','#9DA1D7',NULL,NULL,NULL,'Базовая палитра',1,'2026-03-11 03:15:00','admin'),(82,'Пастельно-лиловый','#C080C0',NULL,NULL,NULL,'Базовая палитра',1,'2026-03-11 03:15:00','admin');
...
INSERT INTO `materials` VALUES (2,NULL,'2022-09-13',300,2,'Cabeus UTP-4 cat 5.e',6,6,'По результатам инвентаризации. Монтажники походу оставили',NULL,NULL,NULL,1,'2026-06-27 08:20:00','BorisBarinov'),(3,NULL,'2022-09-13',150,2,'Cabeus UTP-4 cat 5.e',6,6,'Походу монтажники оставили. Пол бухты примерно',NULL,NULL,NULL,1,'2026-06-27 08:20:00','BorisBarinov'),(4,3,'2023-03-02',150,2,'Cabeus UTP-4 cat 5.e',8,1,'Передали в Чел. на всякий случай',NULL,NULL,NULL,1,'2025-05-14 06:52:45',NULL),(5,NULL,'2022-02-13',1,3,'Cablexpert TK-NCT-01 обжимка+тестер',8,1,'Купил сам',NULL,1900,316.67,1,NULL,NULL),(9,NULL,'2021-12-28',25,4,'Набор MK270',6,6,'',NULL,28175,4695.83,1,NULL,NULL);
...
CREATE TABLE `net_domains` (
  ...
  KEY `idx-net_domains-marker_id` (`marker_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `net_domains` VALUES (1,'msk_dom','Московский L2 Домен',1,52),(2,'chl_dom','',7,61);
...
INSERT INTO `networks` VALUES (1,'MSK_SRV_LAN',8,'10.20.75.0/24',169102080,24,169102081,169085450,'Сеть общих сервисов Мск',6,'',0,'','1-50 static\r\n51-100 dhcp','10.20.75.10\n10.20.75.11','2026-07-15 05:30:00','DaniilZimin'),(2,'CHL_SRV_LAN',6,'10.50.75.0/24',171068160,24,171068161,171068170,'Сеть общих сервисов Чел',6,'',0,'','1-50 static\r\n51-100 dhcp','10.50.75.10','2026-07-15 05:30:00','DaniilZimin'),(3,'CHL_IT_LAN',9,'10.50.30.0/24',171056640,24,171056641,171068170,'IT сеть Челябинск',8,'',0,'','1-50 static\r\n51-100 dhcp','10.50.75.10','2026-07-15 05:30:00','DaniilZimin'),(4,'CHL_MGMT_LAN',12,'10.50.1.0/24',171049216,24,171049217,171068170,'Сеть управления Чел',9,'',0,'','1-100 static\r\n101-200 dhcp','10.50.75.10','2026-07-15 05:30:00','DaniilZimin'),(5,'CHL_OPEN_LAN',7,'10.50.100.0/23',171074560,23,171074561,171068170,'Открытая сеть',1,'### IPAM\r\n  * Сервера - до 20го адреса включительно\r\n  * Клиенты - от 21 до 510',0,'','1-20 static servers\r\n21-100 dhcp clients','10.50.75.10','2026-08-01 07:00:00','admin'),(6,'CHL_OVPN_LAN',5,'10.50.50.0/24',171061760,24,171061761,171061761,'Сеть клиентов OpenVPN Чел',3,'### IPAM\r\nНа OpenVPN за каждым клиентом фиксируется статический адрес через CCD\r\n\r\n### Дополнительно\r\nКаждый клиент может получить дополнительный доступ на фаерволе на уровне IP после согласования служебки через ИБ',NULL,NULL,NULL,'10.50.50.1','2026-08-01 07:00:00','admin'),(7,'CHL_PRN_LAN',13,'10.50.40.0/24',171059200,24,171059201,171068170,'Сеть принтеров Чел',2,'',NULL,NULL,NULL,'10.50.75.10','2026-08-01 07:00:00','admin'),(8,'CHL_VOIP_LAN',11,'10.50.7.0/24',171050752,24,171050753,171068170,'Сеть телефонии Чел',7,'',NULL,NULL,NULL,'10.50.75.10',NULL,NULL),(9,'MSK_CLOSED_LAN',3,'10.20.101.0/24',169108736,24,169108737,169102090,'Закрытая сеть Мск',4,'',0,'','1-50 static\r\n51-100 dhcp','10.20.75.10\n10.20.75.11',NULL,NULL),(10,'MSK_DMZ_LAN',4,'55.66.77.80/28',927092048,28,927092049,NULL,'Сеть DMZ сервисов Мск',5,'',NULL,NULL,NULL,'',NULL,NULL),(11,'MSK_DOMRU_LAN',17,'55.66.77.76/30',927092044,30,927092045,NULL,'Подключение Домр.РУ Мск',10,'',NULL,NULL,NULL,'',NULL,NULL),(12,'MSK_MGMT_LAN',15,'10.20.1.0/24',169083136,24,169083137,169102090,'Сеть управления Мск',9,'',0,'','1-50 static\r\n51-200 dhcp','10.20.75.10\n10.20.75.11',NULL,NULL),(13,'MSK_OPEN_LAN',2,'10.20.100.0/24',169108480,24,169108481,169102090,'Открытая сеть Мск',1,'',0,'','1-20 static\r\n21-100 dhcp','10.20.75.10\n10.20.75.11',NULL,NULL),(14,'MSK_OVPN_LAN',1,'10.20.50.0/24',169095680,24,169095681,169095681,'Сеть OpenVPN МСК',3,'### Назначение сети\r\nПодключение клиентов в изолированную сеть с доступом до ограниченного количества ресурсов\r\n\r\n### Доступ\r\n- Терминальный сервер 1С\r\n- Телефония\r\n- Мониторинг\r\n\r\nвсе остальные подключения только через служебку согласованную в ИБ\r\n',0,'','1-20 reserved\r\n21-40 admin\r\n41-100 users','10.20.50.1',NULL,NULL),(15,'MSK_PRN_LAN',16,'10.20.40.0/24',169093120,24,169093121,169102090,'Сеть принтеров Мск',2,'',0,'','','10.20.75.10\n10.20.75.11',NULL,NULL),(16,'MSK_VOIP_LAN',10,'10.20.7.0/24',169084672,24,169084673,169102090,'Сеть телефонии Мск',7,'',0,'','','10.20.75.10\n10.20.75.11',NULL,NULL),(17,'CHL_RT_LAN',18,'66.77.88.96/30',1112365152,30,1112365153,NULL,'Челябинский ввод интернет',10,'',NULL,NULL,NULL,'',NULL,NULL),(18,'S2S_VPN_LAN',NULL,'10.0.0.0/30',167772160,30,NULL,NULL,'Для соединения VPN серверов между собой',11,'',NULL,NULL,NULL,NULL,NULL,NULL),(19,'MSK_SURV_LAN',20,'10.20.33.0/24',169091328,24,169091329,169102090,'Сеть видеонаблюдения',12,'',0,'','1-9 static\r\n10-100 dhcp','10.20.75.10','2025-08-29 07:41:54',NULL),(9001,'MSK_OLD_LAN',NULL,'10.20.90.0/24',169105920,24,NULL,NULL,'Сеть старого файлового сервера, выведена',6,'',1,'','',NULL,'2026-06-30 09:30:00','VeniaminLevchenko');
...
INSERT INTO `networks_in_aces` VALUES (9001,9003,3);
...
CREATE TABLE `notifications` (
  `id` int NOT NULL AUTO_INCREMENT,
  `user_id` int NOT NULL COMMENT 'Получатель',
  `event_key` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Ключ дедупликации/повторов',
  `subject` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Тема письма',
  `body` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'Готовый HTML письма',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Поставлено в очередь',
  `sent_at` timestamp NULL DEFAULT NULL COMMENT 'Отправлено (NULL = в очереди)',
  `attempts` int NOT NULL DEFAULT '0' COMMENT 'Число неудачных попыток отправки',
  `last_error` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Последняя ошибка отправки',
  PRIMARY KEY (`id`),
  KEY `idx-notifications-sent_at` (`sent_at`),
  KEY `idx-notifications-dedup` (`user_id`,`event_key`,`sent_at`),
...
INSERT INTO `notifications` VALUES (9001,1,'contracts:7:state_id','Документ «Счет № 213 - Серверные шкафы в Чел и Мск»: Состояние — Оплачено 100%','<p>Документ <a href=\"/contracts/view?id=7\">Счет № 213 - Серверные шкафы в Чел и Мск</a></p><p><strong>Состояние:</strong> Ожидает оплаты &rarr; Оплачено 100%</p>','2026-08-19 02:12:00','2026-08-19 02:15:04',0,NULL),(9002,9,'contracts:7:state_id','Документ «Счет № 213 - Серверные шкафы в Чел и Мск»: Состояние — Оплачено 100%','<p>Документ <a href=\"/contracts/view?id=7\">Счет № 213 - Серверные шкафы в Чел и Мск</a></p><p><strong>Состояние:</strong> Ожидает оплаты &rarr; Оплачено 100%</p>','2026-08-19 02:12:00','2026-08-19 02:15:05',0,NULL),(9003,6,'contracts:3:state_id','Документ «Счет №456 Серверное оборудование в МСК»: Состояние — Оплачено 100%','<p>Документ <a href=\"/contracts/view?id=3\">Счет №456 Серверное оборудование в МСК</a></p><p><strong>Состояние:</strong> Согласовано &rarr; Оплачено 100%</p>','2026-08-24 06:40:00',NULL,0,NULL),(9004,1,'watch:contracts_paywait:4','Документ «Счет№ 709 Оборудование в офисы» ждёт оплаты больше 30 дней','<p>Документ <a href=\"/contracts/view?id=4\">Счет№ 709 Оборудование в офисы</a> в состоянии «Ожидает оплаты» с 21.12.2021.</p>','2026-08-26 00:00:00',NULL,3,'SMTP: Connection could not be established with host localhost: stream_socket_client(): connection refused'),(9005,10,'watch:contracts_paywait:4','Документ «Счет№ 709 Оборудование в офисы» ждёт оплаты больше 30 дней','<p>Документ <a href=\"/contracts/view?id=4\">Счет№ 709 Оборудование в офисы</a> в состоянии «Ожидает оплаты» с 21.12.2021.</p>','2026-08-26 00:00:00','2026-08-26 00:00:12',1,NULL),(9006,5,'contracts:7:total','Документ «Счет № 213 - Серверные шкафы в Чел и Мск»: Сумма — 39 611,00 руб.','<p>Документ <a href=\"/contracts/view?id=7\">Счет № 213 - Серверные шкафы в Чел и Мск</a></p><p><strong>Сумма:</strong> <i>(пусто)</i> &rarr; 39 611,00 руб.</p>','2026-07-30 04:21:00','2026-07-30 04:25:00',0,NULL);
...
INSERT INTO `org_inet` VALUES (1,'Москва - Домру','81.200.15.42','255.255.255.248','81.200.15.41','81.200.14.1','81.200.14.2','Оптика (Ethernet), 100 Мбит/с',1,'100 мбит/с, оптика, DMZ\r\nпредоплата',1,'120000234/vip','',10100.00,2020.00,1,NULL,0),(2,'Челябинск - РТ','92.53.104.18','255.255.255.252','92.53.104.17','92.53.96.1','8.8.8.8','Оптика (Ethernet), 50 Мбит/с',1,'100 Мбит/с, оптика, \r\nПостоплата 20го числа',7,'19000003555','Порт 19 циски',17500.00,3500.00,2,NULL,0);
...
) ENGINE=InnoDB AUTO_INCREMENT=9004 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Структурные подразделения';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `org_struct` VALUES ('1',1,'4','Бухгалтерия',4,1),('2',1,'4','Отдел продаж',4,2),('3',1,'4','Отдел ИТ',4,3),('4',1,NULL,'Генеральная дирекция',NULL,4),('5',1,NULL,'Хозяйственный отдел',NULL,5),('31',1,'3','Группа поддержки пользователей',3,9001),('32',1,'3','Группа сопровождения 1С',3,9002),('21',1,'2','Корпоративные продажи',2,9003);
...
INSERT INTO `places` VALUES (1,NULL,'Московская площадка','143441, Московская область, Красногорский район, 69 километр МКАД, корпус 33, 17й этаж','МСК','Москва',303,'','{\"places\":{\"3\":{\"x\":7,\"y\":242,\"width\":200,\"height\":147},\"4\":{\"x\":211,\"y\":198,\"width\":282,\"height\":145},\"2\":{\"x\":716,\"y\":237,\"width\":112,\"height\":195},\"5\":{\"x\":536,\"y\":78,\"width\":177,\"height\":184},\"6\":{\"x\":295,\"y\":496,\"width\":184,\"height\":96}}}',303),(2,1,'Рецепшен','','','Рец',305,'','{\"techs\":{\"39\":{\"x\":715,\"y\":10,\"width\":24,\"height\":25},\"36\":{\"x\":718,\"y\":249,\"width\":25,\"height\":25}}}',305),(3,1,'Бухгалтерия','оф. 1711','','Бух',304,'Открытое пространство, 4 рабочих места','{\"techs\":{\"5\":{\"x\":9,\"y\":248,\"width\":66,\"height\":66},\"6\":{\"x\":9,\"y\":317,\"width\":66,\"height\":66},\"41\":{\"x\":142,\"y\":246,\"width\":50,\"height\":50},\"37\":{\"x\":200,\"y\":363,\"width\":25,\"height\":25}}}',304),(4,1,'Менеджеры','оф. 1712','','Мен',306,'Открытое пространство, 6 рабочих мест','{\"techs\":{\"7\":{\"x\":220,\"y\":271,\"width\":66,\"height\":66},\"17\":{\"x\":253,\"y\":204,\"width\":66,\"height\":66},\"42\":{\"x\":404,\"y\":352,\"width\":50,\"height\":50},\"38\":{\"x\":505,\"y\":154,\"width\":25,\"height\":25}}}',306),(5,1,'Генеральный','','','Ген',308,'','',308),(6,1,'Серверная','оф. 1715','','Серв.',307,'Стойка ND-05C, кондиционер, СКУД на двери','{\"techs\":{\"18\":{\"x\":331,\"y\":528,\"width\":30,\"height\":45},\"40\":{\"x\":298,\"y\":498,\"width\":25,\"height\":25}}}',307),(7,NULL,'Челябинская площадка','454080, г. Челябинск, ул. Энгельса, 77А оф707','ЧЕЛ','Чел',NULL,'',NULL,NULL),(8,7,'Серверная','каб 5.','','Серв.',NULL,'Стойка ND-05C, вход по ключу у дежурного',NULL,NULL),(9,7,'Бухгалтерия','каб. 3','','Бух.',NULL,'',NULL,NULL),(10,7,'Менеджеры','каб 2.','','Мен.',NULL,'',NULL,NULL),(11,7,'Кабинет ИТ','каб. 4','','ИТ',NULL,'Рабочие места ИТ, тестовый стенд',NULL,NULL),(13,5,'Приемная','','','Приемная',NULL,'',NULL,NULL),(14,5,'Комната отдыха','','','К.О.',NULL,'',NULL,NULL);
...
CREATE TABLE `ports` (
  ...
  `aggr` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `ports` VALUES (1,12,NULL,'Ge0/1','Access Vlan1',2,NULL),(2,1,NULL,'iLO','красный патчкорд',1,NULL),(3,12,NULL,'Ge0/3','Trunk',4,NULL),(4,1,NULL,'eth1','синий патчкорд',3,NULL),(5,12,NULL,'Ge0/5','Trunk',6,NULL),(6,1,NULL,'eth2','синий патчкорд',5,NULL),(7,12,NULL,'Ge0/2','Access Vlan1',8,NULL),(8,2,NULL,'iLO','красный патчкорд',7,NULL),(9,12,NULL,'Ge0/4','Trunk',10,NULL),(10,2,NULL,'eth1','синий патчкорд',9,NULL),(11,12,NULL,'Ge0/6','Trunk',12,NULL),(12,2,NULL,'eth2','синий патчкорд',11,NULL),(13,45,NULL,'Head1','Желтый патчкорд',14,NULL),(14,12,NULL,'Ge0/7','Access Vlan1',13,NULL),(15,45,NULL,'Head2','Желтый патчкорд',16,NULL),(16,12,NULL,'Ge0/8','Access Vlan1',15,NULL),(17,22,NULL,'Gi1/0/48','Зеленый патчкорд',19,'Po1'),(18,12,NULL,'Ge0/23','Зеленый патчкорд',20,'Po1'),(19,12,NULL,'Ge0/24','Зеленый патчкорд',17,'Po1'),(20,22,NULL,'Gi1/0/47','Зеленый патчкорд',18,'Po1'),(9001,22,NULL,'Gi1/0/1','Бухгалтерия, розетка 12',9002,NULL),(9002,46,NULL,'Internet','Аплинк в коммутатор',9001,NULL),(9003,46,NULL,'PC','Транзит на рабочее место',9004,NULL),(9004,5,NULL,'eth','Через телефон',9003,NULL),(9005,22,NULL,'Gi1/0/2','Бухгалтерия, розетка 13',9006,NULL),(9006,47,NULL,'Internet','Аплинк в коммутатор',9005,NULL),(9007,47,NULL,'PC','Транзит на рабочее место',9008,NULL),(9008,6,NULL,'eth','Через телефон',9007,NULL),(9009,22,NULL,'Gi1/0/3','Менеджеры, розетка 21',9010,NULL),(9010,48,NULL,'Internet','Аплинк в коммутатор',9009,NULL),(9011,48,NULL,'PC','Транзит на рабочее место',9012,NULL),(9012,7,NULL,'eth','Через телефон',9011,NULL),(9013,22,NULL,'Gi1/0/4','Менеджеры, розетка 22',9014,NULL),(9014,49,NULL,'Internet','Аплинк в коммутатор',9013,NULL),(9015,49,NULL,'PC','Транзит на рабочее место',9016,NULL),(9016,17,NULL,'eth','Через телефон',9015,NULL),(9017,22,NULL,'Gi1/0/10','Рецепшен, видеонаблюдение',9018,NULL),(9018,36,NULL,'Eth1','Сеть',9017,NULL),(9019,14,NULL,'Ge0/24','Аплинк на ЧЕЛ-КОМ-0002',9020,NULL),(9020,23,NULL,'Gi1/0/48','Аплинк на ЧЕЛ-КОМ-0001',9019,NULL),(9021,14,NULL,'Ge0/1','Управление ЧЕЛ-СРВ-0001',9022,NULL),(9022,33,NULL,'iLO','Сервисный интерфейс',9021,NULL),(9023,14,NULL,'Ge0/2','ЧЕЛ-СРВ-0001',9024,NULL),(9024,33,NULL,'eth1','Первый порт',9023,NULL),(9025,14,NULL,'Ge0/3','Управление ЧЕЛ-СРВ-0002',9026,NULL),(9026,34,NULL,'iLO','Сервисный интерфейс',9025,NULL),(9027,14,NULL,'Ge0/4','ЧЕЛ-СРВ-0002',9028,NULL),(9028,34,NULL,'eth1','Первый порт',9027,NULL),(9029,23,NULL,'Gi1/0/1','Бухгалтерия, розетка 4',9030,NULL),(9030,50,NULL,'Internet','Аплинк в коммутатор',9029,NULL),(9031,50,NULL,'PC','Транзит на рабочее место',9032,NULL),(9032,8,NULL,'eth','Через телефон',9031,NULL),(9033,23,NULL,'Gi1/0/2','Бухгалтерия, розетка 5',9034,NULL),(9034,51,NULL,'Internet','Аплинк в коммутатор',9033,NULL),(9035,51,NULL,'PC','Транзит на рабочее место',9036,NULL),(9036,9,NULL,'eth','Через телефон',9035,NULL),(9037,23,NULL,'Gi1/0/3','Менеджеры, розетка 7',9038,NULL),(9038,52,NULL,'Internet','Аплинк в коммутатор',9037,NULL),(9039,52,NULL,'PC','Транзит на рабочее место',9040,NULL),(9040,10,NULL,'eth','Через телефон',9039,NULL),(9041,23,NULL,'Gi1/0/4','Менеджеры, розетка 8',9042,NULL),(9042,53,NULL,'Internet','Аплинк в коммутатор',9041,NULL),(9043,53,NULL,'PC','Транзит на рабочее место',9044,NULL),(9044,11,NULL,'eth','Через телефон',9043,NULL),(9045,23,NULL,'Gi1/0/5','Кабинет ИТ, розетка 1',9046,NULL),(9046,54,NULL,'Internet','Аплинк в коммутатор',9045,NULL),(9047,23,NULL,'Gi1/0/6','Кабинет ИТ, розетка 2',9048,NULL),(9048,55,NULL,'Internet','Аплинк в коммутатор',9047,NULL),(9049,9001,NULL,'Gi2/0/48','Аплинк на ЧЕЛ-КОМ-0001',9050,NULL),(9050,14,NULL,'Ge0/23','Аплинк на второй юнит стека',9049,NULL),(9051,9001,NULL,'Gi2/0/1','Серверная, патч-панель 2',9052,NULL),(9052,24,NULL,'eth','Док-станция',9051,NULL);
...
INSERT INTO `sandboxes` VALUES (1,'Тестовая песочница 1С','1C_TEST',0,NULL,NULL,0,'2026-07-09 09:05:00','VeniaminLevchenko'),(2,'Тестовая песочница ИТ','TEST',0,NULL,NULL,0,'2026-07-09 09:05:00','VeniaminLevchenko'),(9001,'Песочница миграции 1С 8.2','1C82_MIGR',0,'Снесена после перевода базы на 8.3','',1,'2026-04-02 06:00:00','admin');
...
CREATE TABLE `scans` (
  ...
  `users_id` int DEFAULT NULL COMMENT 'Сотрудник, к которому прикреплён скан (фото)',
  PRIMARY KEY (`id`),
  KEY `contracts_id` (`contracts_id`),
  ...
  KEY `idx-scans-users_id` (`users_id`)
...
INSERT INTO `scans` VALUES (199,NULL,'png','1-SPA504G2',NULL,2,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(200,NULL,'png','200-0cbd4013e35a41f6af9d9a22de4a8c0',NULL,10,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(201,NULL,'png','201-grandstream_dp750_451022_4',NULL,14,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(202,NULL,'png','202-pngegg',NULL,17,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(203,NULL,'png','203-pngegg _1_',NULL,17,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(204,NULL,'png','204-UBIQUITI-AP-AC-LR-2199032254',NULL,31,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(205,NULL,'png','205-BACK-UPS ES400',NULL,55,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(206,NULL,'png','206-16966',NULL,57,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(207,NULL,'png','207-232d',NULL,58,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(208,NULL,'png','208-APC-BK650EI-301692254',NULL,59,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(209,NULL,'png','209-APC-BK650EI-301692241',NULL,59,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(210,NULL,'png','210-scale-dec-558x600 _1_',NULL,61,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(211,NULL,'png','211-scale-dec-558x600',NULL,61,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(212,NULL,'png','212-APC-800VA,-230V,-AVR,-Schuko-Outlets,-CIS-BX800CI-RS-1434382254 _1_',NULL,65,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(213,NULL,'png','213-APC-800VA,-230V,-AVR,-Schuko-Outlets,-CIS-BX800CI-RS-1434382241',NULL,65,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(214,NULL,'png','214-APC-BX700UI-2080232254',NULL,69,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(215,NULL,'png','215-APC-BX700UI-2080232241',NULL,69,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(216,NULL,'png','216-APC-BX950UI-2080242254',NULL,73,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(217,NULL,'png','217-APC-BX950UI-2080242241',NULL,73,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(218,NULL,'png','218-CyberPower-BR850ELCD-779982254',NULL,74,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(219,NULL,'png','219-APC-650VA,-AVR,-230V,-Schuko-Sockets,-CIS-BX650CI-RS-1258122254',NULL,75,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(220,NULL,'png','220-APC-650VA,-AVR,-230V,-Schuko-Sockets,-CIS-BX650CI-RS-1258122241',NULL,75,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(221,NULL,'png','221-m1120',NULL,87,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(222,NULL,'png','222-4012i',NULL,88,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(223,NULL,'png','223-avaya-1608-i',NULL,99,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(224,NULL,'png','224-1161576',NULL,100,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(225,NULL,'png','225-1181965',NULL,104,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(226,NULL,'png','226-SIP-t31g',NULL,138,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(227,NULL,'png','227-SIP-T46U',NULL,139,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(228,NULL,'png','228-ws-c3560x-24t-s_2-1200x800',NULL,151,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(229,NULL,'png','229-ws-c3560x-24t-s_3-1200x800',NULL,151,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(230,NULL,'png','230-10103655_1',NULL,152,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(231,NULL,'png','231-10103655__3_3',NULL,152,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(232,NULL,'jpg','232-149-G430',NULL,171,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(233,NULL,'png','233-ADS2800W_main',NULL,183,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(234,NULL,'png','234-ADS2800W_left',NULL,183,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(235,NULL,'png','235-oceanstor-2200-v3',NULL,184,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(236,NULL,'png','236-DEPO_Neos_DF226_670',NULL,187,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(237,NULL,'png','237-DELL-U2412M-1239912254',NULL,190,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(238,NULL,'png','238-cca40c3a86831c9adc7d1afb0c8255a9',NULL,190,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(239,NULL,'jpg','239-DELL-U2412M-1239912312',NULL,190,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(240,NULL,'png','240-aac5fcd72707e7f423defe936dd85619992ab332',NULL,193,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(241,NULL,'png','241-364cdaa073c21d05d094dea688ffa765f3ec9456',NULL,193,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(242,NULL,'png','242-dfca307953924a054675f439d578f5a61ce5ef67',NULL,193,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(243,NULL,'png','243-b4a190e9faa3dd8fa06c819d95f20d1a10cf19cc',NULL,193,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(244,NULL,'png','244-696528',NULL,195,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(245,NULL,'png','245-orig _2__proc',NULL,199,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(246,NULL,'png','246-orig_proc',NULL,199,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(247,NULL,'png','247-orig _1__proc',NULL,199,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(248,NULL,'png','248-APC-Power-Saving-900,-230V-BR900GI-1088272254',NULL,214,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(249,NULL,'png','249-br900gi-10122970vNcHamL8P7bO5',NULL,214,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(250,NULL,'png','250-20220525064527878ec88633f42e095b0379dfa777105',NULL,235,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(251,NULL,'png','251-apc-smart-ups-3000va-usb-serial-rm-2u-230v-sua3000rmi2u',NULL,238,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(252,NULL,'jpg','252-apc-3000va-usb-serial-rm-2u-230v-sua3000rmi2u-189172241',NULL,238,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(253,NULL,'png','253-apc-1000va-usb-serial-rm-2u-230v-sua1000rmi2u-163832254',NULL,239,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(254,NULL,'jpg','254-apc-1000va-usb-serial-rm-2u-230v-sua1000rmi2u-163832241',NULL,239,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(255,NULL,'png','255-07_Yoga_C940_Iron_Grey_15Inch_Hero_Tent_Voice_Assistant_Cortana',NULL,241,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(256,NULL,'png','256-fa4416c04ffbbf2bd1be51c62b827137',NULL,241,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(257,NULL,'png','257-5746f95f1939f208c12b645b94a798c4',NULL,241,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(258,NULL,'png','258-1000x1000_1',NULL,242,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(259,NULL,'jpg','259-295842_v01_b',NULL,256,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(260,NULL,'png','260-pngegg _3_',NULL,271,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(261,NULL,'png','261-HP_t620_Thin_Client_back_bennoshop_600x600@2x',NULL,271,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(262,NULL,'png','262-559-SYS-6025B-3RV',NULL,274,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(263,NULL,'jpg','263-gibridnij-massiv-hraneniya-dannih-netapp-fas2554',NULL,275,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(264,NULL,'jpg','264-561-gibridnij-massiv-hraneniya-dannih-netapp-fas2554 _1_.jpg_thumb_160x160',NULL,275,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(265,NULL,'png','265-7_y4jv-h4',NULL,278,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(266,NULL,'png','266-apc-br650mi-pro-front',NULL,279,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(267,NULL,'png','267-apc-br650mi-pro-back',NULL,279,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(268,NULL,'png','268-WA6330',NULL,281,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(269,NULL,'png','269-product_pic',NULL,284,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(270,NULL,'png','270-47',NULL,309,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(271,NULL,'jpg','271-5468452',NULL,309,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(272,NULL,'png','272-1005639_v01_b',NULL,310,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(273,NULL,'jpg','273-1005639_v10_b',NULL,310,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(274,NULL,'jpg','274-1005639_v05_b',NULL,310,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(275,NULL,'jpg','275-1005639_v02_b',NULL,310,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(276,NULL,'png','276-Mini_PK_RDW_Computers_1',NULL,311,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(277,NULL,'png','277-1676587032348',NULL,330,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(278,NULL,'png','278-1676584183821',NULL,330,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(279,NULL,'png','279-slm2008pt-eu-10108158-014c6s8NRxg6cD8N',NULL,381,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(280,NULL,'png','280-5ebb4058f57e9f61879a666c59b59c7b',NULL,387,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(281,NULL,'png','281-1bc255ac4c76a074e8e99147f5267344',NULL,388,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(282,NULL,'png','282-HPE_ProLiant_DL380_Gen9',NULL,4,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(283,3,'pdf','283-Счет №456 от 17.11.2020г',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(284,NULL,'png','284-intel-nuc',NULL,327,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(285,4,'pdf','285-2021-12-21 Счет№ 709 Оборудование в офисы',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(286,NULL,'png','286-Hb9a2b5f9b3e44a9fa19a5b3afdcc45a7T',NULL,194,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(287,NULL,'png','287-KX-TG1611_Spec2',NULL,262,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(288,NULL,'png','288-DP720_side_cradle_web',NULL,15,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(289,NULL,'png','289-0bbc86c5c6692524f51156798c383ed3',NULL,252,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(290,NULL,'png','290-gac2500_main_picture_2',NULL,54,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(291,NULL,'png','291-gac2500_top',NULL,54,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(292,NULL,'png','292-1451',NULL,389,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(293,NULL,'png','293-f3101f1cf5e7bd8d59c3fed39a166c86',NULL,38,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(294,NULL,'png','294-msa2052b',NULL,390,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(295,NULL,'png','295-msa2052',NULL,390,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(296,5,'pdf','296-________',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(300,7,'pdf','299-testFax',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(301,NULL,'jpg','301-188362-6afa9-42460626-m750x740-ub5b3a',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(302,NULL,'jpg','302-561ee21418326133449e5c443bb49228',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(303,NULL,'jpg','303-3',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(304,NULL,'jpg','304-1',3,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(305,NULL,'jpg','305-4',2,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(306,NULL,'jpg','306-2',4,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(307,NULL,'jpg','307-5',6,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(308,NULL,'jpg','308-6',5,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `segments` (
  ...
  KEY `idx-segments-marker_id` (`marker_id`)
) ENGINE=InnoDB AUTO_INCREMENT=9002 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `segments` VALUES (1,'Открытый','Для компьютеров с доступом в интернет','segment_open','### Назначение сегмента\r\nВ этом сегменте находятся компьютеры с доступом в интернет, но без доступа к ресурсам закрытого сегмента',NULL,NULL,'2026-07-15 05:35:00','DaniilZimin',60),(2,'Сеть принтеров','Для принтеров','segment_prn','### Назначение сегмента\r\nСегмент для принтеров необходим для возможности печати на принтеры только с серверов печати и блокировки доступа пользователей к печатному оборудованию напрямую\r\n\r\n### Доступ\r\n- Из сети серверов открыт\r\n- Из остальных закрыт сетей закрыт\r\n- Печать из остальных сетей через сервера печати в сети серверов \r\n- Исходящие SMB соединения до файловых серверов и в интернет по порту SMTP для возможности сетевого сканирования  ',NULL,NULL,NULL,NULL,53),(3,'Клиентский VPN','Для сетей VPN клиентов','segment_guest_dmz','### Назначение сегмента\r\nПоскольку с другого конца клиентского VPN может быть BYOD устройство (а на самом деле в основном они и есть), то все их IP адреса должны быть помещены в некий гостевой DMZ с фильтрацией доступа в остальные сегменты.\r\n\r\n### Доступ\r\n  * до ресурсов доступных из интернет\r\n  * до корпоративного портала и чата\r\n  * терминальных сервисов без буфера обмена и монтирования устройств',NULL,NULL,NULL,NULL,69),(4,'Закрытый','Закрытые ресурсы','segment_closed','### Назначение сегмента\r\nЗакрытые ресурсы, представляющие собой коммерческую тайну и клиентские устройства с доступом к ней и без доступа в интернет и в открытый сегмент.\r\n\r\n### Доступ\r\n  * До сети серверов для доступа к инфраструктурным сервисам  \r\n  * До прокси сервера где через белый список доступ до серверов обновлений\r\n  * До сервера печати где доступ только к принтерам через сервис контроля печати',NULL,NULL,'2026-07-15 05:35:00','DaniilZimin',63),(5,'Внешний DMZ','Для сервисов доступных из интернет','segment_ext_dmz','### Назначение сегмента\r\nОграничение доступа серверов доступных из интернет к остальной сети, для ограничения масштабов взлома при прорыве внешнего контура\r\n\r\n### Доступ\r\n  * До инфраструктурных сервисов\r\n  * Для каждого сервиса также индивидуальный доступ',NULL,NULL,NULL,NULL,65),(6,'Сеть серверов','Ресурсы доступные для всех','segment_common','### Назначение сегмента\r\nВ этом сегменте расположены сервисы, которые должны быть доступны и из закрытого и из открытого сегментов\r\n\r\n### Доступ\r\nОтовсюду но только по адресам/портам размещенных сервисов',NULL,NULL,'2026-07-15 05:35:00','DaniilZimin',64),(7,'VoIP','Для устройств VoIP','segment_voip','### Назначение сегмента\r\nВ сетях этого сегмента должен быть настроен DHCP autoprovision (опция 66) для автоматического подключения телефонов к АТС\r\n\r\n### Доступ\r\nСервер телефонии может бросать исходящие соединения наружу по SIP (+RTP), также нужен проброс входящих SIP (+RTP) с белого списка (провайдеров телефонии) на сервер телефонии для входящих вызовов.  \r\nОстальной доступ ограничен, т.к. телефония очень финансово чувствительна ко взлому  \r\n(сразу начнутся звонки в Бразилию, Китай и т.п. где в течение дня можно получить счет на сотни тыс.р.)',NULL,NULL,'2026-08-01 07:05:00','admin',74),(8,'IT сегмент','Сеть для рабочих мест админов','segment_it_lan','### Назначение сегмента\r\nОрганизация доступа сисадминов до всей инфраструктуры\r\n\r\n### Доступ\r\nИз этого сегмента полный доступ во все остальные  \r\nВ этот сегмент только RDP доступ с VPN адресов админов до своих машин для удаленной работы  \r\n(взлом узлов этой сети чрезвычайно опасен, т.к. даст далее доступ до всей сети)',NULL,NULL,'2026-08-01 07:05:00','admin',55),(9,'Сегмент управления','Для управления устройствами','segment_mgmt','### Назначение сегмента\r\nРазмещение адресов интерфейсов управления оборудованием\r\n\r\n### Доступ\r\nТолько ИТ из сети\r\nИсходящие соединения только до инфраструктурных сервисов',NULL,NULL,'2026-08-01 07:05:00','admin',76),(10,'Внешний','Для внешних подключений','segment_ext','### Назначение сегмента\r\nТут находятся очевидно все сервисы доступные напрямую из интернет\r\n\r\n### Доступ\r\nПоскольку тут сервисы имеют внешний адрес с доступом из интернет, и это не DMZ, то фаервол нужно ставить на каждый узел отдельно',NULL,NULL,NULL,NULL,59),(11,'Межсайтовый VPN','Для связи между площадками','segment_intersite_vpn','',NULL,NULL,NULL,NULL,51),(12,'Сегмент видеонаблюдения','Видеокамеры, регистраторы','segment_skud','',NULL,'','2025-08-29 07:29:54',NULL,75),(9001,'Гостевой WiFi (закрыт)','Сегмент гостевой сети, закрыт после перехода на ваучеры','segment_guest_wifi_old','',1,'','2026-05-18 04:10:00','DaniilZimin',NULL);
...
--
-- Table structure for table `segments_in_aces`
--

DROP TABLE IF EXISTS `segments_in_aces`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `segments_in_aces` (
  `id` int NOT NULL AUTO_INCREMENT,
  `aces_id` int DEFAULT NULL,
  `segments_id` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `segments_in_aces-m2m` (`aces_id`,`segments_id`),
  KEY `segments_in_aces-aces_id` (`aces_id`),
  KEY `segments_in_aces-segments_id` (`segments_id`)
) ENGINE=InnoDB AUTO_INCREMENT=9306 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `segments_in_aces`
--

LOCK TABLES `segments_in_aces` WRITE;
/*!40000 ALTER TABLE `segments_in_aces` DISABLE KEYS */;
INSERT INTO `segments_in_aces` VALUES (9300,9300,1),(9301,9301,8),(9303,9303,8),(9304,9304,1);
/*!40000 ALTER TABLE `segments_in_aces` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `services` VALUES (1,'Услуги связи - Дом.Ру','Связь в МСК','',1,'',10,1,2,10,NULL,8500,1416.67,7,NULL,0,0,1,'',100,NULL,'[]',NULL,NULL,NULL,'2025-12-17 12:34:36',NULL),(2,'Услуги связи - РТ','Услуги связи РТ в Челябинске','',1,'',10,1,2,10,NULL,6200,1033.33,57,7,0,0,1,'',100,NULL,'[]',NULL,NULL,NULL,'2025-12-17 12:34:43',NULL),(3,'Управление сетью','Все что связано с сетевыми вопросами','',0,'',1,1,3,9,NULL,NULL,NULL,NULL,NULL,0,0,1,'',100,NULL,NULL,NULL,NULL,NULL,'2026-08-17 06:00:00','admin'),(4,'Локальная сеть (LAN)','Коммутация устройств','',0,'',NULL,NULL,NULL,NULL,3,NULL,NULL,NULL,NULL,0,1,1,'',100,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(5,'Управление виртуализацией','Все услуги и сервисы по виртуализации','',0,'',9,1,2,9,NULL,NULL,NULL,NULL,NULL,0,0,1,'',100,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(6,'Маршрутизация','Управление маршрутизацией','',0,'',NULL,NULL,NULL,NULL,3,NULL,NULL,NULL,NULL,0,1,1,'routing',100,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(7,'Сетевой экран','Настройка сетевых ограничений','',0,'',NULL,NULL,NULL,NULL,3,NULL,NULL,NULL,NULL,0,1,1,'',100,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(8,'Виртуализация: аппаратный уровень','Обслуживание и настройка серверов','',0,'',NULL,NULL,NULL,NULL,5,NULL,NULL,NULL,NULL,0,0,1,'',100,9,NULL,NULL,NULL,NULL,'2026-07-21 03:40:00','VeniaminLevchenko'),(9,'Виртуализация: гипервизоры','Слой виртуализации','',0,'',NULL,NULL,NULL,NULL,5,NULL,NULL,NULL,NULL,0,1,1,'',100,9,NULL,NULL,NULL,NULL,'2026-07-21 03:40:00','VeniaminLevchenko'),(10,'Виртуализация: кластеризация','vCenter','',0,'',NULL,NULL,NULL,NULL,5,NULL,NULL,NULL,NULL,0,1,1,'',100,9,NULL,NULL,NULL,NULL,'2026-07-21 03:40:00','VeniaminLevchenko'),(11,'Телефония','Управление SIP телефонией','',1,'',9,1,3,7,NULL,NULL,NULL,NULL,NULL,0,1,1,'',100,NULL,'[]',NULL,NULL,NULL,'2025-12-17 12:34:55',NULL),(12,'Домен Taburetka.local','Управление доменом','',0,'',6,1,2,6,NULL,NULL,NULL,NULL,NULL,0,1,1,'',100,NULL,NULL,8,32,600,'2026-06-05 11:20:00','DaniilZimin'),(13,'Сервер печати','Перенаправление и контроль задач печати от пользователей к устройствам печати','',1,'',10,1,4,6,NULL,NULL,NULL,NULL,NULL,0,1,1,'',100,NULL,NULL,NULL,NULL,NULL,'2026-06-05 11:20:00','DaniilZimin'),(14,'DNS зона taburetka.local','Встроенная в AD','',0,'',NULL,NULL,NULL,NULL,12,NULL,NULL,NULL,NULL,0,1,1,'',1,NULL,NULL,NULL,NULL,NULL,'2026-06-05 11:20:00','DaniilZimin'),(15,'DHCP сервер','Раздача адресов сетевым устройствам','',0,'',NULL,NULL,NULL,NULL,3,NULL,NULL,NULL,NULL,0,1,1,'',100,6,NULL,NULL,NULL,NULL,'2026-06-05 11:20:00','DaniilZimin'),(16,'Межсайтовый VPN','Связность сайтов','',0,'',NULL,NULL,NULL,11,3,NULL,NULL,NULL,NULL,0,1,1,'',100,6,NULL,NULL,NULL,NULL,NULL,NULL),(17,'Пользовательский VPN','Доступ пользователей к внутренним ресурсам','Описание https://wiki.reviakin.net/сервисы:пользовательский_vpn',1,'',6,NULL,NULL,NULL,3,NULL,NULL,NULL,NULL,0,1,1,'',100,6,NULL,NULL,NULL,NULL,NULL,NULL),(18,'Кластер 1С','Трехзвенка БД - Сервер - Клиент','',1,'',9,4,4,4,NULL,NULL,NULL,NULL,NULL,0,1,1,'',100,NULL,NULL,12,48,1200,'2026-07-21 03:40:00','VeniaminLevchenko'),(19,'Контроль доступа в интернет','Выход в интернет через SQUID','',1,'',1,1,3,1,NULL,3500,583.33,NULL,NULL,0,1,1,'',100,6,NULL,NULL,NULL,NULL,'2026-08-17 06:00:00','admin'),(20,'Мониторинг инфраструктуры','Zabbix','',0,'',1,1,3,6,NULL,NULL,NULL,NULL,NULL,0,1,1,'',100,10,NULL,2,8,200,'2026-08-17 06:00:00','admin'),(21,'Видеонаблюдение','Регистратор + камеры','',0,'',6,1,2,12,NULL,NULL,NULL,NULL,NULL,0,1,1,'',100,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(22,'Сайт taburetka','LAMP сервер на базе дебиан','',1,'',1,1,2,5,NULL,NULL,NULL,NULL,NULL,0,1,1,'',100,NULL,NULL,2,4,80,NULL,NULL),(23,'DNS зона taburetka.fidonet','BIND9','',0,'',1,NULL,NULL,5,NULL,NULL,NULL,NULL,NULL,0,1,1,'',100,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(24,'Инвентаризация','Учет в ИТ','',1,'',1,1,4,6,NULL,NULL,NULL,NULL,NULL,0,1,1,'',100,NULL,NULL,NULL,NULL,NULL,'2026-08-17 06:00:00','admin'),(26,'Резервное копирование','Резервное копирование VM при помощи Veeam','',0,'',1,1,2,9,NULL,NULL,NULL,NULL,NULL,0,1,1,'',100,1,'[]',4,16,8000,'2025-05-09 14:42:12',NULL),(9001,'Файловый архив (выведен)','Общие папки старого файлового сервера','',1,'',9,NULL,NULL,6,NULL,NULL,NULL,NULL,NULL,1,1,1,'',100,NULL,'[]',NULL,NULL,NULL,'2026-06-30 09:25:00','VeniaminLevchenko'),(9002,'Облачная платформа IaaS','Арендованные вычислительные мощности внешнего провайдера','',0,'',1,1,2,5,NULL,42000,9240,NULL,NULL,0,1,1,'',100,NULL,'[]',16,64,2000,'2026-08-05 04:30:00','admin');
...
) ENGINE=InnoDB AUTO_INCREMENT=9305 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `services_in_aces` VALUES (9001,9004,20),(9200,9200,24),(9201,9201,22),(9202,9202,19),(9302,9302,20);
...
INSERT INTO `soft` VALUES (15,3,'Office 2016 Standard','',NULL,'Microsoft Office стандартный 2016\nMicrosoft Office Standard 2016','Microsoft Visual Studio 2010 Tools for Office Runtime \\(x\\d{2}\\)\nЯзыковой пакет Microsoft Visual Studio 2010 Tools для среды выполнения Office \\(x\\d{2}\\) - RUS\nMicrosoft Office 2003 Web Components\nMicrosoft Office File Validation Add-In\nАрхивация личных папок Microsoft Outlook\nНадстройка Microsoft для сохранения в формате PDF или XPS для программ выпуска 2007 системы Microsoft Office','2026-05-30 05:10:00','BorisBarinov',NULL,NULL,NULL),(43,3,'Office 2010 Standard','',NULL,'Microsoft Office стандартный 2010','Microsoft Visual Studio 2010 Tools for Office Runtime \\(x\\d{2}\\)\nЯзыковой пакет Microsoft Visual Studio 2010 Tools для среды выполнения Office \\(x\\d{2}\\) - RUS\nMicrosoft Office 2003 Web Components\nMicrosoft Office File Validation Add-In\nАрхивация личных папок Microsoft Outlook\nНадстройка Microsoft для сохранения в формате PDF или XPS для программ выпуска 2007 системы Microsoft Office','2026-03-11 03:10:00','admin',1,NULL,NULL),(76,3,'Windows 10 Pro','',NULL,'Майкрософт Windows 10 Pro','DHTML Editing Component\nЦентр устройств Windows Mobile\nПомощник по обновлению до Windows 10\nUpdate for Windows 10 for .*\nПроверка работоспособности ПК Windows','2026-05-30 05:10:00','BorisBarinov',NULL,NULL,NULL),(79,3,'Windows 7 Professional','',NULL,'Microsoft Windows 7 Профессиональная\nMicrosoft Windows 7 Professional','Предыдущая версия клиента\nDHTML Editing Component\nЦентр устройств Windows Mobile\nWindows Software Development Kit\nОсновные компоненты Windows Live','2026-03-11 03:10:00','admin',1,NULL,NULL),(104,3,'Windows 8.1 Professional','',NULL,'Майкрософт Windows 8\\.1 Профессиональная\nMicrosoft Windows 8\\.1 Pro','','2023-08-30 13:51:42',NULL,NULL,NULL,NULL),(115,56,'LibreOffice','Свободно распространяемый офисный пакет с открытым исходным кодом',NULL,'LibreOffice \\d\\.\\d\\.\\d\\.\\d','LibreOffice [0-9.]* Help Pack .*','2023-10-27 04:55:23','admin',NULL,NULL,NULL),(122,63,'Bitrix24','Приложение-клиент - бесплатно',NULL,'Bitrix24 for Windows\nBitrix24','','2023-10-27 04:56:54','admin',NULL,NULL,NULL),(163,3,'SQL Server 2012','',NULL,'Microsoft SQL Server 2012 \\(64-разрядная версия\\)\nMicrosoft SQL Server 2012 \\(64-bit\\)','Microsoft Report Viewer 2012 Runtime\nMicrosoft SQL Server 2012\nMicrosoft .* (for|для) SQL Server 2012\nSQL Server Browser for SQL Server 2012\nОбозреватель SQL Server для SQL Server 2012\nMicrosoft SQL Server Data Tools (Build Utilities )?- \\w+ \\(12.*\nСистемные типы Microsoft SQL Server System CLR Types\nСлужбы синхронизации контроля версий для SQL Server 2012','2023-08-30 13:51:42',NULL,NULL,NULL,NULL),(169,97,'КриптоПро CSP','',NULL,'КриптоПро CSP\nКриптоПро CADESCOM\nКриптоПро ЭЦП Browser plug-in','','2023-08-30 13:51:42',NULL,NULL,NULL,NULL),(174,3,'Office 2013 Standard','',NULL,'Microsoft Office стандартный 2013','','2018-04-18 06:21:13',NULL,NULL,NULL,NULL),(224,3,'Project 2016 Standard','',NULL,'Microsoft Project стандартный 2016','','2018-04-28 06:55:29',NULL,NULL,NULL,NULL),(370,3,'Visio 2016 Standard','',NULL,'Microsoft Visio стандартный 2016','','2018-08-16 05:52:20',NULL,NULL,NULL,NULL),(450,3,'SQL Server 2008 R2','Бесплатный только MS SQL Server Express 2008 R2',NULL,'Microsoft SQL Server 2008 R2','Файлы поддержки установки Microsoft SQL Server .*\nMicrosoft SQL Server Native Client\nMicrosoft SQL Server VSS Writer\nУстановка Microsoft SQL Server 2008 R2.*\nФайлы поддержки программы установки Microsoft SQL Server 2008\nPrevious Versions Client\nСобственный клиент Microsoft SQL Server 2008 R2\nСлужбы синхр\\. контроля версий Microsoft SQL Server VSS Writer\nПолитики Microsoft SQL Server 2008 R2\nMicrosoft SQL Server Compact 3.5 SP2 .*\nMicrosoft SQL Server Browser\nMicrosoft Report Viewer Redistributable 2008 SP1.*\nФайлы поддержки программы установки Microsoft SQL Server 20xx\nMicrosoft SQL Server 2008 Setup Support Files','2023-08-30 13:51:45',NULL,NULL,NULL,NULL),(490,70,'Кнопка \"Яндекс\" на панели задач','',NULL,'Кнопка \"Яндекс\" на панели задач','','2023-09-05 05:39:25',NULL,NULL,NULL,NULL),(501,3,'Visio 2010 Standard','',NULL,'Microsoft Visio стандартный 2010','','2018-09-18 15:17:03',NULL,NULL,NULL,NULL),(575,3,'OneDrive','',NULL,'Microsoft OneDrive','','2023-09-05 05:39:26',NULL,NULL,NULL,NULL),(698,3,'SQL Server 2005','',NULL,'Microsoft SQL Server 2005','Microsoft Visual Basic PowerPacks 10.0\nMicrosoft SQL Server VSS Writer','2023-08-30 13:51:47',NULL,NULL,NULL,NULL),(752,317,'Kaspersky Endpoint Security для Windows','',NULL,'Kaspersky Endpoint Security для Windows\nKaspersky Endpoint Security for Windows','Расширение для Microsoft Exchange ActiveSync\nРасширение для iOS Mobile Device Management\nАгент администрирования Kaspersky Security Center\nKaspersky Endpoint Agent .*\nKaspersky Endpoint Security','2023-08-31 04:43:10','reviakin.a',NULL,NULL,NULL),(820,3,'SQL Server 2008','',NULL,'Microsoft SQL Server 2008','Microsoft SQL Server VSS Writer\nMicrosoft SQL Server 2008 Native Client\nMicrosoft SQL Server 2008 Browser\nMicrosoft Visual Basic PowerPacks 10.0','2023-08-30 13:51:47',NULL,NULL,NULL,NULL),(878,317,'Агент администрирования Kaspersky Security Center','',NULL,'Агент администрирования Kaspersky Security Center','','2023-10-27 04:56:04','admin',NULL,NULL,NULL),(880,3,'Windows Server 2012 Datacenter','',NULL,'Microsoft Windows Server 2012 Datacenter','','2020-11-10 10:38:38',NULL,NULL,NULL,NULL),(882,3,'Windows Server 2003 Standard','',NULL,'Microsoft\\(R\\) Windows\\(R\\) Server 2003, Standard Edition','Windows Server 2003 - обновления программного обеспечения\nWindows Server 2003 - Обновление программного обеспечения\nОбновление безопасности для проигрывателя Windows Media 6.4','2023-08-30 13:51:48',NULL,NULL,NULL,NULL),(883,3,'Windows Server 2008 R2 Standard','',NULL,'Microsoft Windows Server 2008 R2 Standard','','2020-11-10 16:53:07',NULL,NULL,NULL,NULL),(884,3,'Windows Server 2012 Standard','',NULL,'Microsoft Windows Server 2012 Standard','','2020-11-10 16:59:25',NULL,NULL,NULL,NULL),(885,3,'Windows Server 2012 R2 Datacenter','',NULL,'Microsoft Windows Server 2012 R2 Datacenter','','2020-11-10 16:59:52',NULL,NULL,NULL,NULL),(886,3,'Windows Server 2012 R2 Standard','',NULL,'Microsoft Windows Server 2012 R2 Standard','','2020-11-10 17:00:31',NULL,NULL,NULL,NULL),(887,3,'Windows Server 2008 Standard','',NULL,'Microsoft Windows Server 2008 Standard','','2020-11-10 17:02:37',NULL,NULL,NULL,NULL),(897,260,'CorelDRAW Graphics Suite 2019','',NULL,'CorelDRAW Graphics Suite 2019','Corel Graphics - Windows Shell Extension\nGhostscript GPL','2023-09-03 08:15:14','reviakin.a',NULL,NULL,NULL),(899,253,'Предприятие 8.3','',NULL,'1C:Предприятие 8 \\(8.3','','2023-08-31 03:38:46','reviakin.a',NULL,NULL,NULL),(902,260,'CorelDRAW Graphics Suite 2017','',NULL,'CorelDRAW Graphics Suite 2017','Corel Graphics - Windows Shell Extension\nGhostscript GPL','2023-09-03 08:14:52','reviakin.a',NULL,NULL,NULL),(905,3,'Update Health Tools','',NULL,'Microsoft Update Health Tools','','2023-09-05 05:39:33',NULL,NULL,NULL,NULL),(908,81,'ICQ','ICQ от mail.ru. Бесплатно',NULL,'ICQ','','2023-09-05 05:39:33','reviakin.a',NULL,NULL,NULL),(926,93,'LiteManager Pro - Viewer','Платное ПО удаленного управления рабочими станциями',NULL,'LiteManager Pro - Viewer','','2021-01-26 05:31:52',NULL,NULL,NULL,NULL),(927,317,'Kaspersky Embedded Systems Security','',NULL,'Kaspersky Embedded Systems Security','','2021-01-26 10:39:26',NULL,NULL,NULL,NULL),(928,93,'LiteManager Pro - Server','',NULL,'LiteManager Pro - Server','','2023-10-27 04:56:00','admin',NULL,NULL,NULL),(969,70,'Yandex','',NULL,'Yandex','','2023-10-27 04:56:02','admin',NULL,NULL,NULL),(997,21,'Microsoft Edge Update','',NULL,'Microsoft Edge Update','','2023-09-05 05:39:34',NULL,NULL,NULL,NULL),(998,3,'Edge','',NULL,'Microsoft Edge','','2023-09-05 05:39:35',NULL,NULL,NULL,NULL),(1010,190,'ГРАНД-Смета 2021','',NULL,'ГРАНД-Смета, версия 2021','','2021-10-17 18:19:38',NULL,NULL,NULL,NULL),(1035,233,'SCAD Office','',NULL,'SCAD Office','','2021-10-27 12:59:17',NULL,NULL,NULL,NULL),(1066,3,'MS Access 2016','',NULL,'','','2022-08-15 07:12:22',NULL,NULL,NULL,NULL),(1074,11,'Photoshop CS6','',NULL,'','','2023-02-01 05:45:06',NULL,NULL,NULL,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=9002 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Теги для категоризации объектов';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tags` VALUES (1,'Связь','svaz','#274e13','Всё, что относится к телефонии и каналам связи',6,0,'2025-12-17 12:33:06','2026-07-09 09:10:00','admin'),(2,'Облачный','cloud','#4a86e8','Ресурсы, вынесенные к внешнему провайдеру',4,0,'2025-12-17 12:33:45','2026-07-09 09:10:00','admin'),(9001,'Устаревшее','ustarevshee','#999999','Помечает выведенное из эксплуатации',0,1,'2026-04-02 06:05:00','2026-04-02 06:05:00','admin');
...
CREATE TABLE `tags_links` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique-tags_links-tag_model` (`tag_id`,`model_class`,`model_id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=9007 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Связи тегов с объектами (полиморфная связь)';
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `tags_links` WRITE;
/*!40000 ALTER TABLE `tags_links` DISABLE KEYS */;
INSERT INTO `tags_links` VALUES (1,1,'app\\models\\Services',1,'2025-12-17 12:34:36'),(2,1,'app\\models\\Services',2,'2025-12-17 12:34:43'),(3,1,'app\\models\\Services',11,'2025-12-17 12:34:55'),(9001,1,'app\\models\\Techs',46,'2026-07-09 09:20:00'),(9002,1,'app\\models\\Techs',50,'2026-07-09 09:20:00'),(9003,1,'app\\models\\Comps',15,'2026-07-09 09:21:00'),(9004,2,'app\\models\\Comps',9005,'2026-08-05 05:20:00'),(9005,2,'app\\models\\Comps',9006,'2026-08-05 05:20:00'),(9006,2,'app\\models\\Services',9002,'2026-08-05 05:21:00');
/*!40000 ALTER TABLE `tags_links` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `tech_models` (
  ...
  `updated_by` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `archived` tinyint(1) DEFAULT NULL,
  `ports_layout` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`),
  KEY `type_id` (`type_id`),
  KEY `manufacturers_id` (`manufacturers_id`),
...
CREATE TABLE `tech_states` (
  ...
  `archived` tinyint(1) DEFAULT '0',
  `marker_id` int DEFAULT NULL COMMENT 'Цветовой маркер',
  `operating` tinyint(1) DEFAULT '0' COMMENT 'Оборудование в работе',
  PRIMARY KEY (`id`),
  KEY `tech_states_archived_index` (`archived`),
  KEY `idx-tech_states-marker_id` (`marker_id`),
  KEY `idx-tech_states-operating` (`operating`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tech_states` VALUES (1,'state_issued','На руках','Выдано пользователю на руки.',0,58,1),(2,'state_confirmed','Согл','Приобретение согласовано. Формируются заявки / счета / запросы.',0,52,0),(3,'state_in_supply_service','Снабж.','В службе снабжения: все документы переданы в службу снабжения, ожидаем приобретения и доставки к месту потребности оборудования / ПО.',0,51,0),(4,'state_in_warehouse','Склад','На складе. В настоящий момент не установлен, но имеется в наличии',0,53,0),(5,'state_operating','ОК','Находится в работе по месту установки.',0,54,1),(6,'state_malfunction','Замеч.','К работе оборудования имеются замечания, необходимо устранить.',0,55,1),(7,'state_broken','Сломан','Полностью не работоспособен. Требуется ремонт или списание.',0,56,0),(8,'state_decommisioned','Списано','Выведено из эксплуатации.',1,NULL,0);
...
CREATE TABLE `tech_types` (
  ...
  KEY `idx-tech_types-marker_id` (`marker_id`)
...
INSERT INTO `tech_types` VALUES (1,'pc','ПК','ПК','Персональный компьютер (создано автоматически при обновлении БД)',NULL,NULL,1,0,0,0,'2026-07-13 04:00:00','admin',NULL,NULL,64),(2,'voip_phone','IP Телефон','ТЕЛ','Количество линий?\r\nУмеет провижнинг?\r\nУмеет отказоустойчивость?\r\nПитание POE/ БП (идет ли в комплекте)?\r\nМожно включать бриджом?\r\nЛогин / пароль по умолч.\r\nнеочевидное расположение серийного номера?','Внутренний номер','Внутренний телефонный номер, назначенный этому аппарату',0,1,0,0,'2026-07-13 04:00:00','admin',NULL,NULL,74),(3,'srv','Серв. оборуд.','СРВ','Назначение оборудования\r\nПроцессор: модель @частота (количество ядер)\r\nПамять: объем (тип)\r\nНМЖД: тип объем @rpm, RAID контроллеры\r\nВидео: модель (объем VRAM)\r\nУдаленное управление\r\nOC: Версия операционной системы (Pro/не Pro)\r\nПорты: список имеющихся портов\r\nнеочевидное расположение серийного номера?','','',1,0,0,0,'2026-07-13 04:00:00','admin',NULL,NULL,52),(4,'net_router','Маршрутизатор','МРШ','Какое количествое каких типов портов?\r\nНаличие PoE (кол-во портов, макс бюджет)?\r\nСPU/RAM\r\nЛогин / пароль по умолч.\r\nнеочевидное расположение серийного номера?','','',0,0,0,0,'2026-07-13 04:00:00','admin',NULL,NULL,58),(5,'voip_gw','VoIP GW','ТЕЛ','Количество линий?\r\nУмеет провижнинг?\r\nУмеет отказоустойчивость?\r\nПитание POE/ БП (идет ли в комплекте)?\r\nМожно включать бриджом?\r\nЛогин / пароль по умолч.\r\nнеочевидное расположение серийного номера?','','',0,0,0,0,'2026-07-13 04:00:00','admin',NULL,NULL,61),(6,'mfu_bw_a3','Печатное оборуд.','ПРН','Принетер/МФУ, формат бумаги, цветной?\r\nСетевой?\r\nПоддержка двусторонней печати?\r\nСканирование с податчика?, Поддержка двустороннего сканирования?\r\nСканирование в SMB/FTP/Почту?\r\nДопустимая нагрузка по печати (стр/мес)?\r\nМодели картриджей (цвет, емкость)?\r\nЛогин/пароль по умолчанию?\r\nнеочевидное расположение серийного номера?','Сетевой путь','Полный сетевой путь к принтеру вместе с сервером печати, на котором опубликован. Например \\\\msk-fsrv-open\\HP_LJ2021_5',0,0,0,0,'2026-07-13 04:00:00','admin',NULL,NULL,70),(7,'net_switch','Коммутатор','КОМ','Управляемый?\r\nКакое количествое каких типов портов?\r\nНаличие PoE (кол-во портов, макс бюджет)?\r\nЛогин / пароль по умолч.\r\nнеочевидное расположение серийного номера?','','',0,0,0,0,'2026-07-13 04:00:00','admin',NULL,NULL,51),(8,'ups','ИБП','ИБП','Управляемый? \r\nЕмкость, макс мощность?\r\nПланируемое время при типовых нагрузках?\r\nВозможность установки доп бат. модулей?\r\nКакое количество каких типов розеток?\r\nМодели батарейных блоков / сборок / батарей?\r\nЛогин / пароль по умолч?\r\nнеочевидное расположение серийного номера?','','',0,0,1,0,'2026-07-13 04:00:00','admin',NULL,NULL,59),(9,'wifi_ap','WiFi Точка Доступа','ВФЙ','Поддерживаемые протоколы, частоты?\r\nРадиус действия (в помещ/ на улице)?\r\nУличной/внутренней установки?\r\nОбъединение в mesh?\r\nПитание (наличие БП / инжектора в комплекте)?\r\nЛогин / пароль по умолч.\r\nнеочевидное расположение серийного номера?','','',0,0,0,0,'2026-07-13 04:00:00','admin',NULL,NULL,77),(10,'dvr_cam','Камера видеонабл.','ВИД','Цифровая / аналоговая\r\nВнешняя / внутренняя / температурный режим\r\nРазрешение, угол обзора, запись аудио\r\nРежим день/ночь, ИК подсветка\r\nPTZ?\r\nСетевые настройки по умолч.','','',0,0,0,0,'2026-07-13 04:00:00','admin',NULL,NULL,63),(11,'wifi_router','WiFi router','ВФЙ','Поддерживаемые протоколы, частоты?\r\nРадиус действия (в помещ/ на улице)?\r\nУличной/внутренней установки?\r\nОбъединение в mesh?\r\nПитание (наличие БП / инжектора в комплекте)?\r\nЛогин / пароль по умолч.\r\nнеочевидное расположение серийного номера?','','',0,0,0,0,'2026-07-13 04:00:00','admin',NULL,NULL,76),(12,'nas','СХД','СХД','Количество контроллеров\r\nКоличество блоков питания\r\nРежим взаимодействия контроллеров\r\nКоличество и формат дисков в корзине\r\nПоддержка сжатия, поддержка дедупликации\r\nСетевые интерфейсы','','',0,0,0,0,'2026-07-13 04:00:00','admin',NULL,NULL,75),(13,'laptop','Ноутбук','БУК','Экран: матовый/глянец Диагональ IPS/TN @разрешение\r\nПроцессор: модель @частота (количество ядер)\r\nПамять: объем (тип)\r\nНМЖД: тип объем @rpm\r\nВидео: модель (объем VRAM)\r\nOC: Версия операционной системы (Pro/не Pro)\r\nПорты: список имеющихся портов\r\nнеочевидное расположение серийного номера?','','',1,0,0,0,'2026-07-13 04:00:00','admin',NULL,NULL,60),(14,'skud','СКУД','СКД','Тип оборудования: Турникет, Пилон, Считыватель\r\nНаличие сетевого интерфейса, тип','','',0,0,0,0,'2026-07-13 04:00:00','admin',NULL,NULL,79),(15,'scan','Сканер','СКАН','Сетевой/нет?\r\nПланшетный/протяжный?\r\nДвусторонний?\r\nСкнирование в FTP/SMB/SMTP?','','',0,0,0,0,'2026-07-13 04:00:00','admin',NULL,NULL,71),(16,'display','Монитор','МОН','Диагональ, разрешение\r\nПовортный/неповоротный экран\r\nМатрица, Покрытие\r\nПорты\r\nНаличие колонок\r\nВнешний БП?','','',0,0,0,1,'2026-07-13 04:00:00','admin',NULL,NULL,53),(17,'web_camera','Веб-камера','ВЕБ','Максимальное разрешение 720p\r\nКоличество мегапикселей у камеры: 1.2\r\nТип фокусировки: постоянный фокус\r\nВстроенный микрофон: Монофонический\r\nДиапазон микрофона: До 1 м\r\nПоле обзора по диагонали: 60°\r\nУниверсальное крепление для ноутбука, ЖК-экрана или монитора\r\nПодключение кабелем длиной 1,5 м\r\n','','',0,0,0,0,'2026-03-11 03:05:00','admin',NULL,1,NULL),(18,'videoconf','Терминал ВКС','ВКС','Наличие, тип камеры\r\nНаличие, тип дисплея\r\n','','',0,0,0,0,'2026-03-11 03:05:00','admin',1,NULL,NULL),(19,'aio_pc','Моноблок',NULL,'Экран: матовый/глянец Диагональ IPS/TN @разрешение\r\nПроцессор: модель @частота (количество ядер)\r\nПамять: объем (тип)\r\nНМЖД: тип объем @rpm\r\nВидео: модель (объем VRAM)\r\nOC: Версия операционной системы (Pro/не Pro)\r\nПорты: список имеющихся портов\r\nнеочевидное расположение серийного номера?','','',1,0,0,0,'2026-07-13 04:00:00','admin',NULL,NULL,80),(20,'vid_reg','Видеорегистратор','РЕГ','Цифровая / аналоговая\r\nРазрешение, угол обзора, запись аудио\r\nРежим день/ночь, ИК подсветка\r\nPTZ?\r\nСетевые настройки по умолч.','','',0,0,0,0,'2026-07-13 04:00:00','admin',NULL,NULL,78),(21,'Racks','Шкафы и стойки','ШК','Высота (U)\r\nГабариты\r\nТип дверей (перф/стекло)','','',0,0,0,0,'2026-07-13 04:00:00','admin',NULL,NULL,57),(22,'Сист_контр.','Системы мониторинга','конт','За чем может следить\r\nКакие дополнительные датчики подключаются\r\nНаименование модулей расширения','Системы мониторинга серверной и ','',0,0,0,0,'2023-08-28 13:41:17',NULL,NULL,NULL,NULL),(23,'usb_k','USB концентратор','USB','Количество портов?','','',0,0,0,0,'2026-03-11 03:05:00','admin',NULL,1,NULL),(24,'tsd','Терминалы сбора данных','ТРМ','Операционная система\r\nТип, диагональ экрана\"@разрешение\r\nCPU\r\nRAM\r\nStorage\r\nWiFi\r\nАккумулятор\r\nКамеры','','',0,0,0,0,'2026-03-11 03:05:00','admin',1,NULL,NULL);
...
CREATE TABLE `techs` (
  ...
  `ports_override` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`id`),
  UNIQUE KEY `num` (`num`),
  KEY `user_id` (`user_id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=9002 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='Рабочие места';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `techs` VALUES (1,'МСК-СРВ-0001','',4,'F14F0E5B9AF009901',NULL,6,NULL,NULL,'','00155d3b793300155d3b793500155d3b793700155d3b7939',5,'','','','CPU: 2x E5260v4\r\nRAM: 8x 32GB\r\nNET: 4x 1Gbit\r\nFC: 2x 8Gbit',NULL,NULL,1,18,'36-37',NULL,9,'','2026-08-14 02:30:00','',0,1,'[]',1,'',NULL,NULL,'VeniaminLevchenko',5,NULL),(2,'МСК-СРВ-0002','0000072',4,'F14F0E5B9AF009917',NULL,6,NULL,NULL,'','00155d3b794100155d3b794300155d3b794500155d3b7947',5,'','','','CPU: 2x E5260v4\r\nRAM: 8x 32GB\r\nNET: 4x 1Gbit\r\nFC: 2x 8Gbit',NULL,NULL,2,18,'38-39',NULL,9,'','2026-08-14 02:30:00','',0,1,'[]',1,'',NULL,NULL,'VeniaminLevchenko',5,NULL),(3,'МСК-ПК-0001','',327,'AAX380016302',NULL,6,NULL,NULL,'','',4,'','','','SSD: 240GB\r\nRAM: 8GB',NULL,NULL,NULL,NULL,'',NULL,NULL,'','2025-05-24 07:01:42','',0,0,'[]',1,'',NULL,NULL,NULL,NULL,NULL),(4,'МСК-ПК-0002','',327,'AAX380016308',NULL,6,NULL,NULL,'','',4,'','','','SSD: 240GB\r\nRAM: 8GB',NULL,NULL,NULL,NULL,'',NULL,NULL,'','2025-05-24 07:01:42','',0,0,'[]',1,'',NULL,NULL,NULL,NULL,NULL),(5,'МСК-ПК-0003','0000039',327,'AAX380016309',NULL,3,2,6,'10.20.100.23','005056b4d780',5,'','поцарапан корпус','','SSD: 240GB\r\nRAM: 8GB',NULL,1,5,NULL,'',4,NULL,'','2026-06-19 05:05:00','',0,0,'[]',1,'',NULL,NULL,'BorisBarinov',NULL,NULL),(6,'МСК-ПК-0004','',327,'AAX380016311',NULL,3,4,6,'','024208d2b582',5,'','','','SSD: 240GB\r\nRAM: 8GB',NULL,1,6,NULL,'',4,NULL,'','2026-06-19 05:05:00','',0,0,'[]',1,'',NULL,NULL,'BorisBarinov',NULL,NULL),(7,'МСК-ПК-0005','',327,'AAX380016312',NULL,4,3,6,'','1a9cc268ceb7',5,'','','','SSD: 240GB\r\nRAM: 8GB',NULL,1,7,NULL,'',5,NULL,'','2026-06-19 05:05:00','',0,0,'[]',1,'',NULL,NULL,'BorisBarinov',NULL,NULL),(8,'ЧЕЛ-ПК-0001','',327,'AAX380016314',NULL,9,12,1,'','be6c0e44c1ac',5,'','','','SSD: 240GB\r\nRAM: 8GB',NULL,1,9,NULL,'',NULL,NULL,'[{\"type\":\"motherboard\",\"manufacturer\":\"Intel Corporation\",\"product\":\"NUC7JYB\",\"sn\":\"GEJY14900ACN\",\"cores\":null,\"capacity\":null,\"title\":\"Материнская плата\",\"manufacturer_id\":21,\"fingerprint\":\"motherboard|intel corporation|nuc7jyb|gejy14900acn\",\"hidden\":false,\"uid\":\"653b423a4a814\",\"inv_num\":null,\"manual_name\":null,\"manual_sn\":null},{\"type\":\"processor\",\"manufacturer\":\"Intel(R)\",\"product\":\"Intel(R) Celeron(R) J4025 CPU @ 2.00GHz\",\"sn\":\"\",\"cores\":\"2\",\"capacity\":null,\"title\":\"Процессор\",\"manufacturer_id\":21,\"fingerprint\":\"processor|intel(r)|intel(r) celeron(r) j4025 cpu @ 2.00ghz|\",\"hidden\":false,\"uid\":\"653b423a4a817\",\"inv_num\":null,\"manual_name\":null,\"manual_sn\":null},{\"type\":\"memorybank\",\"manufacturer\":\"Kingston\",\"product\":\"8192MiB\",\"sn\":\"\",\"cores\":null,\"capacity\":8192,\"title\":\"Модуль памяти\",\"manufacturer_id\":341,\"fingerprint\":\"memorybank|kingston|8192mib|\",\"hidden\":false,\"uid\":\"653b423a4a818\",\"inv_num\":null,\"manual_name\":null,\"manual_sn\":null},{\"type\":\"harddisk\",\"manufacturer\":\"KINGSTON\",\"product\":\"KINGSTON SA400S37240G 240GB\",\"sn\":\"\",\"cores\":null,\"capacity\":240,\"title\":\"Накопитель\",\"manufacturer_id\":341,\"fingerprint\":\"harddisk|kingston|kingston sa400s37240g 240gb|\",\"hidden\":false,\"uid\":\"653b423a4a81a\",\"inv_num\":null,\"manual_name\":null,\"manual_sn\":null},{\"type\":\"videocard\",\"manufacturer\":\"Intel(R)\",\"product\":\"Intel(R) UHD Graphics 600 1024MiB\",\"sn\":\"\",\"cores\":null,\"capacity\":\"1024\",\"title\":\"Видеокарта\",\"manufacturer_id\":21,\"fingerprint\":\"videocard|intel(r)|intel(r) uhd graphics 600 1024mib|\",\"hidden\":false,\"uid\":\"653b423a4a81b\",\"inv_num\":null,\"manual_name\":null,\"manual_sn\":null}]','2026-06-19 05:05:00','',0,0,'[]',1,'',NULL,NULL,'BorisBarinov',NULL,NULL),(9,'ЧЕЛ-ПК-0002','',327,'AAX380016315',NULL,9,13,NULL,'','ca817492a179',6,'','Иногда падает в BSOD','','SSD: 240GB\r\nRAM: 8GB',NULL,1,10,NULL,'',4,NULL,'','2026-06-19 05:05:00','',0,0,'[]',1,'',NULL,NULL,'BorisBarinov',NULL,NULL),(10,'ЧЕЛ-ПК-0003','',327,'AAX380016316',NULL,10,14,1,'','024475adf01a',5,'','','','SSD: 240GB\r\nRAM: 8GB',NULL,1,11,NULL,'',5,NULL,'','2026-06-19 05:05:00','',0,0,'[]',1,'',NULL,NULL,'BorisBarinov',NULL,NULL),(11,'ЧЕЛ-ПК-0004','',327,'AAX380016317',NULL,10,15,NULL,'','f245fcbb16aa',5,'','','','SSD: 240GB\r\nRAM: 8GB',NULL,1,12,NULL,'',NULL,NULL,'','2026-06-19 05:05:00','',0,0,'[]',1,'',NULL,NULL,'BorisBarinov',NULL,NULL),(12,'МСК-КОМ-0001','',151,'FCW1842A3AL10',NULL,6,NULL,NULL,'10.20.1.1\n10.20.7.1\n10.20.33.1\n10.20.40.1\n10.20.75.1\n10.20.100.1\n10.20.101.1','00241b9689d6',5,'https://10.20.1.1/','Ядро МСК','','',NULL,NULL,NULL,18,'43',NULL,1,'','2026-08-23 07:10:00','',1,0,'[]',1,'c3560x-msk-0001',1,'msk-sw-core','admin',3,NULL),(13,'МСК-КОМ-0002','',151,'FCW1842A3AL17',NULL,6,NULL,NULL,'','',4,'','','лежит в серверной в ЗИП','',NULL,NULL,NULL,NULL,'43',NULL,NULL,'','2025-05-24 07:01:42','',1,0,'[]',NULL,'',NULL,NULL,NULL,NULL,NULL),(14,'ЧЕЛ-КОМ-0001','',151,'FCW1842A3AL21',NULL,8,NULL,NULL,'10.50.1.1','005706abaf8a',5,'https://10.50.1.1/','','','',NULL,NULL,NULL,19,'44',NULL,9,'','2026-08-14 02:30:00','',1,0,'[]',NULL,'c3560x-chl-0001',1,'chl-sw-core','VeniaminLevchenko',3,NULL),(15,'МСК-МОН-0001','',193,'XKV0P9BA00YL',5,3,2,6,'','',5,'','','','',NULL,NULL,NULL,NULL,'',4,NULL,'','2025-05-24 07:01:42','',0,0,'[]',1,'',NULL,NULL,NULL,NULL,NULL),(16,'МСК-МОН-0002','',193,'XKV0P9BA01YL',6,3,4,6,'','',5,'','','','',NULL,NULL,NULL,NULL,'',4,NULL,'','2025-05-24 07:01:42','',0,0,'[]',1,'',NULL,NULL,NULL,NULL,NULL),(17,'МСК-ПК-0006','',327,'AAX3800163AA',NULL,4,7,6,'','024231533ef0',7,'','Пролила кофе','','SSD: 240GB\r\nRAM: 8GB',NULL,1,8,NULL,'',5,NULL,'','2026-06-19 05:05:00','',0,0,'[]',1,'',NULL,NULL,'BorisBarinov',NULL,NULL),(18,'МСК-ШК-0001','',309,'',NULL,6,NULL,6,'','',5,'','','','',NULL,NULL,NULL,NULL,'',NULL,NULL,'','2025-05-24 07:01:42','',0,0,'{\"rack-labels\":[{\"pos\":\"47\",\"back\":\"1\",\"label\":\"* светильник *\"},{\"pos\":\"42\",\"back\":\"1\",\"label\":\"- каб. органайзер -\"},{\"pos\":\"46\",\"back\":\"1\",\"label\":\"ПП 48 портов\"},{\"pos\":\"43\",\"back\":\"1\",\"label\":\" - каб. органайзер -\"},{\"pos\":\"26\",\"back\":\"\",\"label\":\"KVM консоль\"},{\"pos\":\"41\",\"back\":\"1\",\"label\":\"ПП 48 портов\"},{\"pos\":\"45\",\"back\":\"1\",\"label\":\" - каб. органайзер -\"},{\"pos\":\"24\",\"back\":\"1\",\"label\":\"Блок розеток\"},{\"pos\":\"22\",\"back\":\"1\",\"label\":\"Блок розеток\"}]}',1,'',NULL,NULL,NULL,NULL,NULL),(19,'ЧЕЛ-ШК-0001','',309,'',NULL,8,NULL,1,'','',NULL,'','','','',NULL,NULL,NULL,NULL,'',NULL,NULL,'','2025-05-24 07:01:42','',0,0,'{\"rack-labels\":[{\"pos\":\"47\",\"back\":\"1\",\"label\":\"* светильник *\"},{\"pos\":\"46\",\"back\":\"1\",\"label\":\"ПП 48 портов\"},{\"pos\":\"45\",\"back\":\"1\",\"label\":\" - каб. органайзер -\"},{\"pos\":\"42\",\"back\":\"1\",\"label\":\" - каб. органайзер -\"},{\"pos\":\"41\",\"back\":\"1\",\"label\":\"ПП 48 портов\"},{\"pos\":\"24\",\"back\":\"\",\"label\":\"KVM консоль\"}]}',NULL,'',NULL,NULL,NULL,NULL,NULL),(20,'МСК-ИБП-0001','',310,'N06F10KM3000EF',NULL,6,NULL,6,'','',5,'','','','',NULL,NULL,NULL,18,'3-7',NULL,NULL,'','2025-05-24 07:01:43','3-7,9-10',0,1,'[]',NULL,'',NULL,NULL,NULL,NULL,NULL),(21,'ЧЕЛ-ИБП-0001','',310,'N06F10KM300011',NULL,8,NULL,1,'','',5,'','','','',NULL,NULL,NULL,19,'3-7',NULL,NULL,'','2025-05-24 07:01:43','3-7,9-10',0,1,'[]',NULL,'',NULL,NULL,NULL,NULL,NULL),(22,'МСК-КОМ-0003','',194,'P1CV189071603',NULL,6,NULL,6,'10.20.1.2','',5,'https://10.20.1.2/','','','',NULL,NULL,NULL,18,'44',NULL,1,'','2026-08-23 07:10:00','',1,0,'[]',NULL,'c2960x-msk-0003',1,'msk-sw-access','admin',3,NULL),(23,'ЧЕЛ-КОМ-0002','',194,'P1CV186021208',NULL,8,NULL,1,'10.50.1.2','00c3fee7a5ed',5,'https://10.50.1.2/','','','',NULL,NULL,NULL,19,'43',NULL,9,'','2026-08-14 02:30:00','',1,0,'[]',NULL,'c2960x-chl-0002',1,'chl-sw-access','VeniaminLevchenko',3,NULL),(24,'ЧЕЛ-БУК-0001','',241,'FDO1628R0V7',NULL,11,10,10,'','dea9a5774774',1,'','','','',NULL,NULL,13,NULL,'',5,NULL,'','2025-05-24 07:01:43','',0,0,'[]',2,'',NULL,NULL,NULL,NULL,NULL),(25,'ЧЕЛ-БУК-0002','',241,'FDO1628R0V1',NULL,11,9,9,'','de3907302a54',1,'','','','',NULL,NULL,14,NULL,'',5,NULL,'','2025-05-24 07:01:43','',0,0,'[]',NULL,'',NULL,NULL,NULL,NULL,NULL),(26,'МСК-МОН-0003','',193,'XKV0P9BA06YL',7,4,3,6,'','',5,'','','','',NULL,NULL,NULL,NULL,'',5,NULL,'','2025-05-24 07:01:43','',0,0,'[]',NULL,'',NULL,NULL,NULL,NULL,NULL),(27,'МСК-МОН-0004','',193,'XKV0P9BA10YL',17,4,7,6,'','',5,'','','','',NULL,NULL,NULL,NULL,'',5,NULL,'','2025-05-24 07:01:43','',0,0,'[]',NULL,'',NULL,NULL,NULL,NULL,NULL),(28,'ЧЕЛ-МОН-0001','',193,'XKV0P9BA15YL',8,9,12,1,'','',5,'','','','',NULL,NULL,NULL,NULL,'',NULL,NULL,'','2025-05-24 07:01:43','',0,0,'[]',NULL,'',NULL,NULL,NULL,NULL,NULL),(29,'ЧЕЛ-МОН-0002','',193,'XKV0P9BA1AYL',9,9,13,NULL,'','',NULL,'','','','',NULL,NULL,NULL,NULL,'',4,NULL,'','2025-05-24 07:01:43','',0,0,'[]',NULL,'',NULL,NULL,NULL,NULL,NULL),(30,'ЧЕЛ-МОН-0003','',193,'XKV0P9BA1fYL',10,10,14,1,'','',5,'','','','',NULL,NULL,NULL,NULL,'',5,NULL,'','2025-05-24 07:01:43','',0,0,'[]',NULL,'',NULL,NULL,NULL,NULL,NULL),(31,'ЧЕЛ-МОН-0004','',193,'XKV0P9BA21YL',11,10,15,NULL,'','',5,'','','','',NULL,NULL,NULL,NULL,'',NULL,NULL,'','2025-05-24 07:01:43','',0,0,'[]',NULL,'',NULL,NULL,NULL,NULL,NULL),(32,'ЧЕЛ-МОН-0005','',193,'XKV0P9BA25YL',NULL,8,NULL,1,'','',8,'','Разбили','','',NULL,NULL,NULL,NULL,'',NULL,NULL,'','2025-05-24 07:01:43','',0,0,'[]',NULL,'',NULL,NULL,NULL,NULL,NULL),(33,'ЧЕЛ-СРВ-0001','',4,'F14F0E5B9AF009933',NULL,8,NULL,1,'10.50.1.10','02e5027e90fa02e5027e90fb02e5027e90fc02e5027e90fd',5,'','','','CPU: 2x E5260v4\r\nRAM: 8x 32GB\r\nNET: 4x 1Gbit\r\nFC: 2x 8Gbit',NULL,NULL,22,19,'37-38',NULL,9,'','2026-08-14 02:30:00','',0,1,'[]',NULL,'',NULL,NULL,'VeniaminLevchenko',5,NULL),(34,'ЧЕЛ-СРВ-0002','',4,'F14F0E5B9AF009935',NULL,8,NULL,1,'10.50.1.11','72e6bbae08ca72e6bbae08cb72e6bbae08cc72e6bbae08cd',5,'','','','CPU: 2x E5260v4\r\nRAM: 8x 32GB\r\nNET: 4x 1Gbit\r\nFC: 2x 8Gbit',NULL,NULL,23,19,'35-36',NULL,9,'','2026-08-14 02:30:00','',0,1,'[]',NULL,'',NULL,NULL,'VeniaminLevchenko',5,NULL),(36,'МСК-РЕГ-0001','',389,'1901000885',NULL,2,NULL,NULL,'','',5,'','','','',NULL,NULL,NULL,NULL,'',NULL,NULL,'','2025-05-24 07:01:43','',0,0,'[]',NULL,'',NULL,NULL,NULL,NULL,NULL),(37,'МСК-ВИД-0001','',38,'0415401793',NULL,3,NULL,NULL,'10.20.33.10','186882920d99',5,'','','','',NULL,NULL,NULL,NULL,'',NULL,NULL,'','2025-05-24 07:01:43','',0,0,'[]',NULL,'',NULL,NULL,NULL,NULL,NULL),(38,'МСК-ВИД-0002','',38,'0415401794',NULL,4,NULL,NULL,'10.20.33.12','186882920d9a',5,'','','','',NULL,NULL,NULL,NULL,'',NULL,NULL,'','2025-05-24 07:01:43','',0,0,'[]',NULL,'',NULL,NULL,NULL,NULL,NULL),(39,'МСК-ВИД-0003','',38,'0415401790',NULL,2,NULL,NULL,'10.20.33.13','186882920d9b',5,'','','','',NULL,NULL,NULL,NULL,'',NULL,NULL,'','2025-05-24 07:01:43','',0,0,'[]',NULL,'',NULL,NULL,NULL,NULL,NULL),(40,'МСК-ВИД-0004','',38,'',NULL,6,NULL,NULL,'10.20.33.15','186882920d90',5,'','','','',NULL,NULL,NULL,NULL,'',NULL,NULL,'','2025-05-24 07:01:43','',0,0,'[]',NULL,'',NULL,NULL,NULL,NULL,NULL),(41,'МСК-ПРН-0001','',53,'VCF8955916',NULL,3,NULL,NULL,'10.20.40.10','0017c87697b1',5,'','','','',NULL,NULL,NULL,NULL,'',NULL,NULL,'','2025-05-24 07:01:43','',0,0,'[]',NULL,'',NULL,NULL,NULL,NULL,NULL),(42,'МСК-ПРН-0002','',53,'VCF8955908',NULL,4,NULL,NULL,'10.20.40.12','0017c877a410',5,'','','','',NULL,NULL,NULL,NULL,'',NULL,NULL,'','2025-05-24 07:01:43','',0,0,'[]',NULL,'',NULL,NULL,NULL,NULL,NULL),(43,'ЧЕЛ-ПРН-0001','',53,'VCF8953216',NULL,9,NULL,NULL,'10.50.40.10','0017c8778faf',5,'','','','',NULL,NULL,NULL,NULL,'',NULL,NULL,'','2025-05-24 07:01:43','',0,0,'[]',NULL,'',NULL,NULL,NULL,NULL,NULL),(44,'ЧЕЛ-ПРН-0002','',53,'VCF8953219',NULL,10,NULL,NULL,'10.50.40.12','0017c87ab169',5,'','','','',NULL,NULL,NULL,NULL,'',NULL,NULL,'','2025-05-24 07:01:43','',0,0,'[]',NULL,'',NULL,NULL,NULL,NULL,NULL),(45,'МСК-СХД-0001','',390,'',NULL,6,NULL,NULL,'10.20.1.100\n10.20.1.101','0003c0a42bf9-0003c0a42bfb',5,'https://10.20.1.100/','','','',298,NULL,NULL,18,'33-34',NULL,9,'','2026-08-23 07:10:00','',0,1,'[]',NULL,'',1,'msk-san','admin',5,NULL),(46,'МСК-ТЕЛ-0001','',138,'2104SN29201',5,3,2,6,'10.20.7.11','001c9295dd7f',NULL,'','1123','','',NULL,NULL,NULL,NULL,'',4,NULL,'','2026-07-02 10:45:00','',0,0,'[]',NULL,'',NULL,NULL,'DaniilZimin',NULL,NULL),(47,'МСК-ТЕЛ-0002','',138,'2104SN29202',6,3,4,6,'10.20.7.12','00478a632ad1',5,'','1122','','',NULL,NULL,NULL,NULL,'',4,NULL,'','2026-07-02 10:45:00','',0,0,'[]',NULL,'',NULL,NULL,'DaniilZimin',NULL,NULL),(48,'МСК-ТЕЛ-0003','',138,'2104SN29203',7,4,3,6,'10.20.7.13','00f93d7937b5',NULL,'','1201','','',NULL,NULL,NULL,NULL,'',5,NULL,'','2026-07-02 10:45:00','',0,0,'[]',NULL,'',NULL,NULL,'DaniilZimin',NULL,NULL),(49,'МСК-ТЕЛ-0004','',138,'2104SN29204',17,4,7,6,'10.20.7.14','000df36c941a',5,'','1202','','',NULL,NULL,NULL,NULL,'',5,NULL,'','2026-07-02 10:45:00','',0,0,'[]',NULL,'',NULL,NULL,'DaniilZimin',NULL,NULL),(50,'ЧЕЛ-ТЕЛ-0001','Тел. Yealink-2021-12',138,'2104SN29206',8,9,12,1,'10.50.7.11','007663e7f5e2',5,'','3021','','',NULL,NULL,NULL,NULL,'',NULL,NULL,'','2025-05-24 07:01:43','',0,0,'[]',1,'',NULL,NULL,NULL,NULL,NULL),(51,'ЧЕЛ-ТЕЛ-0002','',138,'2104SN29207',9,9,13,NULL,'10.50.7.12','00fdbb5e11fb',5,'','3024','','',NULL,NULL,NULL,NULL,'',4,NULL,'','2025-05-24 07:01:43','',0,0,'[]',NULL,'',NULL,NULL,NULL,NULL,NULL),(52,'ЧЕЛ-ТЕЛ-0003','',138,'2104SN29208',10,10,14,1,'10.50.7.14','0005c854d8c8',5,'','3011','','',NULL,NULL,NULL,NULL,'',5,NULL,'','2025-05-24 07:01:43','',0,0,'[]',NULL,'',NULL,NULL,NULL,NULL,NULL),(53,'ЧЕЛ-ТЕЛ-0004','',138,'2104SN29209',11,10,15,NULL,'10.50.7.16','00c1a95ed736',5,'','3014','','',NULL,NULL,NULL,NULL,'',NULL,NULL,'','2025-05-24 07:01:43','',0,0,'[]',NULL,'',NULL,NULL,NULL,NULL,NULL),(54,'ЧЕЛ-ТЕЛ-0005','',138,'2104SN2920A',24,11,10,10,'10.50.7.15','00f0c5c515b5',5,'','3044','','',NULL,NULL,NULL,NULL,'',5,NULL,'','2025-05-24 07:01:43','',0,0,'[]',NULL,'',NULL,NULL,NULL,NULL,NULL),(55,'ЧЕЛ-ТЕЛ-0006','',138,'2104SN2920B',25,11,9,9,'10.50.7.18','00adb2ddc53d',5,'','3041','','',NULL,NULL,NULL,NULL,'',5,NULL,'','2025-05-24 07:01:43','',0,0,'[]',NULL,'',NULL,NULL,NULL,NULL,NULL),(56,'МСК-ИБП-0002','',69,'3B1629X15430',5,3,2,6,'','',5,'','','','',NULL,NULL,NULL,NULL,'',4,NULL,'','2025-05-24 07:01:43','',0,0,'[]',NULL,'',NULL,NULL,NULL,NULL,NULL),(57,'МСК-ИБП-0003','',69,'3B1629X15432',6,3,4,6,'','',5,'','','','',NULL,NULL,NULL,NULL,'',4,NULL,'','2025-05-24 07:01:44','',0,0,'[]',NULL,'',NULL,NULL,NULL,NULL,NULL),(58,'МСК-ИБП-0004','',69,'3B1629X15433',7,4,3,6,'','',5,'','','','',NULL,NULL,NULL,NULL,'',5,NULL,'','2025-05-24 07:01:44','',0,0,'[]',NULL,'',NULL,NULL,NULL,NULL,NULL),(59,'МСК-ИБП-0005','',69,'3B1629X15436',17,4,7,6,'','',5,'','','','',NULL,NULL,NULL,NULL,'',5,NULL,'','2025-05-24 07:01:44','',0,0,'[]',NULL,'',NULL,NULL,NULL,NULL,NULL),(60,'ЧЕЛ-ИБП-0002','',69,'3B1629X15437',8,9,12,1,'','',5,'','','','',NULL,NULL,NULL,NULL,'',NULL,NULL,'','2025-05-24 07:01:44','',0,0,'[]',NULL,'',NULL,NULL,NULL,NULL,NULL),(61,'ЧЕЛ-ИБП-0003','',69,'3B1629X15438',9,9,13,NULL,'','',5,'','','','',NULL,NULL,NULL,NULL,'',4,NULL,'','2025-05-24 07:01:44','',0,0,'[]',NULL,'',NULL,NULL,NULL,NULL,NULL),(62,'ЧЕЛ-ИБП-0004','',69,'3B1629X15439',10,10,14,1,'','',5,'','','','',NULL,NULL,NULL,NULL,'',5,NULL,'','2025-05-24 07:01:44','',0,0,'[]',NULL,'',NULL,NULL,NULL,NULL,NULL),(63,'ЧЕЛ-ИБП-0005','',69,'3B1629X1543A',11,10,15,NULL,'','',5,'','','','',NULL,NULL,NULL,NULL,'',NULL,NULL,'','2025-05-24 07:01:44','',0,0,'[]',NULL,'',NULL,NULL,NULL,NULL,NULL),(9001,'ЧЕЛ-КОМ-0003','',194,'P1CV186021209',NULL,8,NULL,1,'10.50.1.2','00c3fee7a5ee',5,'','','','',NULL,NULL,NULL,19,'42',NULL,9,'','2026-08-23 07:00:00',NULL,1,0,'[]',NULL,'c2960x-chl-0003',1,'chl-sw-access-2','VeniaminLevchenko',3,'Gi2/0/1\nGi2/0/2\nGi2/0/3\nGi2/0/4\nGi2/0/5\nGi2/0/6\nGi2/0/7\nGi2/0/8\nGi2/0/9\nGi2/0/10\nGi2/0/11\nGi2/0/12\nGi2/0/13\nGi2/0/14\nGi2/0/15\nGi2/0/16\nGi2/0/17\nGi2/0/18\nGi2/0/19\nGi2/0/20\nGi2/0/21\nGi2/0/22\nGi2/0/23\nGi2/0/24\nGi2/0/25\nGi2/0/26\nGi2/0/27\nGi2/0/28\nGi2/0/29\nGi2/0/30\nGi2/0/31\nGi2/0/32\nGi2/0/33\nGi2/0/34\nGi2/0/35\nGi2/0/36\nGi2/0/37\nGi2/0/38\nGi2/0/39\nGi2/0/40\nGi2/0/41\nGi2/0/42\nGi2/0/43\nGi2/0/44\nGi2/0/45\nGi2/0/46\nGi2/0/47\nGi2/0/48');
...
INSERT INTO `techs_history` VALUES (1,18,'2025-05-14 06:51:38',NULL,NULL,'num,model_id,places_id,it_staff_id,state_id,partners_id,external_links,contracts_ids','МСК-ШК-0001',NULL,NULL,NULL,NULL,NULL,309,NULL,NULL,6,NULL,NULL,NULL,6,5,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'{\"rack-labels\":[{\"pos\":\"47\",\"back\":\"1\",\"label\":\"* светильник *\"},{\"pos\":\"42\",\"back\":\"1\",\"label\":\"- каб. органайзер -\"},{\"pos\":\"46\",\"back\":\"1\",\"label\":\"ПП 48 портов\"},{\"pos\":\"43\",\"back\":\"1\",\"label\":\" - каб. органайзер -\"},{\"pos\":\"26\",\"back\":\"\",\"label\":\"KVM консоль\"},{\"pos\":\"41\",\"back\":\"1\",\"label\":\"ПП 48 портов\"},{\"pos\":\"45\",\"back\":\"1\",\"label\":\" - каб. органайзер -\"},{\"pos\":\"24\",\"back\":\"1\",\"label\":\"Блок розеток\"},{\"pos\":\"22\",\"back\":\"1\",\"label\":\"Блок розеток\"}]}',0,0,'7',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(2,19,'2025-05-14 06:51:38',NULL,NULL,'num,model_id,places_id,it_staff_id,external_links,contracts_ids','ЧЕЛ-ШК-0001',NULL,NULL,NULL,NULL,NULL,309,NULL,NULL,8,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'{\"rack-labels\":[{\"pos\":\"47\",\"back\":\"1\",\"label\":\"* светильник *\"},{\"pos\":\"46\",\"back\":\"1\",\"label\":\"ПП 48 портов\"},{\"pos\":\"45\",\"back\":\"1\",\"label\":\" - каб. органайзер -\"},{\"pos\":\"42\",\"back\":\"1\",\"label\":\" - каб. органайзер -\"},{\"pos\":\"41\",\"back\":\"1\",\"label\":\"ПП 48 портов\"},{\"pos\":\"24\",\"back\":\"\",\"label\":\"KVM консоль\"}]}',0,0,'7',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(3,6,'2025-05-14 09:15:53',NULL,NULL,'num,sn,model_id,places_id,user_id,head_id,it_staff_id,state_id,comp_id,partners_id,mac,specs,contracts_ids,lic_keys_ids,materials_usages_ids','МСК-ПК-0004',NULL,'AAX380016311',NULL,NULL,NULL,327,NULL,NULL,3,4,4,NULL,6,5,NULL,NULL,6,1,NULL,'024208d2b582',NULL,NULL,NULL,NULL,NULL,'SSD: 240GB\r\nRAM: 8GB',NULL,NULL,0,0,'4',NULL,NULL,'8',NULL,NULL,'1',NULL,NULL,0,NULL,NULL),(4,1,'2025-05-23 11:27:09',NULL,NULL,'num,sn,model_id,installed_id,places_id,state_id,comp_id,partners_id,mac,installed_pos,specs,external_links,full_length,contracts_ids,lic_items_ids','МСК-СРВ-0001',NULL,'F14F0E5B9AF009901',NULL,NULL,NULL,4,NULL,18,6,NULL,NULL,NULL,NULL,5,NULL,NULL,1,1,NULL,'00155d3b793300155d3b793500155d3b793700155d3b7939','36-37',NULL,NULL,NULL,NULL,'CPU: 2x E5260v4\r\nRAM: 8x 32GB\r\nNET: 4x 1Gbit\r\nFC: 2x 8Gbit',NULL,'[]',0,1,'3',NULL,'2',NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(5,2,'2025-05-23 11:27:09',NULL,NULL,'num,inv_num,sn,model_id,installed_id,places_id,state_id,comp_id,partners_id,mac,installed_pos,specs,external_links,full_length,contracts_ids,lic_items_ids','МСК-СРВ-0002','0000072','F14F0E5B9AF009917',NULL,NULL,NULL,4,NULL,18,6,NULL,NULL,NULL,NULL,5,NULL,NULL,2,1,NULL,'00155d3b794100155d3b794300155d3b794500155d3b7947','38-39',NULL,NULL,NULL,NULL,'CPU: 2x E5260v4\r\nRAM: 8x 32GB\r\nNET: 4x 1Gbit\r\nFC: 2x 8Gbit',NULL,'[]',0,1,'3',NULL,'2',NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(6,3,'2025-05-23 11:27:09',NULL,NULL,'num,sn,model_id,places_id,state_id,partners_id,specs,external_links,contracts_ids,lic_keys_ids','МСК-ПК-0001',NULL,'AAX380016302',NULL,NULL,NULL,327,NULL,NULL,6,NULL,NULL,NULL,NULL,4,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'SSD: 240GB\r\nRAM: 8GB',NULL,'[]',0,0,'4',NULL,NULL,'1',NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(7,4,'2025-05-23 11:27:09',NULL,NULL,'num,sn,model_id,places_id,state_id,partners_id,specs,external_links,contracts_ids,lic_keys_ids','МСК-ПК-0002',NULL,'AAX380016308',NULL,NULL,NULL,327,NULL,NULL,6,NULL,NULL,NULL,NULL,4,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'SSD: 240GB\r\nRAM: 8GB',NULL,'[]',0,0,'4',NULL,NULL,'2',NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(8,5,'2025-05-23 11:27:09',NULL,NULL,'num,inv_num,sn,model_id,places_id,user_id,head_id,it_staff_id,state_id,comp_id,partners_id,ip,mac,comment,specs,external_links,contracts_ids,lic_keys_ids','МСК-ПК-0003','0000039','AAX380016309',NULL,NULL,NULL,327,NULL,NULL,3,2,4,NULL,6,5,NULL,NULL,5,1,'10.20.100.23','005056b4d780',NULL,NULL,NULL,'поцарапан корпус',NULL,'SSD: 240GB\r\nRAM: 8GB',NULL,'[]',0,0,'4',NULL,NULL,'7',NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(9,6,'2025-05-23 11:27:09',NULL,NULL,'external_links','МСК-ПК-0004',NULL,'AAX380016311',NULL,NULL,NULL,327,NULL,NULL,3,4,4,NULL,6,5,NULL,NULL,6,1,NULL,'024208d2b582',NULL,NULL,NULL,NULL,NULL,'SSD: 240GB\r\nRAM: 8GB',NULL,'[]',0,0,'4',NULL,NULL,'8',NULL,NULL,'1',NULL,NULL,0,NULL,NULL),(10,7,'2025-05-23 11:27:09',NULL,NULL,'num,sn,model_id,places_id,user_id,head_id,it_staff_id,state_id,comp_id,partners_id,mac,specs,external_links,contracts_ids,lic_keys_ids','МСК-ПК-0005',NULL,'AAX380016312',NULL,NULL,NULL,327,NULL,NULL,4,3,5,NULL,6,5,NULL,NULL,7,1,NULL,'1a9cc268ceb7',NULL,NULL,NULL,NULL,NULL,'SSD: 240GB\r\nRAM: 8GB',NULL,'[]',0,0,'4',NULL,NULL,'10',NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(11,8,'2025-05-23 11:27:09',NULL,NULL,'num,sn,model_id,places_id,user_id,it_staff_id,state_id,comp_id,partners_id,mac,specs,hw,external_links,contracts_ids,lic_keys_ids','ЧЕЛ-ПК-0001',NULL,'AAX380016314',NULL,NULL,NULL,327,NULL,NULL,9,12,NULL,NULL,1,5,NULL,NULL,9,1,NULL,'be6c0e44c1ac',NULL,NULL,NULL,NULL,NULL,'SSD: 240GB\r\nRAM: 8GB','[{\"type\":\"motherboard\",\"manufacturer\":\"Intel Corporation\",\"product\":\"NUC7JYB\",\"sn\":\"GEJY14900ACN\",\"cores\":null,\"capacity\":null,\"title\":\"Материнская плата\",\"manufacturer_id\":21,\"fingerprint\":\"motherboard|intel corporation|nuc7jyb|gejy14900acn\",\"hidden\":false,\"uid\":\"653b423a4a814\",\"inv_num\":null,\"manual_name\":null,\"manual_sn\":null},{\"type\":\"processor\",\"manufacturer\":\"Intel(R)\",\"product\":\"Intel(R) Celeron(R) J4025 CPU @ 2.00GHz\",\"sn\":\"\",\"cores\":\"2\",\"capacity\":null,\"title\":\"Процессор\",\"manufacturer_id\":21,\"fingerprint\":\"processor|intel(r)|intel(r) celeron(r) j4025 cpu @ 2.00ghz|\",\"hidden\":false,\"uid\":\"653b423a4a817\",\"inv_num\":null,\"manual_name\":null,\"manual_sn\":null},{\"type\":\"memorybank\",\"manufacturer\":\"Kingston\",\"product\":\"8192MiB\",\"sn\":\"\",\"cores\":null,\"capacity\":8192,\"title\":\"Модуль памяти\",\"manufacturer_id\":341,\"fingerprint\":\"memorybank|kingston|8192mib|\",\"hidden\":false,\"uid\":\"653b423a4a818\",\"inv_num\":null,\"manual_name\":null,\"manual_sn\":null},{\"type\":\"harddisk\",\"manufacturer\":\"KINGSTON\",\"product\":\"KINGSTON SA400S37240G 240GB\",\"sn\":\"\",\"cores\":null,\"capacity\":240,\"title\":\"Накопитель\",\"manufacturer_id\":341,\"fingerprint\":\"harddisk|kingston|kingston sa400s37240g 240gb|\",\"hidden\":false,\"uid\":\"653b423a4a81a\",\"inv_num\":null,\"manual_name\":null,\"manual_sn\":null},{\"type\":\"videocard\",\"manufacturer\":\"Intel(R)\",\"product\":\"Intel(R) UHD Graphics 600 1024MiB\",\"sn\":\"\",\"cores\":null,\"capacity\":\"1024\",\"title\":\"Видеокарта\",\"manufacturer_id\":21,\"fingerprint\":\"videocard|intel(r)|intel(r) uhd graphics 600 1024mib|\",\"hidden\":false,\"uid\":\"653b423a4a81b\",\"inv_num\":null,\"manual_name\":null,\"manual_sn\":null}]','[]',0,0,'4',NULL,NULL,'3',NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(12,9,'2025-05-23 11:27:09',NULL,NULL,'num,sn,model_id,places_id,user_id,head_id,state_id,comp_id,partners_id,mac,comment,specs,external_links,contracts_ids,lic_keys_ids','ЧЕЛ-ПК-0002',NULL,'AAX380016315',NULL,NULL,NULL,327,NULL,NULL,9,13,4,NULL,NULL,6,NULL,NULL,10,1,NULL,'ca817492a179',NULL,NULL,NULL,'Иногда падает в BSOD',NULL,'SSD: 240GB\r\nRAM: 8GB',NULL,'[]',0,0,'4',NULL,NULL,'5',NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(13,10,'2025-05-23 11:27:09',NULL,NULL,'num,sn,model_id,places_id,user_id,head_id,it_staff_id,state_id,comp_id,partners_id,mac,specs,external_links,contracts_ids,lic_keys_ids','ЧЕЛ-ПК-0003',NULL,'AAX380016316',NULL,NULL,NULL,327,NULL,NULL,10,14,5,NULL,1,5,NULL,NULL,11,1,NULL,'024475adf01a',NULL,NULL,NULL,NULL,NULL,'SSD: 240GB\r\nRAM: 8GB',NULL,'[]',0,0,'4',NULL,NULL,'4',NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(14,11,'2025-05-23 11:27:09',NULL,NULL,'num,sn,model_id,places_id,user_id,state_id,comp_id,partners_id,mac,specs,external_links,contracts_ids,lic_keys_ids','ЧЕЛ-ПК-0004',NULL,'AAX380016317',NULL,NULL,NULL,327,NULL,NULL,10,15,NULL,NULL,NULL,5,NULL,NULL,12,1,NULL,'f245fcbb16aa',NULL,NULL,NULL,NULL,NULL,'SSD: 240GB\r\nRAM: 8GB',NULL,'[]',0,0,'4',NULL,NULL,'6',NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(15,12,'2025-05-23 11:27:09',NULL,NULL,'num,sn,model_id,installed_id,places_id,state_id,partners_id,ip,mac,installed_pos,comment,external_links,installed_back,contracts_ids,services_ids','МСК-КОМ-0001',NULL,'FCW1842A3AL10',NULL,NULL,NULL,151,NULL,18,6,NULL,NULL,NULL,NULL,5,NULL,NULL,NULL,1,'10.20.1.1\n10.20.7.1\n10.20.33.1\n10.20.40.1\n10.20.75.1\n10.20.100.1\n10.20.101.1','00241b9689d6','43',NULL,NULL,'Ядро МСК',NULL,NULL,NULL,'[]',1,0,'4','4,6,7',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(16,13,'2025-05-23 11:27:10',NULL,NULL,'num,sn,model_id,places_id,state_id,installed_pos,history,external_links,installed_back,contracts_ids','МСК-КОМ-0002',NULL,'FCW1842A3AL17',NULL,NULL,NULL,151,NULL,NULL,6,NULL,NULL,NULL,NULL,4,NULL,NULL,NULL,NULL,NULL,NULL,'43',NULL,NULL,NULL,'лежит в серверной в ЗИП',NULL,NULL,'[]',1,0,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(17,14,'2025-05-23 11:27:10',NULL,NULL,'num,sn,model_id,installed_id,places_id,state_id,ip,mac,installed_pos,external_links,installed_back,contracts_ids,services_ids','ЧЕЛ-КОМ-0001',NULL,'FCW1842A3AL21',NULL,NULL,NULL,151,NULL,19,8,NULL,NULL,NULL,NULL,5,NULL,NULL,NULL,NULL,'10.50.1.1','005706abaf8a','44',NULL,NULL,NULL,NULL,NULL,NULL,'[]',1,0,'4','4,6,7,15',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(18,15,'2025-05-23 11:27:10',NULL,NULL,'num,sn,model_id,arms_id,places_id,user_id,head_id,it_staff_id,state_id,partners_id,external_links,contracts_ids','МСК-МОН-0001',NULL,'XKV0P9BA00YL',NULL,NULL,NULL,193,5,NULL,3,2,4,NULL,6,5,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'[]',0,0,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(19,16,'2025-05-23 11:27:10',NULL,NULL,'num,sn,model_id,arms_id,places_id,user_id,head_id,it_staff_id,state_id,partners_id,external_links,contracts_ids','МСК-МОН-0002',NULL,'XKV0P9BA01YL',NULL,NULL,NULL,193,6,NULL,3,4,4,NULL,6,5,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'[]',0,0,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(20,17,'2025-05-23 11:27:10',NULL,NULL,'num,sn,model_id,places_id,user_id,head_id,it_staff_id,state_id,comp_id,partners_id,mac,comment,specs,external_links,contracts_ids,lic_keys_ids','МСК-ПК-0006',NULL,'AAX3800163AA',NULL,NULL,NULL,327,NULL,NULL,4,7,5,NULL,6,7,NULL,NULL,8,1,NULL,'024231533ef0',NULL,NULL,NULL,'Пролила кофе',NULL,'SSD: 240GB\r\nRAM: 8GB',NULL,'[]',0,0,'4',NULL,NULL,'9',NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(21,20,'2025-05-23 11:27:10',NULL,NULL,'num,sn,model_id,installed_id,places_id,it_staff_id,state_id,installed_pos,installed_pos_end,external_links,full_length','МСК-ИБП-0001',NULL,'N06F10KM3000EF',NULL,NULL,NULL,310,NULL,18,6,NULL,NULL,NULL,6,5,NULL,NULL,NULL,NULL,NULL,NULL,'3-7','3-7,9-10',NULL,NULL,NULL,NULL,NULL,'[]',0,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(22,21,'2025-05-23 11:27:10',NULL,NULL,'num,sn,model_id,installed_id,places_id,it_staff_id,state_id,installed_pos,installed_pos_end,external_links,full_length','ЧЕЛ-ИБП-0001',NULL,'N06F10KM300011',NULL,NULL,NULL,310,NULL,19,8,NULL,NULL,NULL,1,5,NULL,NULL,NULL,NULL,NULL,NULL,'3-7','3-7,9-10',NULL,NULL,NULL,NULL,NULL,'[]',0,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(23,22,'2025-05-23 11:27:10',NULL,NULL,'num,sn,model_id,installed_id,places_id,it_staff_id,state_id,ip,installed_pos,external_links,installed_back,services_ids','МСК-КОМ-0003',NULL,'P1CV189071603',NULL,NULL,NULL,194,NULL,18,6,NULL,NULL,NULL,6,5,NULL,NULL,NULL,NULL,'10.20.1.2',NULL,'44',NULL,NULL,NULL,NULL,NULL,NULL,'[]',1,0,NULL,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(24,23,'2025-05-23 11:27:10',NULL,NULL,'num,sn,model_id,installed_id,places_id,it_staff_id,state_id,ip,mac,installed_pos,external_links,installed_back,services_ids','ЧЕЛ-КОМ-0002',NULL,'P1CV186021208',NULL,NULL,NULL,194,NULL,19,8,NULL,NULL,NULL,1,5,NULL,NULL,NULL,NULL,'10.50.1.2','00c3fee7a5ed','43',NULL,NULL,NULL,NULL,NULL,NULL,'[]',1,0,NULL,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(25,24,'2025-05-23 11:27:10',NULL,NULL,'num,sn,model_id,places_id,user_id,head_id,it_staff_id,state_id,comp_id,partners_id,mac,external_links','ЧЕЛ-БУК-0001',NULL,'FDO1628R0V7',NULL,NULL,NULL,241,NULL,NULL,11,10,5,NULL,10,1,NULL,NULL,13,2,NULL,'dea9a5774774',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'[]',0,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(26,25,'2025-05-23 11:27:10',NULL,NULL,'num,sn,model_id,places_id,user_id,head_id,it_staff_id,state_id,comp_id,mac,external_links','ЧЕЛ-БУК-0002',NULL,'FDO1628R0V1',NULL,NULL,NULL,241,NULL,NULL,11,9,5,NULL,9,1,NULL,NULL,14,NULL,NULL,'de3907302a54',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'[]',0,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(27,26,'2025-05-23 11:27:10',NULL,NULL,'num,sn,model_id,arms_id,places_id,user_id,head_id,it_staff_id,state_id,external_links,contracts_ids','МСК-МОН-0003',NULL,'XKV0P9BA06YL',NULL,NULL,NULL,193,7,NULL,4,3,5,NULL,6,5,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'[]',0,0,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(28,27,'2025-05-23 11:27:10',NULL,NULL,'num,sn,model_id,arms_id,places_id,user_id,head_id,it_staff_id,state_id,external_links,contracts_ids','МСК-МОН-0004',NULL,'XKV0P9BA10YL',NULL,NULL,NULL,193,17,NULL,4,7,5,NULL,6,5,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'[]',0,0,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(29,28,'2025-05-23 11:27:10',NULL,NULL,'num,sn,model_id,arms_id,places_id,user_id,it_staff_id,state_id,external_links,contracts_ids','ЧЕЛ-МОН-0001',NULL,'XKV0P9BA15YL',NULL,NULL,NULL,193,8,NULL,9,12,NULL,NULL,1,5,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'[]',0,0,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(30,29,'2025-05-23 11:27:11',NULL,NULL,'num,sn,model_id,arms_id,places_id,user_id,head_id,external_links,contracts_ids','ЧЕЛ-МОН-0002',NULL,'XKV0P9BA1AYL',NULL,NULL,NULL,193,9,NULL,9,13,4,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'[]',0,0,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(31,30,'2025-05-23 11:27:11',NULL,NULL,'num,sn,model_id,arms_id,places_id,user_id,head_id,it_staff_id,state_id,external_links,contracts_ids','ЧЕЛ-МОН-0003',NULL,'XKV0P9BA1fYL',NULL,NULL,NULL,193,10,NULL,10,14,5,NULL,1,5,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'[]',0,0,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(32,31,'2025-05-23 11:27:11',NULL,NULL,'num,sn,model_id,arms_id,places_id,user_id,state_id,external_links,contracts_ids','ЧЕЛ-МОН-0004',NULL,'XKV0P9BA21YL',NULL,NULL,NULL,193,11,NULL,10,15,NULL,NULL,NULL,5,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'[]',0,0,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(33,32,'2025-05-23 11:27:11',NULL,NULL,'num,sn,model_id,places_id,it_staff_id,state_id,comment,external_links,contracts_ids,archived','ЧЕЛ-МОН-0005',NULL,'XKV0P9BA25YL',NULL,NULL,NULL,193,NULL,NULL,8,NULL,NULL,NULL,1,8,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Разбили',NULL,NULL,NULL,'[]',0,0,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,NULL,NULL),(34,33,'2025-05-23 11:27:11',NULL,NULL,'num,sn,model_id,installed_id,places_id,it_staff_id,state_id,comp_id,ip,mac,installed_pos,specs,external_links,full_length','ЧЕЛ-СРВ-0001',NULL,'F14F0E5B9AF009933',NULL,NULL,NULL,4,NULL,19,8,NULL,NULL,NULL,1,5,NULL,NULL,22,NULL,'10.50.1.10','02e5027e90fa02e5027e90fb02e5027e90fc02e5027e90fd','37-38',NULL,NULL,NULL,NULL,'CPU: 2x E5260v4\r\nRAM: 8x 32GB\r\nNET: 4x 1Gbit\r\nFC: 2x 8Gbit',NULL,'[]',0,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(35,34,'2025-05-23 11:27:11',NULL,NULL,'num,sn,model_id,installed_id,places_id,it_staff_id,state_id,comp_id,ip,mac,installed_pos,specs,external_links,full_length','ЧЕЛ-СРВ-0002',NULL,'F14F0E5B9AF009935',NULL,NULL,NULL,4,NULL,19,8,NULL,NULL,NULL,1,5,NULL,NULL,23,NULL,'10.50.1.11','72e6bbae08ca72e6bbae08cb72e6bbae08cc72e6bbae08cd','35-36',NULL,NULL,NULL,NULL,'CPU: 2x E5260v4\r\nRAM: 8x 32GB\r\nNET: 4x 1Gbit\r\nFC: 2x 8Gbit',NULL,'[]',0,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(36,36,'2025-05-23 11:27:11',NULL,NULL,'num,sn,model_id,places_id,state_id,external_links,services_ids','МСК-РЕГ-0001',NULL,'1901000885',NULL,NULL,NULL,389,NULL,NULL,2,NULL,NULL,NULL,NULL,5,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'[]',0,0,NULL,'21',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(37,37,'2025-05-23 11:27:11',NULL,NULL,'num,sn,model_id,places_id,state_id,ip,mac,external_links,services_ids','МСК-ВИД-0001',NULL,'0415401793',NULL,NULL,NULL,38,NULL,NULL,3,NULL,NULL,NULL,NULL,5,NULL,NULL,NULL,NULL,'10.20.33.10','186882920d99',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'[]',0,0,NULL,'21',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(38,38,'2025-05-23 11:27:11',NULL,NULL,'num,sn,model_id,places_id,state_id,ip,mac,external_links,services_ids','МСК-ВИД-0002',NULL,'0415401794',NULL,NULL,NULL,38,NULL,NULL,4,NULL,NULL,NULL,NULL,5,NULL,NULL,NULL,NULL,'10.20.33.12','186882920d9a',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'[]',0,0,NULL,'21',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(39,39,'2025-05-23 11:27:11',NULL,NULL,'num,sn,model_id,places_id,state_id,ip,mac,external_links,services_ids','МСК-ВИД-0003',NULL,'0415401790',NULL,NULL,NULL,38,NULL,NULL,2,NULL,NULL,NULL,NULL,5,NULL,NULL,NULL,NULL,'10.20.33.13','186882920d9b',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'[]',0,0,NULL,'21',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(40,40,'2025-05-23 11:27:11',NULL,NULL,'num,model_id,places_id,state_id,ip,mac,external_links,services_ids','МСК-ВИД-0004',NULL,NULL,NULL,NULL,NULL,38,NULL,NULL,6,NULL,NULL,NULL,NULL,5,NULL,NULL,NULL,NULL,'10.20.33.15','186882920d90',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'[]',0,0,NULL,'21',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(41,41,'2025-05-23 11:27:11',NULL,NULL,'num,sn,model_id,places_id,state_id,ip,mac,external_links,contracts_ids','МСК-ПРН-0001',NULL,'VCF8955916',NULL,NULL,NULL,53,NULL,NULL,3,NULL,NULL,NULL,NULL,5,NULL,NULL,NULL,NULL,'10.20.40.10','0017c87697b1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'[]',0,0,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(42,42,'2025-05-23 11:27:11',NULL,NULL,'num,sn,model_id,places_id,state_id,ip,mac,external_links,contracts_ids','МСК-ПРН-0002',NULL,'VCF8955908',NULL,NULL,NULL,53,NULL,NULL,4,NULL,NULL,NULL,NULL,5,NULL,NULL,NULL,NULL,'10.20.40.12','0017c877a410',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'[]',0,0,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(43,43,'2025-05-23 11:27:11',NULL,NULL,'num,sn,model_id,places_id,state_id,ip,mac,external_links,contracts_ids','ЧЕЛ-ПРН-0001',NULL,'VCF8953216',NULL,NULL,NULL,53,NULL,NULL,9,NULL,NULL,NULL,NULL,5,NULL,NULL,NULL,NULL,'10.50.40.10','0017c8778faf',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'[]',0,0,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(44,44,'2025-05-23 11:27:11',NULL,NULL,'num,sn,model_id,places_id,state_id,ip,mac,external_links,contracts_ids','ЧЕЛ-ПРН-0002',NULL,'VCF8953219',NULL,NULL,NULL,53,NULL,NULL,10,NULL,NULL,NULL,NULL,5,NULL,NULL,NULL,NULL,'10.50.40.12','0017c87ab169',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'[]',0,0,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(45,45,'2025-05-23 11:27:11',NULL,NULL,'num,model_id,installed_id,places_id,state_id,scans_id,ip,mac,installed_pos,external_links,full_length','МСК-СХД-0001',NULL,NULL,NULL,NULL,NULL,390,NULL,18,6,NULL,NULL,NULL,NULL,5,298,NULL,NULL,NULL,'10.20.1.100\n10.20.1.101','0003c0a42bf90003c0a42bfb','33-34',NULL,NULL,NULL,NULL,NULL,NULL,'[]',0,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(46,46,'2025-05-23 11:27:11',NULL,NULL,'num,sn,model_id,arms_id,places_id,user_id,head_id,it_staff_id,ip,mac,comment,external_links,contracts_ids','МСК-ТЕЛ-0001',NULL,'2104SN29201',NULL,NULL,NULL,138,5,NULL,3,2,4,NULL,6,NULL,NULL,NULL,NULL,NULL,'10.20.7.11','001c9295dd7f',NULL,NULL,NULL,'1123',NULL,NULL,NULL,'[]',0,0,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(47,47,'2025-05-23 11:27:11',NULL,NULL,'num,sn,model_id,arms_id,places_id,user_id,head_id,it_staff_id,state_id,ip,mac,comment,external_links,contracts_ids','МСК-ТЕЛ-0002',NULL,'2104SN29202',NULL,NULL,NULL,138,6,NULL,3,4,4,NULL,6,5,NULL,NULL,NULL,NULL,'10.20.7.12','00478a632ad1',NULL,NULL,NULL,'1122',NULL,NULL,NULL,'[]',0,0,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(48,48,'2025-05-23 11:27:12',NULL,NULL,'num,sn,model_id,arms_id,places_id,user_id,head_id,it_staff_id,ip,mac,comment,external_links,contracts_ids','МСК-ТЕЛ-0003',NULL,'2104SN29203',NULL,NULL,NULL,138,7,NULL,4,3,5,NULL,6,NULL,NULL,NULL,NULL,NULL,'10.20.7.13','00f93d7937b5',NULL,NULL,NULL,'1201',NULL,NULL,NULL,'[]',0,0,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(49,49,'2025-05-23 11:27:12',NULL,NULL,'num,sn,model_id,arms_id,places_id,user_id,head_id,it_staff_id,state_id,ip,mac,comment,external_links,contracts_ids','МСК-ТЕЛ-0004',NULL,'2104SN29204',NULL,NULL,NULL,138,17,NULL,4,7,5,NULL,6,5,NULL,NULL,NULL,NULL,'10.20.7.14','000df36c941a',NULL,NULL,NULL,'1202',NULL,NULL,NULL,'[]',0,0,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(50,50,'2025-05-23 11:27:12',NULL,NULL,'num,inv_num,sn,model_id,arms_id,places_id,user_id,it_staff_id,state_id,partners_id,ip,mac,comment,external_links,contracts_ids','ЧЕЛ-ТЕЛ-0001','Тел. Yealink-2021-12','2104SN29206',NULL,NULL,NULL,138,8,NULL,9,12,NULL,NULL,1,5,NULL,NULL,NULL,1,'10.50.7.11','007663e7f5e2',NULL,NULL,NULL,'3021',NULL,NULL,NULL,'[]',0,0,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(51,51,'2025-05-23 11:27:12',NULL,NULL,'num,sn,model_id,arms_id,places_id,user_id,head_id,state_id,ip,mac,comment,external_links,contracts_ids','ЧЕЛ-ТЕЛ-0002',NULL,'2104SN29207',NULL,NULL,NULL,138,9,NULL,9,13,4,NULL,NULL,5,NULL,NULL,NULL,NULL,'10.50.7.12','00fdbb5e11fb',NULL,NULL,NULL,'3024',NULL,NULL,NULL,'[]',0,0,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(52,52,'2025-05-23 11:27:12',NULL,NULL,'num,sn,model_id,arms_id,places_id,user_id,head_id,it_staff_id,state_id,ip,mac,comment,external_links,contracts_ids','ЧЕЛ-ТЕЛ-0003',NULL,'2104SN29208',NULL,NULL,NULL,138,10,NULL,10,14,5,NULL,1,5,NULL,NULL,NULL,NULL,'10.50.7.14','0005c854d8c8',NULL,NULL,NULL,'3011',NULL,NULL,NULL,'[]',0,0,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(53,53,'2025-05-23 11:27:12',NULL,NULL,'num,sn,model_id,arms_id,places_id,user_id,state_id,ip,mac,comment,external_links,contracts_ids','ЧЕЛ-ТЕЛ-0004',NULL,'2104SN29209',NULL,NULL,NULL,138,11,NULL,10,15,NULL,NULL,NULL,5,NULL,NULL,NULL,NULL,'10.50.7.16','00c1a95ed736',NULL,NULL,NULL,'3014',NULL,NULL,NULL,'[]',0,0,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(54,54,'2025-05-23 11:27:12',NULL,NULL,'num,sn,model_id,arms_id,places_id,user_id,head_id,it_staff_id,state_id,ip,mac,comment,external_links,contracts_ids','ЧЕЛ-ТЕЛ-0005',NULL,'2104SN2920A',NULL,NULL,NULL,138,24,NULL,11,10,5,NULL,10,5,NULL,NULL,NULL,NULL,'10.50.7.15','00f0c5c515b5',NULL,NULL,NULL,'3044',NULL,NULL,NULL,'[]',0,0,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(55,55,'2025-05-23 11:27:12',NULL,NULL,'num,sn,model_id,arms_id,places_id,user_id,head_id,it_staff_id,state_id,ip,mac,comment,external_links,contracts_ids','ЧЕЛ-ТЕЛ-0006',NULL,'2104SN2920B',NULL,NULL,NULL,138,25,NULL,11,9,5,NULL,9,5,NULL,NULL,NULL,NULL,'10.50.7.18','00adb2ddc53d',NULL,NULL,NULL,'3041',NULL,NULL,NULL,'[]',0,0,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(56,56,'2025-05-23 11:27:12',NULL,NULL,'num,sn,model_id,arms_id,places_id,user_id,head_id,it_staff_id,state_id,external_links,contracts_ids','МСК-ИБП-0002',NULL,'3B1629X15430',NULL,NULL,NULL,69,5,NULL,3,2,4,NULL,6,5,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'[]',0,0,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(57,57,'2025-05-23 11:27:12',NULL,NULL,'num,sn,model_id,arms_id,places_id,user_id,head_id,it_staff_id,state_id,external_links,contracts_ids','МСК-ИБП-0003',NULL,'3B1629X15432',NULL,NULL,NULL,69,6,NULL,3,4,4,NULL,6,5,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'[]',0,0,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(58,58,'2025-05-23 11:27:12',NULL,NULL,'num,sn,model_id,arms_id,places_id,user_id,head_id,it_staff_id,state_id,external_links,contracts_ids','МСК-ИБП-0004',NULL,'3B1629X15433',NULL,NULL,NULL,69,7,NULL,4,3,5,NULL,6,5,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'[]',0,0,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(59,59,'2025-05-23 11:27:12',NULL,NULL,'num,sn,model_id,arms_id,places_id,user_id,head_id,it_staff_id,state_id,external_links,contracts_ids','МСК-ИБП-0005',NULL,'3B1629X15436',NULL,NULL,NULL,69,17,NULL,4,7,5,NULL,6,5,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'[]',0,0,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(60,60,'2025-05-23 11:27:12',NULL,NULL,'num,sn,model_id,arms_id,places_id,user_id,it_staff_id,state_id,external_links,contracts_ids','ЧЕЛ-ИБП-0002',NULL,'3B1629X15437',NULL,NULL,NULL,69,8,NULL,9,12,NULL,NULL,1,5,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'[]',0,0,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(61,61,'2025-05-23 11:27:12',NULL,NULL,'num,sn,model_id,arms_id,places_id,user_id,head_id,state_id,external_links,contracts_ids','ЧЕЛ-ИБП-0003',NULL,'3B1629X15438',NULL,NULL,NULL,69,9,NULL,9,13,4,NULL,NULL,5,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'[]',0,0,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(62,62,'2025-05-23 11:27:12',NULL,NULL,'num,sn,model_id,arms_id,places_id,user_id,head_id,it_staff_id,state_id,external_links,contracts_ids','ЧЕЛ-ИБП-0004',NULL,'3B1629X15439',NULL,NULL,NULL,69,10,NULL,10,14,5,NULL,1,5,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'[]',0,0,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(63,63,'2025-05-23 11:27:12',NULL,NULL,'num,sn,model_id,arms_id,places_id,user_id,state_id,external_links,contracts_ids','ЧЕЛ-ИБП-0005',NULL,'3B1629X1543A',NULL,NULL,NULL,69,11,NULL,10,15,NULL,NULL,NULL,5,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'[]',0,0,'4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL),(64,41,'2025-05-25 16:07:23',NULL,NULL,'materials_usages_ids','МСК-ПРН-0001',NULL,'VCF8955916',NULL,NULL,NULL,53,NULL,NULL,3,NULL,NULL,NULL,NULL,5,NULL,NULL,NULL,NULL,'10.20.40.10','0017c87697b1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'[]',0,0,'4',NULL,NULL,NULL,NULL,NULL,'2',NULL,NULL,0,NULL,NULL);
...
INSERT INTO `users` VALUES (1,'1',2,'','Системный администратор','Безруков Аверьян Егорович',1,0,'admin','admin@X3.team','3034','+7 (912) 137-28-86','3034','9-02-1984',5,'03.02.2016',NULL,0,NULL,NULL,'Ведёт инвентаризацию и доступы','',NULL,'S-1-5-21-1001','','$2y$10$7OAEju9r2jCAWUpA2F0PZew.62aUgCjZ6MED1A8ZOXsJc7m5SgU9i','2026-08-12 03:30:00','admin'),(2,'08000004',1,'1','Бухгалтер','Белозёрова Нина Геннадиевна',1,0,'NinaBelozerova','NinaBelozerova@taburetka.fidonet','1123','+7 (998) 558-41-00','1123','27-09-2001',4,'08.08.2020',NULL,0,NULL,NULL,'','',NULL,'','',NULL,'2026-07-26 05:06:00','sapsync'),(3,'08000002',1,'2','Менеджер','Садовский Ким Тарасович',1,0,'KimSadovskiy','KimSadovskiy@taburetka.fidonet','1201','+7 (961) 050-16-30','1201-3','20.08.1998',14,'14.03.2020',NULL,0,NULL,NULL,'','+7 (931) 777-21-14',NULL,'','',NULL,'2026-08-03 02:40:00','sapsync'),(4,'08000006',1,'1','Главный бухгалтер','Бровина Серафима Викторовна',1,0,'SerafimaBrovina','SerafimaBrovina@taburetka.fidonet','1122','+7 (922) 194-16-41','1122','17.03.1983',5,'19.05.2017',NULL,0,NULL,NULL,'','',NULL,'','',NULL,'2026-07-26 05:05:00','sapsync'),(5,'08000007',1,'4','Генеральный директор','Александров Назар Иванович',1,0,'NazarAleksandrov','NazarAleksandrov@taburetka.fidonet','1100','+7 (959) 891-61-87','1100','18.11.1983',NULL,'12.01.2015',NULL,0,NULL,NULL,'','',NULL,'S-1-5-21-1102','',NULL,'2026-07-26 05:00:00','sapsync'),(6,'08000011',1,'3','Системный администратор','Зимин Даниил Егорович',1,0,'DaniilZimin','DaniilZimin@taburetka.fidonet','1136','+7 (952) 073-14-59','1136','26.05.1991',1,'11.11.2021',NULL,0,NULL,NULL,'','',NULL,'S-1-5-21-1004','',NULL,'2026-08-12 03:36:00','admin'),(7,'08000012',1,'2','Менеджер','Мартынова Анфиса Романовна',1,0,'AnfisaMartynova','AnfisaMartynova@taburetka.fidonet','1202','+7 (919) 346-73-99','1202','17.08.2000',14,'21.10.2021',NULL,0,NULL,NULL,'','',NULL,'','',NULL,'2026-07-26 05:12:00','sapsync'),(8,'08000011',1,'5','Офис менеджер','Мартын Викторина Антоновна',1,0,'ViktorinaMartyn','info@taburetka.fidonet','1000','+7 (947) 481-53-92','1000','30.09.2001',5,'05.04.2019',NULL,0,NULL,NULL,'','',NULL,'','',NULL,'2026-07-26 05:14:00','sapsync'),(9,'2',2,'','Системный администратор','Левченко Вениамин Васильевич',1,0,'VeniaminLevchenko','VeniaminLevchenko@X3.team','3041','+7 (991) 634-40-89','3041','18.01.2000',1,'17.09.2019',NULL,0,NULL,NULL,'','',NULL,'S-1-5-21-1002','10.50.50.6',NULL,'2026-08-12 03:32:00','admin'),(10,'4',2,'','Специалист техподдержки','Баринов Борис Григорьевич',1,0,'BorisBarinov','BorisBarinov@X3.team','3044','+7 (967) 238-36-05','3044','24.05.1977',1,'04.03.2021',NULL,0,NULL,NULL,'','',NULL,'S-1-5-21-1003','10.50.50.5',NULL,'2026-08-12 03:34:00','admin'),(11,'08000002',1,'2','Менеджер','Тарская Элина Львовна',1,1,'ElinaTarskaya','ElinaTarskaya@taburetka.fidonet','','+7 (919) 074-41-69','','08.12.1975',14,NULL,'30.04.2026',0,NULL,NULL,'','',NULL,'','',NULL,'2026-04-30 01:00:00','sapsync'),(12,'08000013',1,'1','Бухгалтер','Городнов Силантий Петрович',1,0,'SilantiyGorodnov','SilantiyGorodnov@taburetka.fidonet','3021','','3021','08.12.1975',4,'02.09.2021',NULL,0,NULL,NULL,'','+7 (950) 575-66-51',NULL,'','10.50.50.4',NULL,'2026-07-26 05:07:00','sapsync'),(13,'08000014',1,'1','Бухгалтер по первичным документам','Осипова Борислава Филипповна',1,0,'BorislavaOsipova','BorislavaOsipova@taburetka.fidonet','3024','','3024','04.05.1995',4,'15.02.2022',NULL,0,NULL,NULL,'','+7 (964) 960-41-93',NULL,'','',NULL,'2026-07-26 05:08:00','sapsync'),(14,'08000015',1,'2','Менеджер по работе с корп. клиентами','Питерский Арнольд Матвеевич',1,0,'ArnoldPiterskiy','sales@taburetka.fidonet','3011','+7 (901) 400-88-82','3011','27.06.1975',5,'01.06.2018',NULL,0,NULL,NULL,'','',NULL,'','',NULL,'2026-07-26 05:10:00','sapsync'),(15,'08000017',1,'2','Менеджер','Кириллов Аполлон Евгеньевич',1,0,'ApollonKirillov','sales2@taburetka.fidonet','3014','+7 (961) 020-15-86','3014','27.09.1975',14,'19.08.2026',NULL,0,NULL,NULL,'','',NULL,'','',NULL,'2026-08-19 03:05:00','sapsync'),(17,'',NULL,NULL,'','Гость',3,0,'guest','','','','','',NULL,NULL,NULL,1,NULL,NULL,'Учётка для демонстрационного входа, синхронизацией не трогается','',NULL,'','','$2y$10$0.iukrq0FBy6VHvLzBvULOPUliLd70Qo7Sl1hGvJs0.r5sJH9t1gu','2026-07-26 05:20:00','admin');
...
CREATE TABLE `users_history` (
  ...
  `Persg` int DEFAULT NULL,
  `Uvolen` tinyint(1) DEFAULT NULL,
  `Login` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `Email` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `Phone` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `Mobile` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `Bday` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `manager_id` int DEFAULT NULL,
  `employ_date` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `resign_date` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nosync` tinyint(1) DEFAULT NULL,
  `notepad` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `private_phone` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `external_links` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `uid` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `changed_attributes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`id`),
  KEY `idx-users_history-master_id` (`master_id`),
  KEY `idx-users_history-updated_at` (`updated_at`),
  KEY `idx-users_history-updated_by` (`updated_by`)
) ENGINE=InnoDB AUTO_INCREMENT=9011 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users_history` VALUES (9001,3,'08000002',1,'2','Специалист отдела продаж','Садовский Ким Тарасович',1,0,'KimSadovskiy','KimSadovskiy@taburetka.fidonet','1201','+7 (961) 050-16-30',NULL,'20.08.1998',NULL,'14.03.2020',NULL,0,'','+7 (931) 777-21-14',NULL,'','','2026-02-10 00:00:00','sapsync',NULL,'Doljnost'),(9002,3,'08000002',1,'2','Менеджер','Садовский Ким Тарасович',1,0,'KimSadovskiy','KimSadovskiy@taburetka.fidonet','1201','+7 (961) 050-16-30',NULL,'20.08.1998',NULL,'14.03.2020',NULL,0,'','+7 (931) 777-21-14',NULL,'','','2026-05-14 00:00:00','sapsync','Перевод на позицию менеджера','Doljnost'),(9003,3,'08000002',1,'2','Менеджер','Садовский Ким Тарасович',1,0,'KimSadovskiy','KimSadovskiy@taburetka.fidonet','1201','+7 (961) 050-16-30','1201-3','20.08.1998',14,'14.03.2020',NULL,0,'','+7 (931) 777-21-14',NULL,'','','2026-08-03 02:40:00','sapsync',NULL,'work_phone,manager_id'),(9004,6,'08000011',1,'3','Специалист техподдержки','Зимин Даниил Егорович',1,0,'DaniilZimin','DaniilZimin@taburetka.fidonet','1136','+7 (952) 073-14-59','1136','26.05.1991',NULL,'11.11.2021',NULL,0,'','',NULL,NULL,'','2026-03-01 00:00:00','sapsync',NULL,'Doljnost'),(9005,6,'08000011',1,'3','Системный администратор','Зимин Даниил Егорович',1,0,'DaniilZimin','DaniilZimin@taburetka.fidonet','1136','+7 (952) 073-14-59','1136','26.05.1991',1,'11.11.2021',NULL,0,'','',NULL,NULL,'','2026-06-20 00:00:00','sapsync','Повышение по итогам аттестации','Doljnost,manager_id'),(9006,6,'08000011',1,'3','Системный администратор','Зимин Даниил Егорович',1,0,'DaniilZimin','DaniilZimin@taburetka.fidonet','1136','+7 (952) 073-14-59','1136','26.05.1991',1,'11.11.2021',NULL,0,'','',NULL,'S-1-5-21-1004','','2026-08-12 03:36:00','admin',NULL,'uid'),(9007,11,'08000002',1,'2','Менеджер','Тарская Элина Львовна',1,0,'ElinaTarskaya','ElinaTarskaya@taburetka.fidonet','1204','+7 (919) 074-41-69','','08.12.1975',14,NULL,NULL,0,'','',NULL,'','','2026-01-15 00:00:00','sapsync',NULL,'Phone'),(9008,11,'08000002',1,'2','Менеджер','Тарская Элина Львовна',1,1,'ElinaTarskaya','ElinaTarskaya@taburetka.fidonet','','+7 (919) 074-41-69','','08.12.1975',14,NULL,'30.04.2026',0,'','',NULL,'','','2026-04-30 01:00:00','sapsync','Увольнение по собственному желанию','Uvolen,Phone,resign_date'),(9009,15,'08000017',1,'2','Менеджер','Кириллов Аполлон Евгеньевич',1,0,NULL,NULL,'3014','+7 (961) 020-15-86',NULL,'27.09.1975',NULL,'19.08.2026',NULL,0,'','',NULL,'','','2026-08-18 00:00:00','sapsync','Приём на работу','Ename,Doljnost,employ_date'),(9010,15,'08000017',1,'2','Менеджер','Кириллов Аполлон Евгеньевич',1,0,'ApollonKirillov','sales2@taburetka.fidonet','3014','+7 (961) 020-15-86','3014','27.09.1975',14,'19.08.2026',NULL,0,'','',NULL,'','','2026-08-19 03:05:00','sapsync','Заведена учётная запись в AD','Login,Email,work_phone,manager_id');
...
INSERT INTO `users_in_aces` VALUES (1,10,1),(2,9,1),(4,1,3),(7,6,4),(9001,2,9001),(9002,4,9001),(9003,12,9001),(9004,13,9001),(9005,1,9002),(9006,9,9002);
...
INSERT INTO `users_in_contracts` VALUES (9001,1,3),(9002,9,3),(9003,6,4),(9004,1,7),(9005,14,1),(9006,14,2);
...
INSERT INTO `users_in_services` VALUES (6,5,1),(14,12,10),(21,22,6),(22,23,9),(24,3,10),(25,3,9),(34,18,1),(35,13,6),(41,21,1),(42,24,6),(43,20,6),(44,20,9),(45,17,1),(49,26,6),(50,11,10);
...
INSERT INTO `users_in_svc_infrastructure` VALUES (9001,8,9),(9002,9,9),(9003,10,9),(9004,15,6),(9005,16,6),(9006,17,6),(9007,26,1),(9008,20,10);
