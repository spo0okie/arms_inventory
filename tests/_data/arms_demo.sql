...
INSERT INTO `absences` VALUES (1,1,'VACATION','2026-01-09','2026-01-20',NULL,'manual',NULL,'2026-01-05 08:00:00','seed');
...
INSERT INTO `maintenance_reqs` VALUES (1,'Бэкап ВМ 7/3/0','Кратковременное хранение с ежедневным бэкапом за неделю  \r\n**стратегия GFS  - 3 ежемесячных, 7 ежедневных точек восстановления**',1,1,0,NULL,'2025-05-25 16:02:54',NULL,NULL,NULL),(2,'Бэкап ВМ 7/3/3','Кратковременное хранение с ежедневным бэкапом за неделю  \r\n**стратегия GFS  - 3 ежегодных, 3 ежемесячных, 7 ежедневных точек восстановления**',1,1,0,NULL,'2025-05-25 16:03:37',NULL,NULL,NULL);
...
INSERT INTO `net_domains` VALUES (1,'msk_dom','Московский L2 Домен',1,NULL),(2,'chl_dom','',7,NULL);
...
CREATE TABLE `ports` (
  ...
  `aggr` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `tags` VALUES (1,'Связь','svaz','#274e13','',0,0,'2025-12-17 12:33:06','2025-12-17 12:34:02',NULL),(2,'Облачный','cloud','#4a86e8','',0,0,'2025-12-17 12:33:45','2025-12-17 12:33:45',NULL);
...
INSERT INTO `tags_links` VALUES (1,1,'app\\models\\Services',1,'2025-12-17 12:34:36'),(2,1,'app\\models\\Services',2,'2025-12-17 12:34:43'),(3,1,'app\\models\\Services',11,'2025-12-17 12:34:55');
...
CREATE TABLE `tech_models` (
  ...
  `updated_by` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `archived` tinyint(1) DEFAULT NULL,
  `ports_layout` text COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`),
  KEY `type_id` (`type_id`),
  KEY `manufacturers_id` (`manufacturers_id`),
...
INSERT INTO `tech_types` VALUES (1,'pc','ПК','ПК','Персональный компьютер (создано автоматически при обновлении БД)',NULL,NULL,1,0,0,0,'2023-09-04 04:16:59',NULL,NULL,NULL,NULL),(2,'voip_phone','IP Телефон','ТЕЛ','Количество линий?\r\nУмеет провижнинг?\r\nУмеет отказоустойчивость?\r\nПитание POE/ БП (идет ли в комплекте)?\r\nМожно включать бриджом?\r\nЛогин / пароль по умолч.\r\nнеочевидное расположение серийного номера?','Внутренний номер','Внутренний телефонный номер, назначенный этому аппарату',0,1,0,0,'2023-08-28 13:41:17',NULL,NULL,NULL,NULL),(3,'srv','Серв. оборуд.','СРВ','Назначение оборудования\r\nПроцессор: модель @частота (количество ядер)\r\nПамять: объем (тип)\r\nНМЖД: тип объем @rpm, RAID контроллеры\r\nВидео: модель (объем VRAM)\r\nУдаленное управление\r\nOC: Версия операционной системы (Pro/не Pro)\r\nПорты: список имеющихся портов\r\nнеочевидное расположение серийного номера?','','',1,0,0,0,'2023-09-09 18:05:26','admin',NULL,NULL,NULL),(4,'net_router','Маршрутизатор','МРШ','Какое количествое каких типов портов?\r\nНаличие PoE (кол-во портов, макс бюджет)?\r\nСPU/RAM\r\nЛогин / пароль по умолч.\r\nнеочевидное расположение серийного номера?','','',0,0,0,0,'2023-08-28 13:41:17',NULL,NULL,NULL,NULL),(5,'voip_gw','VoIP GW','ТЕЛ','Количество линий?\r\nУмеет провижнинг?\r\nУмеет отказоустойчивость?\r\nПитание POE/ БП (идет ли в комплекте)?\r\nМожно включать бриджом?\r\nЛогин / пароль по умолч.\r\nнеочевидное расположение серийного номера?','','',0,0,0,0,'2023-08-28 13:41:17',NULL,NULL,NULL,NULL),(6,'mfu_bw_a3','Печатное оборуд.','ПРН','Принетер/МФУ, формат бумаги, цветной?\r\nСетевой?\r\nПоддержка двусторонней печати?\r\nСканирование с податчика?, Поддержка двустороннего сканирования?\r\nСканирование в SMB/FTP/Почту?\r\nДопустимая нагрузка по печати (стр/мес)?\r\nМодели картриджей (цвет, емкость)?\r\nЛогин/пароль по умолчанию?\r\nнеочевидное расположение серийного номера?','Сетевой путь','Полный сетевой путь к принтеру вместе с сервером печати, на котором опубликован. Например \\\\msk-fsrv-open\\HP_LJ2021_5',0,0,0,0,'2023-08-28 13:41:17',NULL,NULL,NULL,NULL),(7,'net_switch','Коммутатор','КОМ','Управляемый?\r\nКакое количествое каких типов портов?\r\nНаличие PoE (кол-во портов, макс бюджет)?\r\nЛогин / пароль по умолч.\r\nнеочевидное расположение серийного номера?','','',0,0,0,0,'2023-08-28 13:41:17',NULL,NULL,NULL,NULL),(8,'ups','ИБП','ИБП','Управляемый? \r\nЕмкость, макс мощность?\r\nПланируемое время при типовых нагрузках?\r\nВозможность установки доп бат. модулей?\r\nКакое количество каких типов розеток?\r\nМодели батарейных блоков / сборок / батарей?\r\nЛогин / пароль по умолч?\r\nнеочевидное расположение серийного номера?','','',0,0,1,0,'2023-08-28 13:41:17',NULL,NULL,NULL,NULL),(9,'wifi_ap','WiFi Точка Доступа','ВФЙ','Поддерживаемые протоколы, частоты?\r\nРадиус действия (в помещ/ на улице)?\r\nУличной/внутренней установки?\r\nОбъединение в mesh?\r\nПитание (наличие БП / инжектора в комплекте)?\r\nЛогин / пароль по умолч.\r\nнеочевидное расположение серийного номера?','','',0,0,0,0,'2023-08-28 13:41:17',NULL,NULL,NULL,NULL),(10,'dvr_cam','Камера видеонабл.','ВИД','Цифровая / аналоговая\r\nВнешняя / внутренняя / температурный режим\r\nРазрешение, угол обзора, запись аудио\r\nРежим день/ночь, ИК подсветка\r\nPTZ?\r\nСетевые настройки по умолч.','','',0,0,0,0,'2023-08-28 13:41:17',NULL,NULL,NULL,NULL),(11,'wifi_router','WiFi router','ВФЙ','Поддерживаемые протоколы, частоты?\r\nРадиус действия (в помещ/ на улице)?\r\nУличной/внутренней установки?\r\nОбъединение в mesh?\r\nПитание (наличие БП / инжектора в комплекте)?\r\nЛогин / пароль по умолч.\r\nнеочевидное расположение серийного номера?','','',0,0,0,0,'2023-08-28 13:41:17',NULL,NULL,NULL,NULL),(12,'nas','СХД','СХД','Количество контроллеров\r\nКоличество блоков питания\r\nРежим взаимодействия контроллеров\r\nКоличество и формат дисков в корзине\r\nПоддержка сжатия, поддержка дедупликации\r\nСетевые интерфейсы','','',0,0,0,0,'2023-08-28 13:41:17',NULL,NULL,NULL,NULL),(13,'laptop','Ноутбук','БУК','Экран: матовый/глянец Диагональ IPS/TN @разрешение\r\nПроцессор: модель @частота (количество ядер)\r\nПамять: объем (тип)\r\nНМЖД: тип объем @rpm\r\nВидео: модель (объем VRAM)\r\nOC: Версия операционной системы (Pro/не Pro)\r\nПорты: список имеющихся портов\r\nнеочевидное расположение серийного номера?','','',1,0,0,0,'2023-09-13 16:11:42','admin',NULL,NULL,NULL),(14,'skud','СКУД','СКД','Тип оборудования: Турникет, Пилон, Считыватель\r\nНаличие сетевого интерфейса, тип','','',0,0,0,0,'2023-08-28 13:41:17',NULL,NULL,NULL,NULL),(15,'scan','Сканер','СКАН','Сетевой/нет?\r\nПланшетный/протяжный?\r\nДвусторонний?\r\nСкнирование в FTP/SMB/SMTP?','','',0,0,0,0,'2023-08-28 13:41:17',NULL,NULL,NULL,NULL),(16,'display','Монитор','МОН','Диагональ, разрешение\r\nПовортный/неповоротный экран\r\nМатрица, Покрытие\r\nПорты\r\nНаличие колонок\r\nВнешний БП?','','',0,0,0,1,'2023-08-28 13:41:17',NULL,NULL,NULL,NULL),(17,'web_camera','Веб-камера','ВЕБ','Максимальное разрешение 720p\r\nКоличество мегапикселей у камеры: 1.2\r\nТип фокусировки: постоянный фокус\r\nВстроенный микрофон: Монофонический\r\nДиапазон микрофона: До 1 м\r\nПоле обзора по диагонали: 60°\r\nУниверсальное крепление для ноутбука, ЖК-экрана или монитора\r\nПодключение кабелем длиной 1,5 м\r\n','','',0,0,0,0,'2023-08-28 13:41:17',NULL,NULL,NULL,NULL),(18,'videoconf','Терминал ВКС','ВКС','Наличие, тип камеры\r\nНаличие, тип дисплея\r\n','','',0,0,0,0,'2023-08-28 13:41:17',NULL,NULL,NULL,NULL),(19,'aio_pc','Моноблок',NULL,'Экран: матовый/глянец Диагональ IPS/TN @разрешение\r\nПроцессор: модель @частота (количество ядер)\r\nПамять: объем (тип)\r\nНМЖД: тип объем @rpm\r\nВидео: модель (объем VRAM)\r\nOC: Версия операционной системы (Pro/не Pro)\r\nПорты: список имеющихся портов\r\nнеочевидное расположение серийного номера?','','',1,0,0,0,'2023-08-28 13:41:17',NULL,NULL,NULL,NULL),(20,'vid_reg','Видеорегистратор','РЕГ','Цифровая / аналоговая\r\nРазрешение, угол обзора, запись аудио\r\nРежим день/ночь, ИК подсветка\r\nPTZ?\r\nСетевые настройки по умолч.','','',0,0,0,0,'2023-08-28 13:41:17',NULL,NULL,NULL,NULL),(21,'Racks','Шкафы и стойки','ШК','Высота (U)\r\nГабариты\r\nТип дверей (перф/стекло)','','',0,0,0,0,'2023-08-28 13:41:17',NULL,NULL,NULL,NULL),(22,'Сист_контр.','Системы мониторинга','конт','За чем может следить\r\nКакие дополнительные датчики подключаются\r\nНаименование модулей расширения','Системы мониторинга серверной и ','',0,0,0,0,'2023-08-28 13:41:17',NULL,NULL,NULL,NULL),(23,'usb_k','USB концентратор','USB','Количество портов?','','',0,0,0,0,'2023-08-28 13:41:17',NULL,NULL,NULL,NULL),(24,'tsd','Терминалы сбора данных','ТРМ','Операционная система\r\nТип, диагональ экрана\"@разрешение\r\nCPU\r\nRAM\r\nStorage\r\nWiFi\r\nАккумулятор\r\nКамеры','','',0,0,0,0,'2023-08-28 13:41:17',NULL,NULL,NULL,NULL);
...
CREATE TABLE `techs` (
  ...
  `ports_override` text COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`id`),
  UNIQUE KEY `num` (`num`),
  KEY `user_id` (`user_id`),
...
INSERT INTO `users` VALUES (1,'1',2,'','Системный администратор','Безруков Аверьян Егорович',1,0,'admin','admin@X3.team','3034','+7 (912) 137-28-86','','9-02-1984',NULL,NULL,NULL,0,NULL,NULL,'','',NULL,'','','$2y$10$7OAEju9r2jCAWUpA2F0PZew.62aUgCjZ6MED1A8ZOXsJc7m5SgU9i',NULL,NULL),(2,'08000004',1,'1','Бухгалтер','Белозёрова Нина Геннадиевна',1,0,'NinaBelozerova','NinaBelozerova@taburetka.fidonet','1123','+7 (998) 558-41-00','','27-09-2001',NULL,NULL,NULL,0,NULL,NULL,'','',NULL,'','',NULL,NULL,NULL),(3,'08000002',1,'2','Менеджер','Садовский Ким Тарасович',1,0,'KimSadovskiy','KimSadovskiy@taburetka.fidonet','1201','+7 (961) 050-16-30','','20.08.1998',NULL,NULL,NULL,0,NULL,NULL,'','+7 (931) 777-21-14',NULL,'','',NULL,NULL,NULL),(4,'08000006',1,'1','Главный бухгалтер','Бровина Серафима Викторовна',1,0,'SerafimaBrovina','SerafimaBrovina@taburetka.fidonet','1122','+7 (922) 194-16-41','','17.03.1983',NULL,NULL,NULL,0,NULL,NULL,'','',NULL,'','',NULL,NULL,NULL),(5,'08000007',1,'4','Генеральный директор','Александров Назар Иванович',1,0,'NazarAleksandrov','NazarAleksandrov@taburetka.fidonet','1100','+7 (959) 891-61-87','','18.11.1983',NULL,NULL,NULL,0,NULL,NULL,'','',NULL,'','',NULL,NULL,NULL),(6,'08000011',1,'3','Системный администратор','Зимин Даниил Егорович',1,0,'DaniilZimin','DaniilZimin@taburetka.fidonet','1136','+7 (952) 073-14-59','','26.05.1991',NULL,NULL,NULL,0,NULL,NULL,'','',NULL,'','',NULL,NULL,NULL),(7,'08000012',1,'2','Менеджер','Мартынова Анфиса Романовна',1,0,'AnfisaMartynova','AnfisaMartynova@taburetka.fidonet','1202','+7 (919) 346-73-99','','17.08.2000',NULL,NULL,NULL,0,NULL,NULL,'','',NULL,'','',NULL,NULL,NULL),(8,'08000011',1,'5','Офис менеджер','Мартын Викторина Антоновна',1,0,'ViktorinaMartyn','info@taburetka.fidonet','1000','+7 (947) 481-53-92','','30.09.2001',NULL,NULL,NULL,0,NULL,NULL,'','',NULL,'','',NULL,NULL,NULL),(9,'2',2,'','Системный администратор','Левченко Вениамин Васильевич',1,0,'VeniaminLevchenko','VeniaminLevchenko@X3.team','3041','+7 (991) 634-40-89','','18.01.2000',NULL,NULL,NULL,0,NULL,NULL,'','',NULL,'','10.50.50.6',NULL,NULL,NULL),(10,'4',2,'','Специалист техподдержки','Баринов Борис Григорьевич',1,0,'BorisBarinov','BorisBarinov@X3.team','3044','+7 (967) 238-36-05','','24.05.1977',NULL,NULL,NULL,0,NULL,NULL,'','',NULL,'','10.50.50.5',NULL,NULL,NULL),(11,'08000002',1,'2','Менеджер','Тарская Элина Львовна',1,1,'ElinaTarskaya','ElinaTarskaya@taburetka.fidonet','','+7 (919) 074-41-69','','08.12.1975',NULL,NULL,NULL,0,NULL,NULL,'','',NULL,'','',NULL,NULL,NULL),(12,'08000013',1,'1','Бухгалтер','Городнов Силантий Петрович',1,0,'SilantiyGorodnov','SilantiyGorodnov@taburetka.fidonet','3021','','','08.12.1975',NULL,NULL,NULL,0,NULL,NULL,'','+7 (950) 575-66-51',NULL,'','10.50.50.4',NULL,NULL,NULL),(13,'08000014',1,'1','Бухгалтер по первичным документам','Осипова Борислава Филипповна',1,0,'BorislavaOsipova','BorislavaOsipova@taburetka.fidonet','3024','','','04.05.1995',NULL,NULL,NULL,0,NULL,NULL,'','+7 (964) 960-41-93',NULL,'','',NULL,NULL,NULL),(14,'08000015',1,'2','Менеджер по работе с корп. клиентами','Питерский Арнольд Матвеевич',1,0,'ArnoldPiterskiy','sales@taburetka.fidonet','3011','+7 (901) 400-88-82','','27.06.1975',NULL,NULL,NULL,0,NULL,NULL,'','',NULL,'','',NULL,NULL,NULL),(15,'08000017',1,'2','Менеджер','Кириллов Аполлон Евгеньевич',1,0,'ApollonKirillov','sales2@taburetka.fidonet','3014','+7 (961) 020-15-86','','27.09.1975',NULL,NULL,NULL,0,NULL,NULL,'','',NULL,'','',NULL,NULL,NULL),(17,'',NULL,NULL,'','Гость',3,0,'guest','','','','','',NULL,NULL,NULL,0,NULL,NULL,'','',NULL,'','','$2y$10$0.iukrq0FBy6VHvLzBvULOPUliLd70Qo7Sl1hGvJs0.r5sJH9t1gu',NULL,NULL);
