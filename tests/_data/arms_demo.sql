...
INSERT INTO `tech_states` VALUES (1,'state_issued','На руках','Выдано пользователю на руки.',0,58),(2,'state_confirmed','Согл','Приобретение согласовано. Формируются заявки / счета / запросы.',0,52),(3,'state_in_supply_service','Снабж.','В службе снабжения: все документы переданы в службу снабжения, ожидаем приобретения и доставки к месту потребности оборудования / ПО.',0,51),(4,'state_in_warehouse','Склад','На складе. В настоящий момент не установлен, но имеется в наличии',0,53),(5,'state_operating','ОК','Находится в работе по месту установки.',0,54),(6,'state_malfunction','Замеч.','К работе оборудования имеются замечания, необходимо устранить.',0,55),(7,'state_broken','Сломан','Полностью не работоспособен. Требуется ремонт или списание.',0,56),(8,'state_decommisioned','Списано','Выведено из эксплуатации.',1,NULL);
