...
CREATE TABLE `users_history` (
  ...
  `manager_id` int DEFAULT NULL,
  `employ_date` varchar(16) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `resign_date` varchar(16) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
