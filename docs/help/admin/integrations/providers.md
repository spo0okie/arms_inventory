...
'integrations' => [
	...
	//   создания логин записывается в карточку сотрудника;
	...
	// виде. Показывает вердикт (будет добавлен / на мониторинге / не
	// ставится + причины) и совпавшие правила; по клику «подробно» -
	// полный журнал: все проверенные правила и на каком условии
	// срезались. Источник - explain.php скрипта arms.zabbix (отвечает
