...
- **узел «?»** — сосед, которого инвентаризация не опознала (ни по адресу,
  ...
  опознает. IP-телефоны (SEP/SIP+MAC, «IP Phone») отсеиваются и считаются
  отдельной цифрой в шапке, как и пустые LLDP-записи без имени и адреса;
...
- **коммутатор другой площадки**, опознанный сверкой, — тоже находка с
  кнопкой: аплинки между площадками записываются так же;
