...
- [дату](../contracts.md#attr-date), т.к. она есть отдельным полем и при поиске документа используется
- [контрагента](../partners.md), т.к. он указывается [отдельным полем](../contracts.md#attr-partners_ids) и также выводится в список и участвует в поиске
